...
{
    public partial class AuditFeedbackFormTOC : System.Web.UI.Page
    {
        ...
        protected void btnFeedBk_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("Select Employee_Name,EmployeeID,Employee_Mail,CaseID from TOCLegend where CaseID=@CaseID", Con);
        ...
        public bool maildetailsFDBK()
        {
            ...
            string call_id = "Case ID is : " + CaseID.Text;
        ...
        {
            Con.Open();
            SqlCommand cmd = new SqlCommand("Update TOCLegend SET [Feedback]=@Feedback where CaseID=@CaseID", Con);
            ...
            maildetailsFDBK();
            //SendFDBKEmail();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Feedback sent and saved');window.location ='TOC_Legend.aspx';", true);
        }
    }
}
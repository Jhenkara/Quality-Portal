...
{
    public partial class _21_SAPOSLegend : System.Web.UI.Page
    {
        ...
        protected void Submit_Button(object sender, EventArgs args)
        {
            ...
            string CommandText = "INSERT INTO [dbo].[FY21SAPOSLegend](QAName,QAMail,BusinessUnit,BusinessSegment,Month,EmployeeID,Employee_Name,Employee_Mail,TLName,TLMail,Reporting_Manager,Reporting_Manager_Mail,TeamName,CCMail,CallDate,EvaluationDate,CaseID,CallID_SR_ID,CallDuration,CaseType,ProblemDescription,Language,NonCompliance,NonComplianceDetail,NonComplianceScore,AuditScore,CustCritical,BusCritical,Opening,Opening1,Opening2,Opening3,Opening4,Opening_Cmnts,ToolUsage,ToolUsage1,ToolUsage2,ToolUsage3,ToolUsage4,ToolUsage_Cmnts,Probing,Probing_Cmnts,Sol_Res,Sol_Res_Cmnts,Behavioural,Behavioural1,Behavioural2,Behavioural3,Behavioural4,Behavioural5,Behavioural_Cmnts,Communication,Communication1,Communication2,Communication3,Communication4,Communication_Cmnts,CustObsdBehav,CustObsdBehav1,CustObsdBehav2,CustObsdBehav3,CustObsdBehav4,CustObsdBehav5,CustObsdBehav_Cmnts,Time_Manage,Time_Manage_Cmnts,Callback,Callback_Cmnts,CaseOwnership,CaseOwnership1,CaseOwnership2,CaseOwnership_Cmnts,Case_Call_Logging,Case_Call_Logging1,Case_Call_Logging2,Case_Call_Logging3,Case_Call_Logging4,Case_Call_Logging_Cmnts,Closing,Closing_Cmnts,WOW_DAB,WOW_DAB_Cmnts,FCR,FCR_Cmnts,AuditResult) values " +
            ...
            Con.Close();
            maildetails();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Audit Saved and Mail sent Successfully');window.location ='21_SAPOSLegend.aspx';", true);
        }
        ...
        private bool SendEmail(string to, string from, string password, string subject, string body, string cc, string tl)
        {
            ...
            try
            {
                ...
                mail.Subject = "SAPOS Audit | " + ddMonth.SelectedItem.Text + " | " + tbId3.Text;
                mail.Body = body;

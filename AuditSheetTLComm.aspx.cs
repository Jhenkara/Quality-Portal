...
{
    public partial class AuditSheetTLComm : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("Select * from AuditLegendComm where CaseID=@CaseID and Reporting_Manager=@Mgr_Name or Employee_Mail=@Username", Con);

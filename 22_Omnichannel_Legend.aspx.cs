...
{
    public partial class _22_Omnichannel_Legend : System.Web.UI.Page
    {
        ...
        protected void Submit_Button(object sender, EventArgs args)
        {
            ...
            string CommandText = "INSERT INTO [dbo].[FY22OmnnichannelLegend](QAName,QAMail,BusinessUnit,BusinessSegment,Month,EmployeeID,Employee_Name,Employee_Mail,TLName,TLMail,Reporting_Manager,Reporting_Manager_Mail,TeamName,CCMail,CallDate,EvaluationDate,CaseID,CallID_SR_ID,CallDuration,CallType,ProblemDescription,NonCompliance,NonComplianceDetail,NonComplianceScore,AuditScore,CustCritical,BusCritical,Understand_Req,Understand_Req_Cmnts,Action_Within_TAT,Action_Within_TAT_Cmnts,Involve_Right_People,Involve_Right_People_Cmnts,Respond_Accordingly,Respond_Accordingly_Cmnts,ShowOwnership,ShowOwnership_Cmnts,Lang_Communication,Lang_Communication_Cmnts,UpdateNotes,UpdateNotes_Cmnts,UpdatedInSharepoint,UpdatedInSharepoint_Cmnts,AuditResult) values " +
            ...
            Con.Close();
            maildetails();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Audit Saved and Mail sent Successfully');window.location ='22_Omnichannel_Legend.aspx';", true);
        }
        ...
        private bool SendEmail(string to, string from, string password, string subject, string body, string cc, string tl)
        {
            ...
            try
            {
                ...
                mail.Subject = "Omnichannel Email Solvup CMD Audit | " + ddMonth.SelectedItem.Text + " | " + tbId3.Text;
                mail.Body = body;
        ...
        public bool maildetails()
        {
            ...
            string body = "http://15.42.19.247:120/AuditSheetUserFY22Omnichannel.aspx?case=" + tbId7.Text;

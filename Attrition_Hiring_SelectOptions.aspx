<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Attrition_Hiring_SelectOptions.aspx.cs" Inherits="Audit_Legends.Attrition_Hiring_SelectOptions" %>
...
<body>
    ...
    <div class="col-sm-8" style="margin-top:100px;width:70%;float:left;">
        <asp:Button ID="New1" CssClass="SelectButtonsNew" runat="server" Text="Profile Details Form" OnClick="New1_Click"/><br /><br /><br />
        <asp:Button ID="New2" CssClass="SelectButtonsNew" runat="server" Text="Attrition Form"/><br /><br /><br />
    </div>

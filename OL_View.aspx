<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OL_View.aspx.cs" Inherits="Audit_Legends.OL_View" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>OL Dashboard</title>
...
<body>
    ...
    <div style="margin-bottom:20px;" class="auto-style1">
        ...
        <div class="card-body" style="background-color:white; box-shadow: 0px 0px 3px grey; border-radius:5px;margin-left:30px;height:auto;width:25%;float:left;">
            <p style="display: inline-block; font-family: 'HP Simplified'; font-size:medium; font-weight: bold">View Operation Manager-wise Data : </p>
            ...
            <br />
            <p style="display: inline-block; font-family: 'HP Simplified'; font-size:medium; font-weight: bold">View Data Form-wise Data  : </p>
    ...
    <div class="form-group ">
            <div class="col-sm-10" style="margin-left:20px;margin-top:10px;">
                <asp:GridView ID="UserGrid" runat="server" AutoGenerateEditButton="false" CellSpacing="2" CssClass=" table table-bordered table-responsive rounded_corners" AutoGenerateColumns="false" HeaderStyle-BackColor="#3AC0F2"
                    ...
                    <Columns>
                        <asp:BoundField DataField="OM" HeaderText="Operation Manager" />

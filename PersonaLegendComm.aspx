<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PersonaLegendComm.aspx.cs" Inherits="Audit_Legends.PersonaLegendComm" %>
    ...
    <div class="row " style="margin-left:20px;margin-top:20px;">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddDeliType" runat="server" Height="25px" Width="300px">
                        ...
                        <asp:ListItem Text="ADX" Value="2"></asp:ListItem>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddTeamName" runat="server" Height="25px" Width="300px">
                        ...
                        <asp:ListItem Text="PS CE Assist" Value="3"></asp:ListItem>
                        <asp:ListItem Text="PS DSO" Value="4"></asp:ListItem>
                        <asp:ListItem Text="Print ADX" Value="5"></asp:ListItem>
                        <asp:ListItem Text="Print Chat" Value="6"></asp:ListItem>
                        <asp:ListItem Text="Print Voice" Value="7"></asp:ListItem>
                    </asp:DropDownList>
        ...
        <table id="table4" style="float:left;margin-left:30px;position:center">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TextBox7" CssClass="form-control" AutoCompleteType="Disabled" placeholder="If not applicable, type ‘NA’" BorderStyle="Inset" runat="server" Height="25px" Width="300px"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" ControlToValidate="TextBox7" SetFocusOnError="true"></asp:RequiredFieldValidator>
                </td>
            </tr>
        ...
        <table id="table2" border="1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><asp:TextBox ID="TextBox5" TextMode="MultiLine" CssClass="form-control" AutoCompleteType="Disabled" Placeholder="Type ‘NA’ if not applicable" BorderStyle="Inset" runat="server" Height="40px" Width="240px"></asp:TextBox></td>
                </tr>

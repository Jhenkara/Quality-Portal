...
{
    public partial class AuditSheetSAPOSQA : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("Select * from [dbo].[FY21SAPOSLegend] where CallID_SR_ID=@CallID_SR_ID and QAMail=@Username", Con);
            ...
            ddLang.SelectedItem.Text = dtt.Rows[0]["Language"].ToString();
            ...
            Q07.SelectedItem.Text = dtt.Rows[0]["CustObsdBehav"].ToString();

            Q07a.SelectedItem.Text = dtt.Rows[0]["CustObsdBehav1"].ToString();

            Q07b.SelectedItem.Text = dtt.Rows[0]["CustObsdBehav2"].ToString();

            Q07c.SelectedItem.Text = dtt.Rows[0]["CustObsdBehav3"].ToString();

            Q07d.SelectedItem.Text = dtt.Rows[0]["CustObsdBehav4"].ToString();

            Q07e.SelectedItem.Text = dtt.Rows[0]["CustObsdBehav5"].ToString();

            C07.Text = dtt.Rows[0]["CustObsdBehav_Cmnts"].ToString();

            Q08.SelectedItem.Text = dtt.Rows[0]["Time_Manage"].ToString();

            C08.Text = dtt.Rows[0]["Time_Manage_Cmnts"].ToString();

            Q09.SelectedItem.Text = dtt.Rows[0]["Callback"].ToString();

            C09.Text = dtt.Rows[0]["Callback_Cmnts"].ToString();

            Q10.SelectedItem.Text = dtt.Rows[0]["CaseOwnership"].ToString();

            Q10a.SelectedItem.Text = dtt.Rows[0]["CaseOwnership1"].ToString();

            Q10b.SelectedItem.Text = dtt.Rows[0]["CaseOwnership2"].ToString();

            C10.Text = dtt.Rows[0]["CaseOwnership_Cmnts"].ToString();

            Q11.SelectedItem.Text = dtt.Rows[0]["Case_Call_Logging"].ToString();

            Q11a.SelectedItem.Text = dtt.Rows[0]["Case_Call_Logging1"].ToString();

            Q11b.SelectedItem.Text = dtt.Rows[0]["Case_Call_Logging2"].ToString();

            Q11c.SelectedItem.Text = dtt.Rows[0]["Case_Call_Logging3"].ToString();

            Q11d.SelectedItem.Text = dtt.Rows[0]["Case_Call_Logging4"].ToString();

            C11.Text = dtt.Rows[0]["Case_Call_Logging_Cmnts"].ToString();

            Q12.SelectedItem.Text = dtt.Rows[0]["Closing"].ToString();

            C12.Text = dtt.Rows[0]["Closing_Cmnts"].ToString();

            Q13.SelectedItem.Text = dtt.Rows[0]["WOW_DAB"].ToString();

            C13.Text = dtt.Rows[0]["WOW_DAB_Cmnts"].ToString();

            Q14.SelectedItem.Text = dtt.Rows[0]["FCR"].ToString();
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@CustObsdBehav", Q07.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CustObsdBehav1", Q07a.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CustObsdBehav2", Q07b.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CustObsdBehav3", Q07c.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CustObsdBehav4", Q07d.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CustObsdBehav5", Q07e.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CustObsdBehav_Cmnts", C07.Text);
            cmd.Parameters.AddWithValue("@Time_Manage", Q08.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Time_Manage_Cmnts", C08.Text);
            cmd.Parameters.AddWithValue("@Callback", Q09.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Callback_Cmnts", C09.Text);
            cmd.Parameters.AddWithValue("@CaseOwnership", Q10.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CaseOwnership1", Q10a.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CaseOwnership2", Q10b.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CaseOwnership_Cmnts", C10.Text);
            cmd.Parameters.AddWithValue("@Case_Call_Logging", Q11.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Case_Call_Logging1", Q11a.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Case_Call_Logging2", Q11b.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Case_Call_Logging3", Q11c.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Case_Call_Logging4", Q11d.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Case_Call_Logging_Cmnts", C11.Text);
            cmd.Parameters.AddWithValue("@Closing", Q12.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Closing_Cmnts", C12.Text);
            cmd.Parameters.AddWithValue("@WOW_DAB", Q13.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@WOW_DAB_Cmnts", C13.Text);
            cmd.Parameters.AddWithValue("@AuditResult", hfv_AuditRes.Value);
            cmd.Parameters.AddWithValue("@FCR", Q14.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@FCR_Cmnts", C14.Text);
            SqlDataReader dr = cmd.ExecuteReader();
            Con.Close();
            maildetails();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Audit Updated Successfully');window.location ='QADashboardFY21SAPOSLegend.aspx';", true);
        }
        ...
        private bool SendEmail(string to, string from, string password, string subject, string body, string cc, string tl)
        {
            ...
            try
            {
                ...
                mail.Subject = "Resolved SAPOS Audit | " + ddMonth.SelectedItem.Text + " | " + tbId3.Text;
                mail.Body = body;
        ...
        public bool maildetails()
        {
            ...
            string body = "http://15.42.19.247:120/AuditSheetUserFY21SAPOS.aspx?case=" + tbId7.Text;
            ...
            string body4 = "http://15.42.19.247:120/AuditSheetMgrFY21SAPOS.aspx?case=" + tbId7.Text;
        ...
        {
            Response.Redirect("~/Download/FY23 SAPOS Report.xlsx");
        }

        protected void QADashboard_Click(object sender, EventArgs e)
        {
            Response.Redirect("QADashboardFY21SAPOSLegend.aspx");
        }

        protected void btnCaseIdCheck_Click(object sender, EventArgs e)
        {
            Con.Open();
            SqlCommand cmd = new SqlCommand("select * from [dbo].[FY21SAPOSLegend] where CaseID=@CaseId", Con);
            cmd.Parameters.AddWithValue("@CaseId", tbId6.Text);
            cmd.Connection = Con;
            SqlDataReader dr = cmd.ExecuteReader();
        ...
        {
            Con.Open();
            SqlCommand cmd = new SqlCommand("select * from [dbo].[FY21SAPOSLegend] where CallID_SR_ID=@CallID_SR_ID", Con);
            cmd.Parameters.AddWithValue("@CallID_SR_ID", tbId7.Text);
            cmd.Connection = Con;
            SqlDataReader dr = cmd.ExecuteReader();
        ...
        {
            Response.Redirect("AuditFeedbackFormSAPOS.aspx");
        }

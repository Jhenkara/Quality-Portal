...
{
    public partial class UserDashboardHW : System.Web.UI.Page
    {
        ...
        public void bind_data()
        {
            ...
            else
            {
                ...
                SqlDataSource1.SelectCommand = "select Employee_ID,Employee_Name,Case_ID,Call_Date,Evaluation_Date,QA_Name,Audit_Status,Total_Compliance FROM [dbo].[HardwareV2Legend] where Employee_Mail='" + emp_mail + "' order by Evaluation_Date desc";
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("HWAuditSheetUser.aspx?case=" + cass);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.Page.Controls.Add(SqlDataSource1);
                SqlDataSource1.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["CString"].ConnectionString;
                SqlDataSource1.SelectCommand = "select Employee_ID,Employee_Name,Case_ID,Call_Date,Evaluation_Date,QA_Name,Audit_Status,Total_Compliance FROM [dbo].[HardwareV2Legend] where Case_ID='" + searchbar.Text + "' order by Call_Date";
                UserGrid.DataSource = SqlDataSource1;
                UserGrid.DataBind();
            }
            catch (Exception ex)

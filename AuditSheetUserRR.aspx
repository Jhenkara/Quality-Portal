<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditSheetUserRR.aspx.cs" Inherits="Audit_Legends.AuditSheetUserRR" %>
...
<body>
    ...
    <div class="auto-style1" style="color:aliceblue;background-color:black;text-align:left;line-height:100px;">
        ...
        <h1><img src="HP-blue.png" style="width:98px;overflow:auto;float:initial;"/> Rio Rancho Legend </h1>
    </div>
        ...
        <table id="table2" border="1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td></td>
                    <td>
                        <asp:TextBox ID="ddv20" TextMode="MultiLine" CssClass="form-control" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server" Height="40px" Width="240px"></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td></td>
                    <td>
                        <asp:TextBox ID="ddv21" TextMode="MultiLine" CssClass="form-control" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server" Height="40px" Width="240px"></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td></td>
                    <td>
                        <asp:TextBox ID="ddv22" TextMode="MultiLine" CssClass="form-control" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server" Height="40px" Width="240px"></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td></td>
                    <td>
                        <asp:TextBox ID="ddv23" TextMode="MultiLine" CssClass="form-control" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server" Height="40px" Width="240px"></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td></td>
                    <td>
                        <asp:TextBox ID="ddv24" TextMode="MultiLine" CssClass="form-control" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server" Height="40px" Width="240px"></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td></td>
                    <td>
                        <asp:TextBox ID="ddv25" TextMode="MultiLine" CssClass="form-control" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server" Height="40px" Width="240px"></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td></td>
                    <td>
                        <asp:TextBox ID="ddv26" TextMode="MultiLine" CssClass="form-control" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server" Height="40px" Width="240px"></asp:TextBox>
                    </td>
                </tr>
            </tbody>
        </table>

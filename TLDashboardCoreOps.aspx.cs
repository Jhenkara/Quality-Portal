...
{
    public partial class TLDashboardCoreOps : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (!IsPostBack)
                {
                    string QA = "select distinct QAName from [dbo].[CoreOpsLegend]";
                ...
                if (!IsPostBack)
                {
                    string Mon = "select distinct Month from [dbo].[CoreOpsLegend]";
                ...
                if (!IsPostBack)
                {
                    string Case = "select distinct CaseType from [dbo].[CoreOpsLegend]";
        ...
        private void GetChart1Data()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("select Employee_Name,avg(TotalCompliance) as [Total Compliance] from [dbo].[CoreOpsLegend] where QAName='" + DropDownList1.SelectedItem.Text + "' and Month='" + DropDownList3.SelectedItem.Text + "' and CaseType='" + DropDownList4.SelectedItem.Text + "' group by Employee_Name", Con);
                cmd.Connection = Con;
                Con.Open();
            ...
            {
                SqlCommand cmd = new SqlCommand("select Employee_Name,avg(TotalCompliance) as [Total Compliance] from [dbo].[CoreOpsLegend] where Month='" + DropDownList3.SelectedItem.Text + "' and CaseType='" + DropDownList4.SelectedItem.Text + "' group by Employee_Name", Con);
                cmd.Connection = Con;
                Con.Open();
                SqlDataReader dr = cmd.ExecuteReader();
                Graph1.DataBindTable(dr, "Employee_Name");
            ...
            {
                SqlCommand cmd = new SqlCommand("select Employee_Name,avg(TotalCompliance) as [Total Compliance] from [dbo].[CoreOpsLegend] where QAName='" + DropDownList1.SelectedItem.Text + "' and CaseType='" + DropDownList4.SelectedItem.Text + "' group by Employee_Name", Con);
                cmd.Connection = Con;
                Con.Open();
                SqlDataReader dr = cmd.ExecuteReader();
                Graph1.DataBindTable(dr, "Employee_Name");
            ...
            {
                SqlCommand cmd = new SqlCommand("select Employee_Name,avg(TotalCompliance) as [Total Compliance] from [dbo].[CoreOpsLegend] where QAName='" + DropDownList1.SelectedItem.Text + "' and Month='" + DropDownList3.SelectedItem.Text + "' group by Employee_Name", Con);
                cmd.Connection = Con;
                Con.Open();
                SqlDataReader dr = cmd.ExecuteReader();
                Graph1.DataBindTable(dr, "Employee_Name");
            ...
            {
                SqlCommand cmd = new SqlCommand("select Employee_Name,avg(TotalCompliance) as [Total Compliance] from [dbo].[CoreOpsLegend] where QAName='" + DropDownList1.SelectedItem.Text + "' group by Employee_Name", Con);
                cmd.Connection = Con;
                Con.Open();
                SqlDataReader dr = cmd.ExecuteReader();
                Graph1.DataBindTable(dr, "Employee_Name");
            ...
            {
                SqlCommand cmd = new SqlCommand("select Employee_Name,avg(TotalCompliance) as [Total Compliance] from [dbo].[CoreOpsLegend] where Month='" + DropDownList3.SelectedItem.Text + "' group by Employee_Name", Con);
                cmd.Connection = Con;
                Con.Open();
                SqlDataReader dr = cmd.ExecuteReader();
                Graph1.DataBindTable(dr, "Employee_Name");
            ...
            {
                SqlCommand cmd = new SqlCommand("select Employee_Name,avg(TotalCompliance) as [Total Compliance] from [dbo].[CoreOpsLegend] where CaseType='" + DropDownList4.SelectedItem.Text + "' group by Employee_Name", Con);
                cmd.Connection = Con;
                Con.Open();
                SqlDataReader dr = cmd.ExecuteReader();
                Graph1.DataBindTable(dr, "Employee_Name");

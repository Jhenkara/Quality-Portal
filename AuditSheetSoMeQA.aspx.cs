...
{
    public partial class AuditSheetSoMeQA : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("Select * from [dbo].[FY21SoMeLegend] where CaseID=@CaseID and QAMail=@Username", Con);
            ...
            ddST.SelectedItem.Text = dtt.Rows[0]["SupportType"].ToString();
            ...
            tbLang.Text = dtt.Rows[0]["Language"].ToString();
            ...
            Q08f.SelectedItem.Text = dtt.Rows[0]["CustObsdBehav6"].ToString();

            C08.Text = dtt.Rows[0]["CustObsdBehav_Cmnts"].ToString();

            Q18.SelectedItem.Text = dtt.Rows[0]["TimeManagement"].ToString();

            C18.Text = dtt.Rows[0]["TimeManagement_Cmnts"].ToString();

            Q09.SelectedItem.Text = dtt.Rows[0]["CaseFollowUp"].ToString();

            C09.Text = dtt.Rows[0]["CaseFollowUp_Cmnts"].ToString();
            ...
            Q10c.SelectedItem.Text = dtt.Rows[0]["CaseOwnership3"].ToString();

            Q10d.SelectedItem.Text = dtt.Rows[0]["CaseOwnership4"].ToString();
            ...
            Q14a.SelectedItem.Text = dtt.Rows[0]["SAPOS"].ToString();

            Q14.SelectedItem.Text = dtt.Rows[0]["SAPOS1a"].ToString();

            Q14b.SelectedItem.Text = dtt.Rows[0]["SAPOS1b"].ToString();

            C14.Text = dtt.Rows[0]["SAPOS1_Cmnts"].ToString();

            Q15.SelectedItem.Text = dtt.Rows[0]["SAPOS2"].ToString();

            C15.Text = dtt.Rows[0]["SAPOS2_Cmnts"].ToString();

            Q16.SelectedItem.Text = dtt.Rows[0]["SAPOS3"].ToString();

            C16.Text = dtt.Rows[0]["SAPOS3_Cmnts"].ToString();

            Q17.SelectedItem.Text = dtt.Rows[0]["FCR"].ToString();

            C17.Text = dtt.Rows[0]["FCR_Cmnts"].ToString();
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@CustObsdBehav6", Q08f.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CustObsdBehav_Cmnts", C08.Text);
            cmd.Parameters.AddWithValue("@TimeManagement", Q18.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@TimeManagement_Cmnts", C18.Text);
            cmd.Parameters.AddWithValue("@CaseFollowUp", Q09.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CaseFollowUp_Cmnts", C09.Text);
            ...
            cmd.Parameters.AddWithValue("@CaseOwnership3", Q10c.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CaseOwnership4", Q10d.SelectedItem.Text);
            ...
            cmd.Parameters.AddWithValue("@SAPOS", Q14a.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@SAPOS1a", Q14.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@SAPOS1b", Q14b.SelectedItem.Text);
            ...
            cmd.Parameters.AddWithValue("@FCR", Q17.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@FCR_Cmnts", C17.Text);
            SqlDataReader dr = cmd.ExecuteReader();
            Con.Close();
            maildetails();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Audit Updated Successfully');window.location ='QADashboardFY21SoMeLegend.aspx';", true);
        }

        protected void FileDownload(object sender, EventArgs e)
        {
            Response.Redirect("~/Download/FY23 SoMe Report.xlsx");
        }
        ...
        private bool ResendEmail(string to, string from, string password, string subject, string body, string cc, string tl)
        {
            ...
            try
            {
                ...
                mail.Subject = "SoMe Audit | " + ddMonth.SelectedItem.Text + " | " + tbId3.Text;
                mail.Body = body;
        ...
        public bool resend_maildetails()
        {
            ...
            string body = "http://15.42.19.247:120/AuditSheetUserFY21SoMe.aspx?case=" + tbId6.Text;
            ...
            string body4 = "http://15.42.19.247:120/AuditSheetMgrFY21SoMe.aspx?case=" + tbId6.Text;
        ...
        private bool SendEmail(string to, string from, string password, string subject, string body, string cc, string tl)
        {
            ...
            try
            {
                ...
                mail.Subject = "Resolved SoMe Audit | " + ddMonth.SelectedItem.Text + " | " + tbId3.Text;
                mail.Body = body;
                mail.IsBodyHtml = true;
                SmtpServer.Port = Convert.ToInt32(ConfigurationManager.AppSettings["smtpPort"]);
                SmtpServer.UseDefaultCredentials = false;
        ...
        {
            Response.Redirect("QADashboardFY21SoMeLegend.aspx");
        }

        protected void btnCaseIdCheck_Click(object sender, EventArgs e)
        {
            Con.Open();
            SqlCommand cmd = new SqlCommand("select * from [dbo].[FY21SoMeLegend] where CaseID=@CaseId", Con);
            cmd.Parameters.AddWithValue("@CaseId", tbId6.Text);
            cmd.Connection = Con;
            SqlDataReader dr = cmd.ExecuteReader();
        ...
        {
            Con.Open();
            SqlCommand cmd = new SqlCommand("select * from [dbo].[FY21SoMeLegend] where CallID_SR_ID=@CallID_SR_ID", Con);
            cmd.Parameters.AddWithValue("@CallID_SR_ID", tbId7.Text);
            cmd.Connection = Con;
            SqlDataReader dr = cmd.ExecuteReader();
        ...
        {
            Response.Redirect("AuditFeedbackFormSoMe.aspx");
        }
        ...
        protected void SoMe_GuideLines_Click(object sender, EventArgs e)
        {
            ...
            //Server.Transfer("21_SoMeLegendGL.aspx");
        }
        ...
        protected void ddBU_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else if (value == "1")
            {
                ddProbDes.Items.Clear();
                ddProbDes.Items.Insert(0, new ListItem("--Choose--", "-1"));
                ddProbDes.Items.Add("Instant ink");
                ...
                ddProbDes.Items.Add("Product Specifications");
                ddProbDes.Items.Add("SAPOS");
                ddProbDes.Items.Add("Print Quality");
                ddProbDes.Items.Add("Communication issue");
                ddProbDes.Items.Add("Scanning");
                ddProbDes.Items.Add("Power related");
                ddProbDes.Items.Add("Complaint");
                ddProbDes.Items.Add("Info Call");
                ddProbDes.Items.Add("Printing related");
                ddProbDes.Items.Add("Status Call");
        ...
        {
            resend_maildetails();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Mail Resent Successfully');window.location ='QADashboardFY21SoMeLegend.aspx';", true);
        }
    }
}
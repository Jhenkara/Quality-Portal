...
{
    public partial class AuditSheetUserFY21CDT : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                SqlCommand cmd1 = new SqlCommand("Update [dbo].[FY21CDTLegend] SET [AuditStatus]='Viewed' where CallID_SR_ID=@CallID_SR_ID and AuditStatus='Not Viewed'", Con);
        ...
        {
            SqlCommand cmd = new SqlCommand("Select * from [dbo].[FY21CDTLegend] where CallID_SR_ID=@CallID_SR_ID and Employee_Mail=@Username", Con);
            ...
            Q02.Text = dtt.Rows[0]["Case_Serial_No"].ToString();
            Q02.ReadOnly = true;
            ...
            Q06.Text = dtt.Rows[0]["Communication"].ToString();
            Q06.ReadOnly = true;
            ...
            Q06e.Text = dtt.Rows[0]["Communication5"].ToString();
            Q06e.ReadOnly = true;

            Q06f.Text = dtt.Rows[0]["Communication6"].ToString();
            Q06f.ReadOnly = true;

            Q06g.Text = dtt.Rows[0]["Communication7"].ToString();
            Q06g.ReadOnly = true;

            Q06h.Text = dtt.Rows[0]["Communication8"].ToString();
            Q06h.ReadOnly = true;
            ...
            Q08.Text = dtt.Rows[0]["CaseLogging"].ToString();
            Q08.ReadOnly = true;

            C08.Text = dtt.Rows[0]["CaseLogging_Cmnts"].ToString();
            C08.ReadOnly = true;

            Q09.Text = dtt.Rows[0]["CaseOwnership"].ToString();
            Q09.ReadOnly = true;
        ...
        {
            Con.Open();
            SqlCommand cmd = new SqlCommand("Update [dbo].[FY21CDTLegend] SET [AuditStatus]='Accepted by Agent' where CallID_SR_ID=@CallID_SR_ID", Con);
            cmd.Parameters.AddWithValue("@CallID_SR_ID", Request.QueryString["case"].ToString());
            cmd.ExecuteNonQuery();
            Con.Close();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Your Response has been Received successfully');window.location ='UserDashboardFY21CDT.aspx';", true);
        }
        ...
        private bool SendEmail(string to, string from, string password, string subject, string body, string cc)
        {
            ...
            try
            {
                ...
                mail.Subject = "CDT Audit | " + tbId3.Text + " | Dispute";
                mail.Body = body;
        ...
        public bool maildetails()
        {
            ...
            string body = "http://15.42.19.247:120/AuditSheetCDTQA.aspx?case=" + tbId7.Text;
        ...
        protected void DisputeOptions(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                SqlCommand cmd = new SqlCommand("Update [dbo].[FY21CDTLegend] SET [AuditStatus]='Disputed by Agent' where CallID_SR_ID=@CallID_SR_ID", Con);
                cmd.Parameters.AddWithValue("@CallID_SR_ID", Request.QueryString["case"].ToString());
                cmd.Connection = Con;
                cmd.ExecuteNonQuery();
                Con.Close();

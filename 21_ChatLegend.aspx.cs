...
{
    public partial class _21_ChatLegend : System.Web.UI.Page
    {
        ...
        protected void Submit_Button(object sender, EventArgs args)
        {
            ...
            string CommandText = "INSERT INTO [dbo].[FY21ChatLegend](QAName,QAMail,BusinessUnit,BusinessSegment,Month,EmployeeID,Employee_Name,Employee_Mail,TLName,TLMail,Reporting_Manager,Reporting_Manager_Mail,TeamName,CCMail,ChatDate,EvaluationDate,CaseID,ChatID_SR_ID,ChatDuration,AuditType,CaseType,ProblemDescription,NonCompliance,NonComplianceDetail,NonComplianceScore,AuditScore,CustCritical,BusCritical,Opening,Opening1,Opening2,Opening3,Opening4,Opening5,Opening_Cmnts,ToolUsage,ToolUsage1,ToolUsage2,ToolUsage3,ToolUsage4,ToolUsage5,ToolUsage6,ToolUsage7,ToolUsage8,ToolUsage_Cmnts,Probing,Probing_Cmnts,Troubleshooting,Troubleshooting_Cmnts,Sol_Res,Sol_Res_Cmnts,Behavioural,Behavioural1,Behavioural2,Behavioural3,Behavioural4,Behavioural5,Behavioural_Cmnts,Communication,Communication1,Communication2,Communication3,Communication4,Communication_Cmnts,CustObsdBehav,CustObsdBehav1,CustObsdBehav2,CustObsdBehav3,CustObsdBehav4,CustObsdBehav5,CustObsdBehav_Cmnts,Time_Manage,Time_Manage_Cmnts,Callback,Callback_Cmnts,CaseOwnership,CaseOwnership1,CaseOwnership2,CaseOwnership3,CaseOwnership4,CaseOwnership_Cmnts,Case_Call_Logging,Case_Call_Logging_Cmnts,Closing,Closing_Cmnts,WOW_DAB,WOW_DAB_Cmnts,SAPOS,SAPOS1a,SAPOS1b,SAPOS1_Cmnts,SAPOS2,SAPOS2_Cmnts,SAPOS3,SAPOS3_Cmnts,FCR,FCR_Cmnts,AuditResult) values " +
            ...
            cmd.Parameters.AddWithValue("@ChatDate", tbId4.Text);
            ...
            Con.Close();
            maildetails();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Audit Saved and Mail sent Successfully');window.location ='21_ChatLegend.aspx';", true);
        }
        ...
        {
            Con.Open();
            SqlCommand cmd = new SqlCommand("select * from [dbo].[FY21ChatLegend] where CallID_SR_ID=@CallID_SR_ID", Con);

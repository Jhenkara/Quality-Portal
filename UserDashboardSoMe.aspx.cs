...
{
    public partial class UserDashboardSoMe : System.Web.UI.Page
    {
        ...
        public void bind_data()
        {
            ...
            else
            {
                ...
                SqlDataSource1.SelectCommand = "select EmployeeID,Employee_Name,CaseID,CaseDate,EvaluationDate,QAName,AuditStatus,TotalCompliance FROM [dbo].[SoMeFBTW_Legend] where Employee_Mail='" + emp_mail + "' order by EvaluationDate desc";
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("AuditSheetUserSoMe.aspx?case=" + cass);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.Page.Controls.Add(SqlDataSource1);
                SqlDataSource1.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["CString"].ConnectionString;
                SqlDataSource1.SelectCommand = "select EmployeeID,Employee_Name,CaseID,CaseDate,EvaluationDate,QAName,AuditStatus,TotalCompliance FROM [dbo].[SoMeFBTW_Legend] where CaseID='" + searchbar.Text + "' order by CaseDate";
                UserGrid.DataSource = SqlDataSource1;
                UserGrid.DataBind();
            }
            catch (Exception ex)

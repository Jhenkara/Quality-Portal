...
{
    public partial class AuditFeedbackFormDaaS : System.Web.UI.Page
    {
        ...
        protected void btnFeedBk_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("Select Employee_Name,EmployeeID,Employee_Mail,CaseID from FY22_DaaSLegend where CallID_SR_ID=@CallID_SR_ID", Con);
        ...
        {
            Con.Open();
            SqlCommand cmd = new SqlCommand("Update FY22_DaaSLegend SET [Feedback]=@Feedback where CallID_SR_ID=@CallID_SR_ID", Con);
            ...
            maildetailsFDBK();
            //SendFDBKEmail();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Feedback sent and saved');window.location ='22_DaaSLegend.aspx';", true);
        }
    }
}
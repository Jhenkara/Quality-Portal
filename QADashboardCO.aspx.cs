...
{
    public partial class QADashboardCO : System.Web.UI.Page
    {
        ...
        public void bind_data()
        {
            ...
            else
            {
                ...
                SqlDataSource1.SelectCommand = "select EmployeeID,Employee_Name,CaseID,CallDate,EvaluationDate,QAName,AuditStatus,TotalCompliance FROM [dbo].[CoreOpsLegend] where QAName='" + emp_name + "' order by EvaluationDate desc";
        ...
        protected void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("AuditSheetQACO.aspx?case=" + cass);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.Page.Controls.Add(SqlDataSource1);
                SqlDataSource1.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["CString"].ConnectionString;
                SqlDataSource1.SelectCommand = "select EmployeeID,Employee_Name,CaseID,CallDate,EvaluationDate,QAName,AuditStatus,TotalCompliance FROM [dbo].[CoreOpsLegend] where CaseID='" + searchbar.Text + "' or EmployeeID='" + searchbar.Text + "' order by CallDate";
                UserGrid.DataSource = SqlDataSource1;
                UserGrid.DataBind();
            }
            catch (Exception ex)

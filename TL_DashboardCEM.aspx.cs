...
{
    public partial class TL_DashboardCEM : System.Web.UI.Page
    {
        ...
        public void bind_data()
        {
            ...
            else
            {
                ...
                SqlDataSource1.SelectCommand = "select EmployeeID,Employee_Name,CaseID,CallDate,EvaluationDate,QAName,Reporting_Manager,AuditStatus,TotalCompliance FROM [dbo].[CEMLegend] where Reporting_Manager='" + mgr_name + "' order by EvaluationDate desc";
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("AuditSheetTLCEM.aspx?case=" + cass + "&mgr=" + mgr);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.Page.Controls.Add(SqlDataSource1);
                SqlDataSource1.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["CString"].ConnectionString;
                SqlDataSource1.SelectCommand = "select EmployeeID,Employee_Name,CaseID,CallDate,EvaluationDate,QAName,Reporting_Manager,AuditStatus,TotalCompliance FROM [dbo].[CEMLegend] where CaseID='" + searchbar.Text + "' order by CallDate";
                UserGrid.DataSource = SqlDataSource1;
                UserGrid.DataBind();
            }
            catch (Exception ex)

...
{
    public partial class AuditSheetQA : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("Select * from AuditLegend where CaseID=@CaseID and QAMail=@Username", Con);
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            Con.Close();
            //maildetails();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Audit Updated Successfully');window.location ='QADashboard.aspx';", true);
        }
    }
}
...
{
    public partial class SoMeForumLegend : System.Web.UI.Page
    {
        ...
        protected void Submit_Button(object sender, EventArgs args)
        {
            ...
            string CommandText = "INSERT INTO [dbo].[SoMeForum_Legend](QAName,QAMail,CustomerType,Month,EmployeeID,Employee_Name,Employee_Mail,Reporting_Manager,TeamName,CCEmail,CaseDate,EvaluationDate,CaseID,CaseType,ProblemDescription,ProductLine,Prediction,NonCompliance,NonComplianceDetail,TotalCompliance,CustCritical,BusCritical,WhatWentWell,Opportunities,A1,A2,A3,A4,A5,B1,B2,C1,C2,C3,C4,C5,D1,D2,D3,E1,E2,E3,E4,F1) values " +
                "(@QAName,@QAMail,@CustomerType,@Month,@EmployeeID,@Employee_Name,@Employee_Mail,@Reporting_Manager,@TeamName,@CCEmail,@CaseDate,@EvaluationDate,@CaseID,@CaseType,@ProblemDescription,@ProductLine,@Prediction,@NonCompliance,@NonComplianceDetail,@TotalCompliance,@CustCritical,@BusCritical,@WhatWentWell,@Opportunities,@A1,@A2,@A3,@A4,@A5,@B1,@B2,@C1,@C2,@C3,@C4,@C5,@D1,@D2,@D3,@E1,@E2,@E3,@E4,@F1)";
            ...
            cmd.Parameters.AddWithValue("@A5", A5.SelectedItem.Text);
            ...
            cmd.Parameters.AddWithValue("@C5", C5.SelectedItem.Text);
            ...
            cmd.Parameters.AddWithValue("@E4", E4.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@F1", F1.SelectedItem.Text);
            SqlDataReader dr = cmd.ExecuteReader();
            Con.Close();
            maildetails();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Audit Saved and Mail sent Successfully');window.location ='SoMeForumLegend.aspx';", true);
        }
        ...
        {
            Response.Redirect("~/Download/SoMe Forums Report.xlsx");
        }
        private bool SendEmail(string to, string from, string password, string subject, string body, string cc)
        {
            ...
            try
            {
                ...
                mail.Subject = "SoMe Forums Audit | " + tbId3.Text + " - " + Compliance.Value;
                mail.Body = body;
        ...
        {
            Response.Redirect("QADashboardForums.aspx");
        }

        protected void btnCaseIdCheck_Click(object sender, EventArgs e)
        {
            Con.Open();
            SqlCommand cmd = new SqlCommand("select * from [dbo].[SoMeForum_Legend] where CaseID=@CaseId", Con);
            cmd.Parameters.AddWithValue("@CaseId", tbId6.Text);
            cmd.Connection = Con;
            SqlDataReader dr = cmd.ExecuteReader();

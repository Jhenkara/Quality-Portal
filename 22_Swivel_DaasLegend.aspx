<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="22_Swivel_DaasLegend.aspx.cs" Inherits="Audit_Legends._22_Swivel_DaasLegend" %>
...
<head>
    ...
    <title>Swivel Daas Audit Form</title>
...
<body>
    ...
    <div class="auto-style1" style="color:aliceblue;background-color:#4d4e4f;text-align:left;line-height:100px;width:100%">
        ...
        <h1><img src="Images/hp_logo_white.png" style="width:98px;overflow:auto;float:initial;"/> Swivel Daas Audit Form </h1>
    </div>
    ...
    <div class="container-fluid" style="text-align:right;align-items:center;height:60px;width:95%;">
        ...
        <script type="text/javascript">
        function SetTarget() {
            window.open("22_Swivel_DaaSGL.aspx");
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:ListItem Text="TAT Missed" Value="2"></asp:ListItem>
...
<%--                                    <tr style="background-color:#1e5eb3;color:white">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            MCSL - Matching Customer Skill Level <br />
                                    ...
                                    <tr>
                                        <td>Email Communication<br />
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ControlToValidate="Q06" ID="RequiredFieldValidator14" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>
                                            Usage of Jargons/short hand<br />
                                            Sentence structure/ Grammar<br />
                                            Attention to Details
                                        </td>
                                        <td>
                                            <asp:DropDownList ID="Q06a" runat="server" Height="20px" Width="150px" Font-Size="X-Small" onchange="DropDownFilter(this);">
                                            <asp:ListItem Enabled="true" text="Met" Value="0" ></asp:ListItem>
                                            <asp:ListItem Text="Met" Value="1"></asp:ListItem>
                                            <asp:ListItem Text="Not Met" Value="2"></asp:ListItem>
                                            <asp:ListItem Text="NA" Value="3"></asp:ListItem>
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:DropDownList ID="Q08" runat="server" Height="20px" Width="150px" Font-Size="X-Small" onchange="DropDownFilter(this);">
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ControlToValidate="Q08" ID="RequiredFieldValidator8" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>Did the Engineer showcase ownership?<br />
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ID="RequiredFieldValidator9" ControlToValidate="Q09" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>
                                            Follow-up emails<br />
                                            E2E Case management<br />
                                            Escalation Process
                                        </td>
                                        <td>
                                            <asp:DropDownList ID="Q09a" runat="server" Height="20px" Width="150px" Font-Size="X-Small" onchange="DropDownFilter(this);">
                                            <asp:ListItem Enabled="true" text="Met" Value="0" ></asp:ListItem>
                                            <asp:ListItem Text="Met" Value="1"></asp:ListItem>
                                            <asp:ListItem Text="Not Met" Value="2"></asp:ListItem>
                                            <asp:ListItem Text="NA" Value="3"></asp:ListItem>
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:DropDownList ID="Q10" runat="server" Height="20px" Width="150px" Font-Size="X-Small" onchange="DropDownFilter(this);">
                                            <asp:ListItem Enabled="true" text="--Choose--" Value="0" ></asp:ListItem>
                                            <asp:ListItem Text="Met" Value="1"></asp:ListItem>
                                            <asp:ListItem Text="No Documentation" Value="2"></asp:ListItem>
                                            <asp:ListItem Text="Partial" Value="3"></asp:ListItem>
                                            <asp:ListItem Text="Usage of Relevant templates" Value="4"></asp:ListItem>
    ...
    <script type="text/javascript">
        ...
        function DropDownFilter() {
            ...
            //-----------------------Dropdown Scoring----------------------
            if ((q1.options[q1.selectedIndex].text == 'Met') || (q1.options[q1.selectedIndex].text == '--Choose--') || (q1.options[q1.selectedIndex].text == 'NA')) {
            ...
            if ((q4.options[q4.selectedIndex].text == 'Met') || (q4.options[q4.selectedIndex].text == '--Choose--') || (q4.options[q4.selectedIndex].text == 'NA')) {
                SelectedValue += Number(0);
                CC += Number(0);
            }
            else
            ...
            if ((q5.options[q5.selectedIndex].text == 'Met')) {
                ...
                if ((q5a.options[q5a.selectedIndex].text == 'Not Met') || (q5b.options[q5b.selectedIndex].text == 'Not Met') || (q5c.options[q5c.selectedIndex].text == 'Not Met') || (q5d.options[q5d.selectedIndex].text == 'Not Met')) {
                    SelectedValue += Number(5);
                    CC += Number(5);
                }
            }//Qstn 5
            ...
            if ((q7.options[q7.selectedIndex].text == 'Met') || (q7.options[q7.selectedIndex].text == 'NA') || (q7.options[q7.selectedIndex].text == '--Choose--')) {
                SelectedValue += Number(0);
                CC += Number(0);
            }
            else {
            ...
            if ((q9.options[q9.selectedIndex].text == 'Met')) {
                SelectedValue += Number(0);
                ...
                document.getElementById('Q09a').options[q9a.selectedIndex].text = "Met";
                document.getElementById('Q09b').options[q9b.selectedIndex].text = "Met";
                document.getElementById('Q09c').options[q9c.selectedIndex].text = "Met";
            }
            else if ((q9.options[q9.selectedIndex].text == 'NA')) {
                SelectedValue += Number(0);
                document.getElementById('Q09a').disabled = true;
                document.getElementById('Q09b').disabled = true;
                document.getElementById('Q09c').disabled = true;
                document.getElementById('Q09a').options[q9a.selectedIndex].text = "NA";
                document.getElementById('Q09b').options[q9b.selectedIndex].text = "NA";
                document.getElementById('Q09c').options[q9c.selectedIndex].text = "NA";
            }
                ...
                if ((q9a.options[q9a.selectedIndex].text == 'Not Met') || (q9b.options[q9b.selectedIndex].text == 'Not Met') || (q9c.options[q9c.selectedIndex].text == 'Not Met')) {

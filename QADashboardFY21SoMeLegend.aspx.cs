...
{
    public partial class QADashboardFY21SoMeLegend : System.Web.UI.Page
    {
        ...
        public void bind_data()
        {
            ...
            else
            {
                ...
                SqlCommand query1 = new SqlCommand("SELECT count(AuditResult) from [dbo].[FY21SoMeLegend] where QAName='" + emp_name + "'", Con);
                ...
                SqlCommand query2 = new SqlCommand("SELECT count(AuditResult) from [dbo].[FY21SoMeLegend] where QAName='" + emp_name + "' and AuditResult = 'Pass'", Con);
                ...
                SqlCommand query3 = new SqlCommand("SELECT count(AuditResult) from [dbo].[FY21SoMeLegend] where QAName='" + emp_name + "' and AuditResult = 'Fail'", Con);
                ...
                SqlCommand query4 = new SqlCommand("SELECT ISNULL(AVG([AuditScore]),0) from [dbo].[FY21SoMeLegend] where QAName='" + emp_name + "'", Con);
                ...
                "select QAName, " +
                 ...
                 "from FY21SoMeLegend where AuditCount > 0 group by QAName) as Table1 where QAName = '" + emp_name + "' group by QAName", Con);
                ...
                SqlDataSource1.SelectCommand = "select EmployeeID,Employee_Name,CaseID,CallDate,EvaluationDate,QAName,AuditStatus,AuditScore FROM [dbo].[FY21SoMeLegend] where QAName='" + emp_name + "' order by AuditCount desc";
                ...
                //SqlDataSource2.SelectCommand = "Select Employee_Name,EvaluationDate,Opening,ToolUsage,Probing,Troubleshooting,Sol_Res,Behavioural,Communication,CustObsdBehav,CaseFollowUp,CaseOwnership,Case_Call_Logging,Closing from FY21SoMeLegend where QAName='" + emp_name + "' order by AuditCount desc";
        ...
        protected void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("AuditSheetSoMeQA.aspx?case=" + cass);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.Page.Controls.Add(SqlDataSource1);
                SqlDataSource1.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["CString"].ConnectionString;
                SqlDataSource1.SelectCommand = "select EmployeeID,Employee_Name,CaseID,CallDate,EvaluationDate,QAName,AuditStatus,AuditScore FROM [dbo].[FY21SoMeLegend] where CaseID='" + searchbar.Text + "' or EmployeeID='" + searchbar.Text + "' order by AuditCount desc";
                UserGrid.DataSource = SqlDataSource1;
                UserGrid.DataBind();
            }
            catch (Exception ex)

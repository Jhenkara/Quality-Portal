...
{
    public partial class AuditSheetMgrFY22Swivel : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("Select * from [dbo].[FY22SwivelDaasLegend] where (CallID_SR_ID=@CallID_SR_ID and Reporting_Manager_Mail=@Username) or (CallID_SR_ID=@CallID_SR_ID and TLMail=@Username) or (CallID_SR_ID=@CallID_SR_ID and CCMail like '%'+ @Username + '%')", Con);
            ...
            Q01.Text = dtt.Rows[0]["TimelyAction"].ToString();
            Q01.ReadOnly = true;

            C01.Text = dtt.Rows[0]["TimelyAction_Cmnts"].ToString();
            C01.ReadOnly = true;

            Q02.Text = dtt.Rows[0]["RightProcess"].ToString();
            Q02.ReadOnly = true;

            C02.Text = dtt.Rows[0]["RightProcess_Cmnts"].ToString();
            C02.ReadOnly = true;

            Q03.Text = dtt.Rows[0]["ToolUsage"].ToString();
            Q03.ReadOnly = true;

            C03.Text = dtt.Rows[0]["ToolUsage_Cmnts"].ToString();
            C03.ReadOnly = true;

            Q04.Text = dtt.Rows[0]["RightParticulars"].ToString();
            Q04.ReadOnly = true;

            C04.Text = dtt.Rows[0]["RightParticulars_Cmnts"].ToString();
            C04.ReadOnly = true;

            Q05.Text = dtt.Rows[0]["Behavioural"].ToString();
            Q05.ReadOnly = true;
            ...
            Q06.Text = dtt.Rows[0]["EmailComm"].ToString();
            Q06.ReadOnly = true;

            Q06a.Text = dtt.Rows[0]["EmailComm1"].ToString();
            Q06a.ReadOnly = true;

            Q06b.Text = dtt.Rows[0]["EmailComm2"].ToString();
            Q06b.ReadOnly = true;

            Q06c.Text = dtt.Rows[0]["EmailComm3"].ToString();
            Q06c.ReadOnly = true;

            C06.Text = dtt.Rows[0]["EmailComm_Cmnts"].ToString();
            C06.ReadOnly = true;

            Q07.Text = dtt.Rows[0]["Callback"].ToString();
            Q07.ReadOnly = true;

            C07.Text = dtt.Rows[0]["Callback_Cmnts"].ToString();
            C07.ReadOnly = true;

            Q08.Text = dtt.Rows[0]["SetRightExpectations"].ToString();
            Q08.ReadOnly = true;
            ...
            Q09a.Text = dtt.Rows[0]["Ownership1"].ToString();
            Q09a.ReadOnly = true;

            Q09b.Text = dtt.Rows[0]["Ownership2"].ToString();
            Q09b.ReadOnly = true;

            Q09c.Text = dtt.Rows[0]["Ownership3"].ToString();
            Q09c.ReadOnly = true;

            C09.Text = dtt.Rows[0]["Ownership_Cmnts"].ToString();
            C09.ReadOnly = true;

            Q10.Text = dtt.Rows[0]["Documentation"].ToString();
            Q10.ReadOnly = true;
        ...
        {
            Con.Open();
            SqlCommand cmd = new SqlCommand("Update [dbo].[FY22SwivelDaasLegend] SET [AuditStatus]='Accepted by Manager' where CallID_SR_ID=@CallID_SR_ID", Con);
            cmd.Parameters.AddWithValue("@CallID_SR_ID", Request.QueryString["case"].ToString());
            cmd.ExecuteNonQuery();
            Con.Close();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Your Response has been Received successfully');window.location ='MgrDashboardKSwivel.aspx';", true);
        }
        ...
        private bool SendEmail(string to, string from, string password, string subject, string body, string cc)
        {
            ...
            try
            {
                ...
                mail.Subject = "Swivel Daas Audit | " + tbId3.Text + " | Dispute";
                mail.Body = body;
        ...
        public bool maildetails()
        {
            ...
            string body = "http://15.42.19.247:120/AuditSheetSwivelQA.aspx?case=" + tbId7.Text;
        ...
        protected void DisputeOptions(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                SqlCommand cmd = new SqlCommand("Update [dbo].[FY22SwivelDaasLegend] SET [AuditStatus]='Disputed by Manager' where CallID_SR_ID=@CallID_SR_ID", Con);
                cmd.Parameters.AddWithValue("@CallID_SR_ID", Request.QueryString["case"].ToString());
                cmd.Connection = Con;
                cmd.ExecuteNonQuery();
                Con.Close();
                maildetails();
                ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Your Response has been Received successfully');window.location ='MgrDashboardSwivel.aspx';", true);
            }
        }
    }
}
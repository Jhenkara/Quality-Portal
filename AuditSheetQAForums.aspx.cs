...
{
    public partial class AuditSheetQAForums : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("Select * from [dbo].[SoMeForum_Legend] where CaseID=@CaseID and QAMail=@Username", Con);
            ...
            A5.SelectedItem.Text = dtt.Rows[0]["A5"].ToString();
            ...
            C5.SelectedItem.Text = dtt.Rows[0]["C5"].ToString();
            ...
            E4.SelectedItem.Text = dtt.Rows[0]["E4"].ToString();
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            Con.Close();
            //maildetails();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Audit Updated Successfully');window.location ='QADashboardForums.aspx';", true);
        }
    }
}
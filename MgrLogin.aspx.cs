...
{
    public partial class MgrLogin : System.Web.UI.Page
    {
        ...
        protected void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            string query = "SELECT COUNT(1) FROM UserCredentials where Username=@Username and Password=@Password and Roles in ('MGR','Poly_MGR','TL','Poly_TL')";

...
{
    public partial class AuditFeedbackFormVoice : System.Web.UI.Page
    {
        ...
        protected void btnFeedBk_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("Select Employee_Name,EmployeeID,Employee_Mail,CaseID from FY21VoiceLegend where CallID_SR_ID=@CallID_SR_ID", Con);
            ...
            string case_id = dtt.Rows[0]["CaseID"].ToString();
            tbId2.Text = emp_id;
            tbId2.ReadOnly = true;
            tbId3.Text = emp_name;
            tbId3.ReadOnly = true;
        ...
        //private bool SendFDBKEmail()
        //{
        //    string QAName = Convert.ToString(Session["Username"]);
        //    string from = QAName;
        //    string getTo = TextBox3.Text;
        //    string getCC = QAName;
        //    string[] ccc = TextBox4.Text.Split(';');
        //    foreach (string CCEmail in ccc)
        //    {
        ...
        public bool maildetailsFDBK()
        {
            ...
            string call_id = "Call ID is : " + CallId.Text + " and Case ID is : " + CaseID.Text;
            ...
            sb.AppendLine("</tr>");
            sb.AppendLine("<tr>");
            sb.AppendLine("<td colspan=2>&nbsp;&nbsp;&nbsp;&nbsp; " + call_id + "</td>");
            sb.AppendLine("</tr>");
            sb.AppendLine("<tr>");
            sb.AppendLine("<th colspan=2><br> </th>");
        ...
        {
            Con.Open();
            SqlCommand cmd = new SqlCommand("Update FY21VoiceLegend SET [Feedback]=@Feedback where CallID_SR_ID=@CallID_SR_ID", Con);
            ...
            maildetailsFDBK();
            //SendFDBKEmail();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Feedback sent and saved');window.location ='21_VoiceLegend.aspx';", true);
        }
    }
}
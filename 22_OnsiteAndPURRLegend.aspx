<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="22_OnsiteAndPURRLegend.aspx.cs" Inherits="Audit_Legends._22_OnsiteAndPURRLegend" %>
...
<head>
    ...
    <title>Onsite and PURR Audit Form</title>
...
<body>
    ...
    <div class="auto-style1" style="color:aliceblue;background-color:#4d4e4f;text-align:left;line-height:100px;width:100%">
        ...
        <h1><img src="Images/hp_logo_white.png" style="width:98px;overflow:auto;float:initial;"/> Onsite and PURR Audit Form </h1>
    </div>
...
<%--        <asp:Button ID="SoMe_GuideLines" CausesValidation="false" runat="server" Text="View Guidelines" CssClass="MenuButtons" OnClick="SoMe_GuideLines_Click" OnClientClick="SetTarget();return false;"/>--%>
        <script type="text/javascript">
        function SetTarget() {
            window.open("21_DOALegendGL.aspx");
                        ...
                        <div class="row">
                            ...
                            <table id="table2" border="1" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td >Did the Engineer pick up the case within TAT?<br />
                                        </td>
                                        <td></td>
                                    ...
                                    <tr>
                                        <td>Was the Work order/PURR scheduled correctly?</td>
                                        <td></td>
                                    ...
                                    <tr>
                                        <td>
                                            Was the Part ordered accurately with delivery instructions along with badge ID?</td>
                                        <td>
                                        </td>
                                    ...
                                    <tr>
                                        <td>Did the Engineer update the correct RDT /use proper documentation when required?</td>
                                        <td>
                                        </td>
                                    ...
                                    <tr>
                                        <td>Did the Engineer update KCI & set right expectations about onsite visit ? <br />
                                        </td>
                                        <td>
                                        </td>
                                    ...
                                    <tr>
                                        <td>Did the Engineer update consignment details & set right expectations about pick up? <br />
                                        </td>
                                        <td>
                                        </td>
                                    ...
                                    <tr>
                                        <td>Did the Engineer dispatch the Main case/Task to appropriate Queues/Team?<br />
                                        </td>
                                        <td></td>
                                    ...
                                    <tr>
                                        <td>Did the Engineer update google sheet\share point\Case notes? <br />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>Did the Engineer confirm address and update in CDAX and relevant reports?<br />
                                        </td>
                                        <td>

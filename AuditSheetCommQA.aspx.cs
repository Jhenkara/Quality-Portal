...
{
    public partial class AuditSheetCommQA : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("Select * from AuditLegendComm where CaseID=@CaseID and QAMail=@Username", Con);
            ...
            TextBox6.Text = dtt.Rows[0]["CSO"].ToString();
            ...
            C17.SelectedItem.Text = dtt.Rows[0]["TraQue3"].ToString();

            C18.SelectedItem.Text = dtt.Rows[0]["TraQue4"].ToString();

            C19.SelectedItem.Text = dtt.Rows[0]["TraQue5"].ToString();

            C20.SelectedItem.Text = dtt.Rows[0]["TraQue5"].ToString();

            C21.SelectedItem.Text = dtt.Rows[0]["TraQue6"].ToString();
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@CSO", TextBox6.Text);
            ...
            cmd.Parameters.AddWithValue("@TraQue3", C17.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@TraQue4", C18.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@TraQue5", C19.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@TraQue6", C20.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@TraQue7", C21.SelectedItem.Text);
            SqlDataReader dr = cmd.ExecuteReader();
            Con.Close();
            //maildetails();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Audit Updated Successfully');window.location ='QADashboardComm.aspx';", true);
        }
    }
}
...
{
    public partial class AuditSheetADXQA : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("Select * from [dbo].[FY21ADXLegend] where CaseID=@CaseID and QAMail=@Username", Con);
            ...
            Q12.SelectedItem.Text = dtt.Rows[0]["ToolUsage"].ToString();

            Q12a.SelectedItem.Text = dtt.Rows[0]["ToolUsage1"].ToString();

            Q12b.SelectedItem.Text = dtt.Rows[0]["ToolUsage2"].ToString();

            Q12c.SelectedItem.Text = dtt.Rows[0]["ToolUsage3"].ToString();

            Q12d.SelectedItem.Text = dtt.Rows[0]["ToolUsage4"].ToString();

            Q12e.SelectedItem.Text = dtt.Rows[0]["ToolUsage5"].ToString();

            C12.Text = dtt.Rows[0]["ToolUsage_Cmnts"].ToString();

            Q02.SelectedItem.Text = dtt.Rows[0]["Probing"].ToString();

            C02.Text = dtt.Rows[0]["Probing_Cmnts"].ToString();

            Q03.SelectedItem.Text = dtt.Rows[0]["Troubleshooting"].ToString();

            C03.Text = dtt.Rows[0]["Troubleshooting_Cmnts"].ToString();
            ...
            Q06.SelectedItem.Text = dtt.Rows[0]["CaseOwnership"].ToString();

            Q06a.SelectedItem.Text = dtt.Rows[0]["CaseOwnership1"].ToString();

            Q06b.SelectedItem.Text = dtt.Rows[0]["CaseOwnership2"].ToString();

            Q06c.SelectedItem.Text = dtt.Rows[0]["CaseOwnership3"].ToString();

            C06.Text = dtt.Rows[0]["CaseOwnership_Cmnts"].ToString();

            Q07.SelectedItem.Text = dtt.Rows[0]["Behavioural"].ToString();

            Q07a.SelectedItem.Text = dtt.Rows[0]["Behavioural1"].ToString();

            Q07b.SelectedItem.Text = dtt.Rows[0]["Behavioural2"].ToString();

            Q07c.SelectedItem.Text = dtt.Rows[0]["Behavioural3"].ToString();

            Q07d.SelectedItem.Text = dtt.Rows[0]["Behavioural4"].ToString();

            Q07e.SelectedItem.Text = dtt.Rows[0]["Behavioural5"].ToString();

            Q07f.SelectedItem.Text = dtt.Rows[0]["Behavioural6"].ToString();

            C07.Text = dtt.Rows[0]["Behavioural_Cmnts"].ToString();

            Q08.SelectedItem.Text = dtt.Rows[0]["Communication"].ToString();

            Q08a.SelectedItem.Text = dtt.Rows[0]["Communication1"].ToString();

            Q08b.SelectedItem.Text = dtt.Rows[0]["Communication2"].ToString();

            Q08c.SelectedItem.Text = dtt.Rows[0]["Communication3"].ToString();

            C08.Text = dtt.Rows[0]["Communication_Cmnts"].ToString();

            Q09.SelectedItem.Text = dtt.Rows[0]["CallEtiquettes"].ToString();

            Q09a.SelectedItem.Text = dtt.Rows[0]["CallEtiquettes1"].ToString();

            Q09b.SelectedItem.Text = dtt.Rows[0]["CallEtiquettes2"].ToString();

            Q09c.SelectedItem.Text = dtt.Rows[0]["CallEtiquettes3"].ToString();

            Q09d.SelectedItem.Text = dtt.Rows[0]["CallEtiquettes4"].ToString();

            Q09e.SelectedItem.Text = dtt.Rows[0]["CallEtiquettes5"].ToString();

            Q09f.SelectedItem.Text = dtt.Rows[0]["CallEtiquettes6"].ToString();

            Q09g.SelectedItem.Text = dtt.Rows[0]["CallEtiquettes7"].ToString();

            C09.Text = dtt.Rows[0]["CallEtiquettes_Cmnts"].ToString();

            Q10.SelectedItem.Text = dtt.Rows[0]["CaseHandling"].ToString();

            C10.Text = dtt.Rows[0]["CaseHandling_Cmnts"].ToString();

            Q11.SelectedItem.Text = dtt.Rows[0]["WOW_DAB"].ToString();

            C11.Text = dtt.Rows[0]["WOW_DAB_Cmnts"].ToString();
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            string CommandText = "UPDATE [dbo].[FY21ADXLegend] SET Month=@Month,EmployeeID=@EmployeeID,Employee_Name=@Employee_Name,Employee_Mail=@Employee_Mail,TLName=@TLName,TLMail=@TLMail,Reporting_Manager=@Reporting_Manager,Reporting_Manager_Mail=@Reporting_Manager_Mail,TeamName=@TeamName,CCMail=@CCMail,CaseID=@CaseID,CallID_SR_ID=@CallID_SR_ID,NonCompliance=@NonCompliance,NonComplianceDetail=@NonComplianceDetail,NonComplianceScore=@NonComplianceScore,AuditScore=@AuditScore,CustCritical=@CustCritical,BusCritical=@BusCritical,Opening=@Opening,Opening1=@Opening1,Opening2=@Opening2,Opening_Cmnts=@Opening_Cmnts,ToolUsage=@ToolUsage,ToolUsage1=@ToolUsage1,ToolUsage2=@ToolUsage2,ToolUsage3=@ToolUsage3,ToolUsage4=@ToolUsage4,ToolUsage5=@ToolUsage5,ToolUsage_Cmnts=@ToolUsage_Cmnts,Probing=@Probing,Probing_Cmnts=@Probing_Cmnts,Troubleshooting=@Troubleshooting,Troubleshooting_Cmnts=@Troubleshooting_Cmnts,Sol_Res=@Sol_Res,Sol_Res_Cmnts=@Sol_Res_Cmnts,Setting_Expectation=@Setting_Expectation,Setting_Expectation_Cmnts=@Setting_Expectation_Cmnts,CaseOwnership=@CaseOwnership,CaseOwnership1=@CaseOwnership1,CaseOwnership2=@CaseOwnership2,CaseOwnership3=@CaseOwnership3,CaseOwnership_Cmnts=@CaseOwnership_Cmnts,Behavioural=@Behavioural,Behavioural1=@Behavioural1,Behavioural2=@Behavioural2,Behavioural3=@Behavioural3,Behavioural4=@Behavioural4,Behavioural5=@Behavioural5,Behavioural6=@Behavioural6,Behavioural_Cmnts=@Behavioural_Cmnts,Communication=@Communication,Communication1=@Communication1,Communication2=@Communication2,Communication3=@Communication3,Communication_Cmnts=@Communication_Cmnts,CallEtiquettes=@CallEtiquettes,CallEtiquettes1=@CallEtiquettes1,CallEtiquettes2=@CallEtiquettes2,CallEtiquettes3=@CallEtiquettes3,CallEtiquettes4=@CallEtiquettes4,CallEtiquettes5=@CallEtiquettes5,CallEtiquettes6=@CallEtiquettes6,CallEtiquettes7=@CallEtiquettes7,CallEtiquettes_Cmnts=@CallEtiquettes_Cmnts,CaseHandling=@CaseHandling,CaseHandling_Cmnts=@CaseHandling_Cmnts,WOW_DAB=@WOW_DAB,WOW_DAB_Cmnts=@WOW_DAB_Cmnts,AuditResult=@AuditResult,[AuditStatus]='Resolved' WHERE CaseID=@CaseID";
            ...
            cmd.Parameters.AddWithValue("@ToolUsage", Q12.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@ToolUsage1", Q12a.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@ToolUsage2", Q12b.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@ToolUsage3", Q12c.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@ToolUsage4", Q12d.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@ToolUsage5", Q12e.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@ToolUsage_Cmnts", C12.Text);
            cmd.Parameters.AddWithValue("@Probing", Q02.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Probing_Cmnts", C02.Text);
            cmd.Parameters.AddWithValue("@Troubleshooting", Q03.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Troubleshooting_Cmnts", C03.Text);
            ...
            cmd.Parameters.AddWithValue("@CaseOwnership", Q06.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CaseOwnership1", Q06a.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CaseOwnership2", Q06b.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CaseOwnership3", Q06c.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CaseOwnership_Cmnts", C06.Text);
            cmd.Parameters.AddWithValue("@Behavioural", Q07.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Behavioural1", Q07a.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Behavioural2", Q07b.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Behavioural3", Q07c.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Behavioural4", Q07d.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Behavioural5", Q07e.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Behavioural6", Q07f.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Behavioural_Cmnts", C07.Text);
            cmd.Parameters.AddWithValue("@Communication", Q08.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Communication1", Q08a.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Communication2", Q08b.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Communication3", Q08c.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Communication_Cmnts", C08.Text);
            cmd.Parameters.AddWithValue("@CallEtiquettes", Q09.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CallEtiquettes1", Q09a.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CallEtiquettes2", Q09b.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CallEtiquettes3", Q09c.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CallEtiquettes4", Q09d.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CallEtiquettes5", Q09e.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CallEtiquettes6", Q09f.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CallEtiquettes7", Q09g.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CallEtiquettes_Cmnts", C09.Text);
            cmd.Parameters.AddWithValue("@CaseHandling", Q10.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CaseHandling_Cmnts", C10.Text);
            cmd.Parameters.AddWithValue("@WOW_DAB", Q11.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@WOW_DAB_Cmnts", C11.Text);
            cmd.Parameters.AddWithValue("@AuditResult", hfv_AuditRes.Value);
            SqlDataReader dr = cmd.ExecuteReader();
            Con.Close();
            maildetails();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Audit Updated Successfully');window.location ='QADashboardFY21ADXLegend.aspx';", true);
        }
        protected void FileDownload(object sender, EventArgs e)
        {
            Response.Redirect("~/Download/FY23 ADX Report.xlsx");
        }
        ...
        private bool ResendEmail(string to, string from, string password, string subject, string body, string cc, string tl)
        {
            ...
            try
            {
                ...
                mail.Subject = "ADX Audit | " + ddMonth.SelectedItem.Text + " | " + tbId3.Text;
                mail.Body = body;
        ...
        public bool resend_maildetails()
        {
            ...
            string body = "http://15.42.19.247:120/AuditSheetUserFY21ADX.aspx?case=" + tbId6.Text;
            ...
            string body4 = "http://15.42.19.247:120/AuditSheetMgrFY21ADX.aspx?case=" + tbId6.Text;
        ...
        private bool SendEmail(string to, string from, string password, string subject, string body, string cc, string tl)
        {
            ...
            try
            {
                ...
                mail.Subject = "Resolved ADX Audit | " + ddMonth.SelectedItem.Text + " | " + tbId3.Text;
                mail.Body = body;
                mail.IsBodyHtml = true;
                SmtpServer.Port = Convert.ToInt32(ConfigurationManager.AppSettings["smtpPort"]);
                SmtpServer.UseDefaultCredentials = false;
        ...
        {
            Response.Redirect("QADashboardFY21ADXLegend.aspx");
        }

        protected void btnCaseIdCheck_Click(object sender, EventArgs e)
        {
            Con.Open();
            SqlCommand cmd = new SqlCommand("select * from [dbo].[FY21ADXLegend] where CaseID=@CaseId", Con);
            cmd.Parameters.AddWithValue("@CaseId", tbId6.Text);
            cmd.Connection = Con;
            SqlDataReader dr = cmd.ExecuteReader();
        ...
        {
            Con.Open();
            SqlCommand cmd = new SqlCommand("select * from [dbo].[FY21ADXLegend] where CallID_SR_ID=@CallID_SR_ID", Con);
            cmd.Parameters.AddWithValue("@CallID_SR_ID", tbId7.Text);
            cmd.Connection = Con;
            SqlDataReader dr = cmd.ExecuteReader();
        ...
        {
            Response.Redirect("AuditFeedbackFormADX.aspx");
        }
        ...
        {
            resend_maildetails();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Mail Resent Successfully');window.location ='QADashboardFY21ADXLegend.aspx';", true);
        }
    }
}
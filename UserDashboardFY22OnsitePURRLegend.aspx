<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserDashboardFY22OnsitePURRLegend.aspx.cs" Inherits="Audit_Legends.UserDashboardFY22OnsitePURRLegend" %>
...
<body>
    ...
    <div class="col-sm-6" style="margin-left:20px;">
        <asp:TextBox ID="searchbar" CssClass="form-check-inline" AutoCompleteType="Disabled" placeholder="Enter the Call ID here" BorderStyle="Inset" runat="server" Height="25px" Width="400px"></asp:TextBox>

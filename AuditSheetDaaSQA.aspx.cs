...
{
    public partial class AuditSheetDaaSQA : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("Select * from [dbo].[FY22_DaaSLegend] where CallID_SR_ID=@CallID_SR_ID and QAMail=@Username", Con);
            ...
            Q10.SelectedItem.Text = dtt.Rows[0]["Callback"].ToString();

            C10.Text = dtt.Rows[0]["Callback_Cmnts"].ToString();

            Q11.SelectedItem.Text = dtt.Rows[0]["CaseOwnership"].ToString();

            Q11a.SelectedItem.Text = dtt.Rows[0]["CaseOwnership1"].ToString();

            Q11b.SelectedItem.Text = dtt.Rows[0]["CaseOwnership2"].ToString();

            Q11c.SelectedItem.Text = dtt.Rows[0]["CaseOwnership3"].ToString();

            C11.Text = dtt.Rows[0]["CaseOwnership_Cmnts"].ToString();

            Q12.SelectedItem.Text = dtt.Rows[0]["Case_Call_Logging"].ToString();

            C12.Text = dtt.Rows[0]["Case_Call_Logging_Cmnts"].ToString();

            Q13.SelectedItem.Text = dtt.Rows[0]["Closing"].ToString();
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@Callback", Q10.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Callback_Cmnts", C10.Text);
            cmd.Parameters.AddWithValue("@CaseOwnership", Q11.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CaseOwnership1", Q11a.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CaseOwnership2", Q11b.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CaseOwnership3", Q11c.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@CaseOwnership_Cmnts", C11.Text);
            cmd.Parameters.AddWithValue("@Case_Call_Logging", Q12.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Case_Call_Logging_Cmnts", C12.Text);
            cmd.Parameters.AddWithValue("@Closing", Q13.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Closing_Cmnts", C13.Text);
            cmd.Parameters.AddWithValue("@AuditResult", hfv_AuditRes.Value);
            SqlDataReader dr = cmd.ExecuteReader();
            Con.Close();
            maildetails();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Audit Updated Successfully');window.location ='QADashboardFY22DaaSLegend.aspx';", true);
        }
        ...
        private bool ResendEmail(string to, string from, string password, string subject, string body, string cc, string tl)
        {
            ...
            try
            {
                ...
                mail.Subject = "India and APJ DaaS Audit | " + ddMonth.SelectedItem.Text + " | " + tbId3.Text;
                mail.Body = body;
        ...
        public bool resend_maildetails()
        {
            ...
            string body = "http://15.42.19.247:120/AuditSheetUserFY22DaaS.aspx?case=" + tbId7.Text;
            ...
            string body4 = "http://15.42.19.247:120/AuditSheetMgrFY22DaaS.aspx?case=" + tbId7.Text;
        ...
        private bool SendEmail(string to, string from, string password, string subject, string body, string cc, string tl)
        {
            ...
            try
            {
                ...
                mail.Subject = "Resolved India and APJ DaaS Audit | " + ddMonth.SelectedItem.Text + " | " + tbId3.Text;
                mail.Body = body;
                mail.IsBodyHtml = true;
                SmtpServer.Port = Convert.ToInt32(ConfigurationManager.AppSettings["smtpPort"]);
                SmtpServer.UseDefaultCredentials = false;
        ...
        {
            Response.Redirect("~/Download/FY23 DaaS Report.xlsx");
        }

        protected void QADashboard_Click(object sender, EventArgs e)
        {
            Response.Redirect("QADashboardFY22DaaSLegend.aspx");
        }

        protected void btnCaseIdCheck_Click(object sender, EventArgs e)
        {
            Con.Open();
            SqlCommand cmd = new SqlCommand("select * from [dbo].[FY22_DaaSLegend] where CaseID=@CaseId", Con);
            cmd.Parameters.AddWithValue("@CaseId", tbId6.Text);
            cmd.Connection = Con;
            SqlDataReader dr = cmd.ExecuteReader();
        ...
        {
            Con.Open();
            SqlCommand cmd = new SqlCommand("select * from [dbo].[FY22_DaaSLegend] where CallID_SR_ID=@CallID_SR_ID", Con);
            cmd.Parameters.AddWithValue("@CallID_SR_ID", tbId7.Text);
            cmd.Connection = Con;
            SqlDataReader dr = cmd.ExecuteReader();
        ...
        {
            Response.Redirect("AuditFeedbackFormDaaS.aspx");
        }
        ...
        {
            resend_maildetails();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Mail Resent Successfully');window.location ='QADashboardFY22DaaSLegend.aspx';", true);
        }
    }
}
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditSheetUserFY22DaaS.aspx.cs" Inherits="Audit_Legends.AuditSheetUserFY22DaaS" %>
...
<body>
    ...
    <div class="container-fluid" style="text-align:right;align-items:center;height:60px;width:95%;">
        ...
        <asp:Button ID="Voice_GuideLines" CausesValidation="false" runat="server" Text="View Guidelines" target="_blank" CssClass="MenuButtons" OnClientClick="SetTarget();return false;" />
        <script type="text/javascript">
        function SetTarget() {
                            ...
                            <table id="table2" border="1" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="Q11a" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server"></asp:TextBox>

...
{
    public partial class AuditSheetSwivelQA : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("Select * from [dbo].[FY22SwivelDaasLegend] where CallID_SR_ID=@CallID_SR_ID and QAMail=@Username", Con);
            ...
            ddSupportMed.SelectedItem.Text = dtt.Rows[0]["SupportMedium"].ToString();
            ...
            Q01.SelectedItem.Text = dtt.Rows[0]["TimelyAction"].ToString();

            C01.Text = dtt.Rows[0]["TimelyAction_Cmnts"].ToString();

            Q02.SelectedItem.Text = dtt.Rows[0]["RightProcess"].ToString();

            C02.Text = dtt.Rows[0]["RightProcess_Cmnts"].ToString();

            Q03.SelectedItem.Text = dtt.Rows[0]["ToolUsage"].ToString();

            C03.Text = dtt.Rows[0]["ToolUsage_Cmnts"].ToString();

            Q04.SelectedItem.Text = dtt.Rows[0]["RightParticulars"].ToString();

            C04.Text = dtt.Rows[0]["RightParticulars_Cmnts"].ToString();
            ...
            Q06.SelectedItem.Text = dtt.Rows[0]["EmailComm"].ToString();

            Q06a.SelectedItem.Text = dtt.Rows[0]["EmailComm1"].ToString();

            Q06b.SelectedItem.Text = dtt.Rows[0]["EmailComm2"].ToString();

            Q06c.SelectedItem.Text = dtt.Rows[0]["EmailComm3"].ToString();

            C06.Text = dtt.Rows[0]["EmailComm_Cmnts"].ToString();

            Q07.SelectedItem.Text = dtt.Rows[0]["Callback"].ToString();

            C07.Text = dtt.Rows[0]["Callback_Cmnts"].ToString();

            Q08.SelectedItem.Text = dtt.Rows[0]["SetRightExpectations"].ToString();

            C08.Text = dtt.Rows[0]["SetRightExpectations_Cmnts"].ToString();

            Q09.SelectedItem.Text = dtt.Rows[0]["Ownership"].ToString();

            Q09a.SelectedItem.Text = dtt.Rows[0]["Ownership1"].ToString();

            Q09b.SelectedItem.Text = dtt.Rows[0]["Ownership2"].ToString();

            Q09c.SelectedItem.Text = dtt.Rows[0]["Ownership3"].ToString();

            C09.Text = dtt.Rows[0]["Ownership_Cmnts"].ToString();

            Q10.SelectedItem.Text = dtt.Rows[0]["Documentation"].ToString();

            C10.Text = dtt.Rows[0]["Documentation_Cmnts"].ToString();
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            string CommandText = "UPDATE [dbo].[FY22SwivelDaasLegend] SET Month=@Month,EmployeeID=@EmployeeID,Employee_Name=@Employee_Name,Employee_Mail=@Employee_Mail,TLName=@TLName,TLMail=@TLMail,Reporting_Manager=@Reporting_Manager,Reporting_Manager_Mail=@Reporting_Manager_Mail,TeamName=@TeamName,CCMail=@CCMail,CaseID=@CaseID,CallID_SR_ID=@CallID_SR_ID,NonCompliance=@NonCompliance,NonComplianceDetail=@NonComplianceDetail,NonComplianceScore=@NonComplianceScore,AuditScore=@AuditScore,CustCritical=@CustCritical,BusCritical=@BusCritical,TimelyAction=@TimelyAction,TimelyAction_Cmnts=@TimelyAction_Cmnts,RightProcess=@RightProcess,RightProcess_Cmnts=@RightProcess_Cmnts,ToolUsage=@ToolUsage,ToolUsage_Cmnts=@ToolUsage_Cmnts,RightParticulars=@RightParticulars,RightParticulars_Cmnts=@RightParticulars_Cmnts,Behavioural=@Behavioural,Behavioural1=@Behavioural1,Behavioural2=@Behavioural2,Behavioural3=@Behavioural3,Behavioural4=@Behavioural4,Behavioural_Cmnts=@Behavioural_Cmnts,EmailComm=@EmailComm,EmailComm1=@EmailComm1,EmailComm2=@EmailComm2,EmailComm3=@EmailComm3,EmailComm_Cmnts=@EmailComm_Cmnts,Callback=@Callback,Callback_Cmnts=@Callback_Cmnts,SetRightExpectations=@SetRightExpectations,SetRightExpectations_Cmnts=@SetRightExpectations_Cmnts,Ownership=@Ownership,Ownership1=@Ownership1,Ownership2=@Ownership2,Ownership3=@Ownership3,Ownership_Cmnts=@Ownership_Cmnts,Documentation=@Documentation,Documentation_Cmnts=@Documentation_Cmnts,AuditResult=@AuditResult,[AuditStatus]='Resolved' WHERE CallID_SR_ID=@CallID_SR_ID";
            ...
            cmd.Parameters.AddWithValue("@TimelyAction", Q01.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@TimelyAction_Cmnts", C01.Text);
            cmd.Parameters.AddWithValue("@RightProcess", Q02.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@RightProcess_Cmnts", C02.Text);
            cmd.Parameters.AddWithValue("@ToolUsage", Q03.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@ToolUsage_Cmnts", C03.Text);
            cmd.Parameters.AddWithValue("@RightParticulars", Q04.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@RightParticulars_Cmnts", C04.Text);
            ...
            cmd.Parameters.AddWithValue("@EmailComm", Q06.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@EmailComm1", Q06a.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@EmailComm2", Q06b.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@EmailComm3", Q06c.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@EmailComm_Cmnts", C06.Text);
            cmd.Parameters.AddWithValue("@Callback", Q07.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Callback_Cmnts", C07.Text);
            cmd.Parameters.AddWithValue("@SetRightExpectations", Q08.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@SetRightExpectations_Cmnts", C08.Text);
            cmd.Parameters.AddWithValue("@Ownership", Q09.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Ownership1", Q09a.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Ownership2", Q09b.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Ownership3", Q09c.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Ownership_Cmnts", C09.Text);
            cmd.Parameters.AddWithValue("@Documentation", Q10.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Documentation_Cmnts", C10.Text);
            cmd.Parameters.AddWithValue("@AuditResult", hfv_AuditRes.Value);
            SqlDataReader dr = cmd.ExecuteReader();
            Con.Close();
            maildetails();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Audit Updated Successfully');window.location ='QADashboardFY22SwivelLegend.aspx';", true);
        }
        ...
        private bool SendEmail(string to, string from, string password, string subject, string body, string cc, string tl)
        {
            ...
            try
            {
                ...
                mail.Subject = "Resolved Swivel Daas Audit | " + ddMonth.SelectedItem.Text + " | " + tbId3.Text;
                mail.Body = body;
        ...
        public bool maildetails()
        {
            ...
            string body = "http://15.42.19.247:120/AuditSheetUserFY22Swivel.aspx?case=" + tbId7.Text;
            ...
            string body4 = "http://15.42.19.247:120/AuditSheetMgrFY22Swivel.aspx?case=" + tbId7.Text;
        ...
        {
            Response.Redirect("~/ Download / FY23 Swivel Daas Report.xlsx");
        }

        protected void QADashboard_Click(object sender, EventArgs e)
        {
            Response.Redirect("QADashboardFY22SwivelLegend.aspx");
        }

        protected void btnCaseIdCheck_Click(object sender, EventArgs e)
        {
            Con.Open();
            SqlCommand cmd = new SqlCommand("select * from [dbo].[FY22SwivelDaasLegend] where CaseID=@CaseId", Con);
            cmd.Parameters.AddWithValue("@CaseId", tbId6.Text);
            cmd.Connection = Con;
            SqlDataReader dr = cmd.ExecuteReader();
        ...
        {
            Con.Open();
            SqlCommand cmd = new SqlCommand("select * from [dbo].[FY22SwivelDaasLegend] where CallID_SR_ID=@CallID_SR_ID", Con);
            cmd.Parameters.AddWithValue("@CallID_SR_ID", tbId7.Text);
            cmd.Connection = Con;
            SqlDataReader dr = cmd.ExecuteReader();
        ...
        {
            Response.Redirect("AuditFeedbackFormSwivel.aspx");
        }

...
{
    public partial class _21_ADXLegend : System.Web.UI.Page
    {
        ...
        protected void Submit_Button(object sender, EventArgs args)
        {
            ...
            string CommandText = "INSERT INTO [dbo].[FY21ADXLegend](QAName,QAMail,BusinessUnit,BusinessSegment,Month,EmployeeID,Employee_Name,Employee_Mail,TLName,TLMail,Reporting_Manager,Reporting_Manager_Mail,TeamName,CCMail,CallDate,EvaluationDate,CaseID,CallID_SR_ID,CallDuration,AuditType,CaseType,ProblemDescription,NonCompliance,NonComplianceDetail,NonComplianceScore,AuditScore,CustCritical,BusCritical,Opening,Opening1,Opening2,Opening_Cmnts,ToolUsage,ToolUsage1,ToolUsage2,ToolUsage3,ToolUsage4,ToolUsage5,ToolUsage_Cmnts,Probing,Probing_Cmnts,Troubleshooting,Troubleshooting_Cmnts,Sol_Res,Sol_Res_Cmnts,Setting_Expectation,Setting_Expectation_Cmnts,CaseOwnership,CaseOwnership1,CaseOwnership2,CaseOwnership3,CaseOwnership_Cmnts,Behavioural,Behavioural1,Behavioural2,Behavioural3,Behavioural4,Behavioural5,Behavioural6,Behavioural_Cmnts,Communication,Communication1,Communication2,Communication3,Communication_Cmnts,CallEtiquettes,CallEtiquettes1,CallEtiquettes2,CallEtiquettes3,CallEtiquettes4,CallEtiquettes5,CallEtiquettes6,CallEtiquettes7,CallEtiquettes_Cmnts,CaseHandling,CaseHandling_Cmnts,WOW_DAB,WOW_DAB_Cmnts,AuditResult) values " +
                "(@QAName,@QAMail,@BusinessUnit,@BusinessSegment,@Month,@EmployeeID,@Employee_Name,@Employee_Mail,@TLName,@TLMail,@Reporting_Manager,@Reporting_Manager_Mail,@TeamName,@CCMail,@CallDate,@EvaluationDate,@CaseID,@CallID_SR_ID,@CallDuration,@AuditType,@CaseType,@ProblemDescription,@NonCompliance,@NonComplianceDetail,@NonComplianceScore,@AuditScore,@CustCritical,@BusCritical,@Opening,@Opening1,@Opening2,@Opening_Cmnts,@ToolUsage,@ToolUsage1,@ToolUsage2,@ToolUsage3,@ToolUsage4,@ToolUsage5,@ToolUsage_Cmnts,@Probing,@Probing_Cmnts,@Troubleshooting,@Troubleshooting_Cmnts,@Sol_Res,@Sol_Res_Cmnts,@Setting_Expectation,@Setting_Expectation_Cmnts,@CaseOwnership,@CaseOwnership1,@CaseOwnership2,@CaseOwnership3,@CaseOwnership_Cmnts,@Behavioural,@Behavioural1,@Behavioural2,@Behavioural3,@Behavioural4,@Behavioural5,@Behavioural6,@Behavioural_Cmnts,@Communication,@Communication1,@Communication2,@Communication3,@Communication_Cmnts,@CallEtiquettes,@CallEtiquettes1,@CallEtiquettes2,@CallEtiquettes3,@CallEtiquettes4,@CallEtiquettes5,@CallEtiquettes6,@CallEtiquettes7,@CallEtiquettes_Cmnts,@CaseHandling,@CaseHandling_Cmnts,@WOW_DAB,@WOW_DAB_Cmnts,@AuditResult)";
            ...
            Con.Close();
            maildetails();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Audit Saved and Mail sent Successfully');window.location ='21_ADXLegend.aspx';", true);
        }

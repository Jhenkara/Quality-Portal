<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="22_PDRA_RS_RC_Legend.aspx.cs" Inherits="Audit_Legends._22_PDRA_RS_RC_Legend" %>
...
<head>
    ...
    <title>PDRA, RS, RC Audit Form</title>
...
<body>
    ...
    <div class="auto-style1" style="color:aliceblue;background-color:#4d4e4f;text-align:left;line-height:100px;width:100%">
        ...
        <h1><img src="Images/hp_logo_white.png" style="width:98px;overflow:auto;float:initial;"/> PDRA, RS, RC Audit Form </h1>
    </div>
                        ...
                        <div class="row">
                            ...
                            <table id="table2" border="1" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td >Did the Engineer Understand the Customer/CE's request?<br />
                                        </td>
                                        <td></td>
                                    ...
                                    <tr>
                                        <td>Did the Engineer Acknowledge & provide right solution/information?</td>
                                        <td></td>
                                    ...
                                    <tr>
                                        <td>
                                            Did the Engineerfollow proper call opening and closing?</td>
                                        <td>
                                        </td>
                                    ...
                                    <tr>
                                        <td>Did the Engineer Connect the call to the correct team - Call Transfer /collected all required information?</td>
                                        <td>
                                        </td>
                                    ...
                                    <tr>
                                        <td>Did the engineer use proper hold procedure? <br />
                                        </td>
                                        <td>
                                        </td>
                                    ...
                                    <tr>
                                        <td>Was the language & communication satisfactory on the call? <br />
                                        </td>
                                        <td>
                                        </td>

...
{
    public partial class QADashboardHygieneCheck : System.Web.UI.Page
    {
        ...
        public void bind_data()
        {
            ...
            else
            {
                ...
                SqlDataSource1.SelectCommand = "select EmployeeID,Employee_Name,CaseID,Interaction_ID,EvaluationDate,Hygiene_Type,QAName,AuditStatus,Validity FROM [dbo].[FY22HygieneCheckdb] where QAName='" + emp_name + "' order by AuditCount desc";
        ...
        protected void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("HygieneCheckEditQA.aspx?case=" + cass);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.Page.Controls.Add(SqlDataSource1);
                SqlDataSource1.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["CString"].ConnectionString;
                SqlDataSource1.SelectCommand = "select EmployeeID,Employee_Name,CaseID,Interaction_ID,EvaluationDate,Hygiene_Type,QAName,AuditStatus,Validity FROM [dbo].[FY22HygieneCheckdb] where CaseID='" + searchbar.Text + "' or EmployeeID='" + searchbar.Text + "' or Interaction_ID='" + searchbar.Text + "' order by AuditCount desc";
                UserGrid.DataSource = SqlDataSource1;
                UserGrid.DataBind();
            }
            catch (Exception ex)

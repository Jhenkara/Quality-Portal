...
{
    public partial class _22_PDRA_RS_RC_Legend : System.Web.UI.Page
    {
        ...
        protected void Submit_Button(object sender, EventArgs args)
        {
            ...
            string CommandText = "INSERT INTO [dbo].[FY22PDRA_RS_RC_Legend](QAName,QAMail,BusinessUnit,BusinessSegment,Month,EmployeeID,Employee_Name,Employee_Mail,TLName,TLMail,Reporting_Manager,Reporting_Manager_Mail,TeamName,CCMail,CallDate,EvaluationDate,CaseID,CallID_SR_ID,CallDuration,CallType,ProblemDescription,NonCompliance,NonComplianceDetail,NonComplianceScore,AuditScore,CustCritical,BusCritical,Customer_CE_Req,Customer_CE_Req_Cmnts,Sol_Info,Sol_Info_Cmnts,Open_Close,Open_Close_Cmnts,CallTransfer,CallTransfer_Cmnts,HoldProcedure,HoldProcedure_Cmnts,Lang_Communication,Lang_Communication_Cmnts,UpdateNotes,UpdateNotes_Cmnts,UpdatedInSharepoint,UpdatedInSharepoint_Cmnts,AuditResult) values " +
                "(@QAName,@QAMail,@BusinessUnit,@BusinessSegment,@Month,@EmployeeID,@Employee_Name,@Employee_Mail,@TLName,@TLMail,@Reporting_Manager,@Reporting_Manager_Mail,@TeamName,@CCMail,@CallDate,@EvaluationDate,@CaseID,@CallID_SR_ID,@CallDuration,@CallType,@ProblemDescription,@NonCompliance,@NonComplianceDetail,@NonComplianceScore,@AuditScore,@CustCritical,@BusCritical,@Customer_CE_Req,@Customer_CE_Req_Cmnts,@Sol_Info,@Sol_Info_Cmnts,@Open_Close,@Open_Close_Cmnts,@CallTransfer,@CallTransfer_Cmnts,@HoldProcedure,@HoldProcedure_Cmnts,@Lang_Communication,@Lang_Communication_Cmnts,@UpdateNotes,@UpdateNotes_Cmnts,@UpdatedInSharepoint,@UpdatedInSharepoint_Cmnts,@AuditResult)";
            ...
            Con.Close();
            maildetails();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Audit Saved and Mail sent Successfully');window.location ='22_PDRA_RS_RC_Legend.aspx';", true);
        }
        ...
        private bool SendEmail(string to, string from, string password, string subject, string body, string cc, string tl)
        {
            ...
            try
            {
                ...
                mail.Subject = "PDRA RS RC Audit | " + ddMonth.SelectedItem.Text + " | " + tbId3.Text;
                mail.Body = body;

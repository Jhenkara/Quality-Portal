...
{
    public partial class TLDashboardHW : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                if (!IsPostBack)
                {
                    string QA = "select distinct QA_Name from [dbo].[HardwareLegend]";
                    SqlDataAdapter adpt = new SqlDataAdapter(QA, Con);
                    DataTable dt = new DataTable();
                    adpt.Fill(dt);
                    DropDownList1.DataSource = dt;
                    DropDownList1.DataBind();
                    DropDownList1.DataTextField = "QA_Name";
                    DropDownList1.DataBind();
                    DropDownList1.Items.Insert(0, new ListItem("--Select--", "0"));
                    //DropDownList1.Items.Add(new ListItem("- Select -", "-1"));
                    DropDownList5.DataSource = dt;
                    DropDownList5.DataBind();
                    DropDownList5.DataTextField = "QA_Name";
                    DropDownList5.DataBind();
                ...
                if (!IsPostBack)
                {
                    string Mon = "select distinct Month from [dbo].[HardwareLegend]";
                ...
                if (!IsPostBack)
                {
                    string Case = "select distinct Case_Type from [dbo].[HardwareLegend]";
                    SqlDataAdapter adpt = new SqlDataAdapter(Case, Con);
                    DataTable dt = new DataTable();
                    adpt.Fill(dt);
                    DropDownList4.DataSource = dt;
                    DropDownList4.DataBind();
                    DropDownList4.DataTextField = "Case_Type";
                    DropDownList4.DataBind();
                    DropDownList4.Items.Insert(0, new ListItem("--Select--", "0"));
                    DropDownList7.DataSource = dt;
                    DropDownList7.DataBind();
                    DropDownList7.DataTextField = "Case_Type";
                    DropDownList7.DataBind();
        ...
        private void GetChart1Data()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("select Employee_Name,avg(Total_Compliance) as [Total Compliance] from [dbo].[HardwareLegend] where QA_Name='" + DropDownList1.SelectedItem.Text + "' and Month='" + DropDownList3.SelectedItem.Text + "' and Case_Type='" + DropDownList4.SelectedItem.Text + "' group by Employee_Name", Con);
                cmd.Connection = Con;
                Con.Open();
            ...
            {
                SqlCommand cmd = new SqlCommand("select Employee_Name,avg(Total_Compliance) as [Total Compliance] from [dbo].[HardwareLegend] where Month='" + DropDownList3.SelectedItem.Text + "' and Case_Type='" + DropDownList4.SelectedItem.Text + "' group by Employee_Name", Con);
                cmd.Connection = Con;
                Con.Open();
                SqlDataReader dr = cmd.ExecuteReader();
                Graph1.DataBindTable(dr, "Employee_Name");
            ...
            {
                SqlCommand cmd = new SqlCommand("select Employee_Name,avg(Total_Compliance) as [Total Compliance] from [dbo].[HardwareLegend] where QA_Name='" + DropDownList1.SelectedItem.Text + "' and Case_Type='" + DropDownList4.SelectedItem.Text + "' group by Employee_Name", Con);
                cmd.Connection = Con;
                Con.Open();
                SqlDataReader dr = cmd.ExecuteReader();
                Graph1.DataBindTable(dr, "Employee_Name");
            ...
            {
                SqlCommand cmd = new SqlCommand("select Employee_Name,avg(Total_Compliance) as [Total Compliance] from [dbo].[HardwareLegend] where QA_Name='" + DropDownList1.SelectedItem.Text + "' and Month='" + DropDownList3.SelectedItem.Text + "' group by Employee_Name", Con);
                cmd.Connection = Con;
                Con.Open();
                SqlDataReader dr = cmd.ExecuteReader();
                Graph1.DataBindTable(dr, "Employee_Name");
            ...
            {
                SqlCommand cmd = new SqlCommand("select Employee_Name,avg(Total_Compliance) as [Total Compliance] from [dbo].[HardwareLegend] where QA_Name='" + DropDownList1.SelectedItem.Text + "' group by Employee_Name", Con);
                cmd.Connection = Con;
                Con.Open();
                SqlDataReader dr = cmd.ExecuteReader();
                Graph1.DataBindTable(dr, "Employee_Name");
            ...
            {
                SqlCommand cmd = new SqlCommand("select Employee_Name,avg(Total_Compliance) as [Total Compliance] from [dbo].[HardwareLegend] where Month='" + DropDownList3.SelectedItem.Text + "' group by Employee_Name", Con);
                cmd.Connection = Con;
                Con.Open();
                SqlDataReader dr = cmd.ExecuteReader();
                Graph1.DataBindTable(dr, "Employee_Name");
            ...
            {
                SqlCommand cmd = new SqlCommand("select Employee_Name,avg(Total_Compliance) as [Total Compliance] from [dbo].[HardwareLegend] where Case_Type='" + DropDownList4.SelectedItem.Text + "' group by Employee_Name", Con);
                cmd.Connection = Con;
                Con.Open();
                SqlDataReader dr = cmd.ExecuteReader();
                Graph1.DataBindTable(dr, "Employee_Name");

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="22_KCI_2Legend.aspx.cs" Inherits="Audit_Legends._22_KCI_2Legend" %>
...
<%--                                    <tr style="background-color:#1e5eb3;color:white">
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:DropDownList ID="Q06" runat="server" Height="20px" Width="150px" Font-Size="X-Small" onchange="DropDownFilter(this);">
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ControlToValidate="Q06" ID="RequiredFieldValidator15" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>

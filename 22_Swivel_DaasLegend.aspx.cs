...
{
    public partial class _22_Swivel_DaasLegend : System.Web.UI.Page
    {
        ...
        protected void Submit_Button(object sender, EventArgs args)
        {
            ...
            string CommandText = "INSERT INTO [dbo].[FY22SwivelDaasLegend](QAName,QAMail,BusinessUnit,BusinessSegment,Month,EmployeeID,Employee_Name,Employee_Mail,TLName,TLMail,Reporting_Manager,Reporting_Manager_Mail,TeamName,CCMail,CallDate,EvaluationDate,CaseID,CallID_SR_ID,CallDuration,SupportMedium,ProblemDescription,NonCompliance,NonComplianceDetail,NonComplianceScore,AuditScore,CustCritical,BusCritical,TimelyAction,TimelyAction_Cmnts,RightProcess,RightProcess_Cmnts,ToolUsage,ToolUsage_Cmnts,RightParticulars,RightParticulars_Cmnts,Behavioural,Behavioural1,Behavioural2,Behavioural3,Behavioural4,Behavioural_Cmnts,EmailComm,EmailComm1,EmailComm2,EmailComm3,EmailComm_Cmnts,Callback,Callback_Cmnts,SetRightExpectations,SetRightExpectations_Cmnts,Ownership,Ownership1,Ownership2,Ownership3,Ownership_Cmnts,Documentation,Documentation_Cmnts,AuditResult) values " +
                "(@QAName,@QAMail,@BusinessUnit,@BusinessSegment,@Month,@EmployeeID,@Employee_Name,@Employee_Mail,@TLName,@TLMail,@Reporting_Manager,@Reporting_Manager_Mail,@TeamName,@CCMail,@CallDate,@EvaluationDate,@CaseID,@CallID_SR_ID,@CallDuration,@SupportMedium,@ProblemDescription,@NonCompliance,@NonComplianceDetail,@NonComplianceScore,@AuditScore,@CustCritical,@BusCritical,@TimelyAction,@TimelyAction_Cmnts,@RightProcess,@RightProcess_Cmnts,@ToolUsage,@ToolUsage_Cmnts,@RightParticulars,@RightParticulars_Cmnts,@Behavioural,@Behavioural1,@Behavioural2,@Behavioural3,@Behavioural4,@Behavioural_Cmnts,@EmailComm,@EmailComm1,@EmailComm2,@EmailComm3,@EmailComm_Cmnts,@Callback,@Callback_Cmnts,@SetRightExpectations,@SetRightExpectations_Cmnts,@Ownership,@Ownership1,@Ownership2,@Ownership3,@Ownership_Cmnts,@Documentation,@Documentation_Cmnts,@AuditResult)";
            ...
            Con.Close();
            maildetails();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Audit Saved and Mail sent Successfully');window.location ='22_Swivel_DaasLegend.aspx';", true);
        }
        ...
        private bool SendEmail(string to, string from, string password, string subject, string body, string cc, string tl)
        {
            ...
            try
            {
                ...
                mail.Subject = "Swivel Daas Audit | " + ddMonth.SelectedItem.Text + " | " + tbId3.Text;
                mail.Body = body;

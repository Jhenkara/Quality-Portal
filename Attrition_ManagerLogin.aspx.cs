...
{
    public partial class Attrition_ManagerLogin : System.Web.UI.Page
    {
        ...
        protected void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            string query = "SELECT COUNT(1) FROM UserCredentials where Username=@Username and Password=@Password and Roles in ('MGR')";
            ...
            {
                Session["Username"] = tbUsername.Text.Trim();
                Response.Redirect("Attrition_Mgr_SelectOptions.aspx");
            }
            else
            {

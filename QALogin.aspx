<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QALogin.aspx.cs" Inherits="Audit_Legends.QALogin" %>
...
<body>
    ...
    <div class="panel-body" id="LoginDiv">
        <div class="row-center" >
            ...
            <h1 class="navbar-brand pull-right" style="color:white;font-weight:bold;font-size:22px;"> Auditor Login </h1>
            <br /><br />
        </div>
        <form runat="server" >

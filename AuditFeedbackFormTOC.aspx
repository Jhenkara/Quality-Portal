<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditFeedbackFormTOC.aspx.cs" Inherits="Audit_Legends.AuditFeedbackFormTOC" %>
...
<head>
    ...
    <title>TOC / DVT Audit Feedback Form</title>
...
<body>
    ...
    <div class="auto-style1" style="color:aliceblue;background-color:black;text-align:left;line-height:100px;width:100%">
        ...
        <h1><img src="Images/HP logoblu.png" style="width:98px;overflow:auto;float:initial;"/> TOC / DVT Audit Feedback Form </h1>
    </div>
    ...
    <div style="text-align:right;height:80px;">
        ...
        <div>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="CaseID" TextMode="MultiLine" AutoPostBack="true" placeholder="* Enter a valid Case ID here" OnTextChanged="btnFeedBk_Click" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server" Height="50px" Width="300px"></asp:TextBox>
                    <%--<br />

...
{
    public partial class MgrDashboardDOA : System.Web.UI.Page
    {
        ...
        public void bind_data()
        {
            ...
            else
            {
                ...
                SqlCommand query1 = new SqlCommand("SELECT count(AuditResult) from [dbo].[FY21DOALegend] where Reporting_Manager='" + emp_name + "'", Con);
                ...
                SqlCommand query2 = new SqlCommand("SELECT count(AuditResult) from [dbo].[FY21DOALegend] where Reporting_Manager='" + emp_name + "' and AuditResult = 'Pass'", Con);
                ...
                SqlCommand query3 = new SqlCommand("SELECT count(AuditResult) from [dbo].[FY21DOALegend] where Reporting_Manager='" + emp_name + "' and AuditResult = 'Fail'", Con);
                ...
                SqlCommand query4 = new SqlCommand("SELECT ISNULL(AVG([AuditScore]),0) from [dbo].[FY21DOALegend] where Reporting_Manager='" + emp_name + "'", Con);
                ...
                "select Reporting_Manager, " +
                 ...
                 "from FY21DOALegend where AuditCount > 0 group by Reporting_Manager) as Table1 where Reporting_Manager = '" + emp_name + "' group by Reporting_Manager", Con);
                ...
                SqlDataSource1.SelectCommand = "select EmployeeID,Employee_Name,CallID_SR_ID,CallDate,EvaluationDate,QAName,AuditStatus,AuditScore FROM [dbo].[FY21DOALegend] where Reporting_Manager_Mail='" + emp_mail + "' or TLMail='" + emp_mail + "' order by AuditCount desc";
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("AuditSheetMgrFY21DOA.aspx?case=" + cass);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.Page.Controls.Add(SqlDataSource1);
                SqlDataSource1.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["CString"].ConnectionString;
                SqlDataSource1.SelectCommand = "select EmployeeID,Employee_Name,CallID_SR_ID,CallDate,EvaluationDate,QAName,AuditStatus,AuditScore FROM [dbo].[FY21DOALegend] where CallID_SR_ID='" + searchbar.Text + "' AND Reporting_Manager_Mail='" + emp_mail + "' or TLMail='" + emp_mail + "' order by AuditCount desc";
                UserGrid.DataBind();
            }
            catch (Exception ex)
            {

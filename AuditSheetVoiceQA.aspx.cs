...
{
    public partial class AuditSheetVoiceQA : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("Select * from [dbo].[FY21VoiceLegend] where CallID_SR_ID=@CallID_SR_ID and QAMail=@Username", Con);
            ...
            Q02i.SelectedItem.Text = dtt.Rows[0]["ToolUsage9"].ToString();

            Q02j.SelectedItem.Text = dtt.Rows[0]["ToolUsage10"].ToString();
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            Con.Close();
            maildetails();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Audit Updated Successfully');window.location ='QADashboardFY21VoiceLegend.aspx';", true);
        }
        ...
        private bool SendEmail(string to, string from, string password, string subject, string body, string cc, string tl)
        {
            ...
            try
            {
                ...
                mail.Subject = "Resolved Voice Audit | " + ddMonth.SelectedItem.Text + " | " + tbId3.Text;
                mail.Body = body;
                mail.IsBodyHtml = true;
                SmtpServer.Port = Convert.ToInt32(ConfigurationManager.AppSettings["smtpPort"]);
                SmtpServer.UseDefaultCredentials = false;
        ...
        {
            resend_maildetails();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Mail Resent Successfully');window.location ='QADashboardFY21VoiceLegend.aspx';", true);
        }
    }
}
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QADashboardFY21ChatLegend.aspx.cs" Inherits="Audit_Legends.QADashboardFY21ChatLegend" %>
...
<body>
    ...
    <div class="col-sm-6" style="margin-left:30px;">
        <br />
        <asp:TextBox ID="searchbar" CssClass="form-check-inline" AutoCompleteType="Disabled" placeholder="Enter the Employee ID or the Chat ID here" BorderStyle="Inset" runat="server" Height="25px" Width="400px"></asp:TextBox>
                ...
                <asp:GridView ID="UserGrid" runat="server" AutoGenerateEditButton="false" CellSpacing="2" CssClass=" table table-bordered table-responsive rounded_corners" AutoGenerateColumns="false" Width="100%" HeaderStyle-BackColor="#3AC0F2"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Employee_Name" HeaderText="Employee Name" />
                          <asp:TemplateField HeaderText="Chat ID">
                            <ItemTemplate>
                                <asp:Label ID="lblcase" runat="server" Text='<%# Eval("ChatID_SR_ID")%>' ></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                       
                        <asp:BoundField DataField="ChatDate" HeaderText="Chat Date" />
            ...
            <div class="col-sm-12">
                <asp:GridView ID="TrendGrid" runat="server" AutoGenerateEditButton="false" CellSpacing="2" CssClass=" table table-bordered table-responsive rounded_corners" AutoGenerateColumns="false" Width="100%" HeaderStyle-BackColor="#3AC0F2"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ToolUsage" HeaderText="Tool Usage" />
                        ...
                        <asp:BoundField DataField="CustObsdBehav" HeaderText="Customer Obsessed Behaviour" HeaderStyle-Width="80px" />
                        <asp:BoundField DataField="Time_Manage" HeaderText="TimeManagement" HeaderStyle-Width="80px" />
                        <asp:BoundField DataField="Callback" HeaderText="Callback" />
                        <asp:BoundField DataField="CaseOwnership" HeaderText="Case Ownership" />
                        <asp:BoundField DataField="Case_Call_Logging" HeaderText="Case/Call Logging" HeaderStyle-Width="80px" />

...
{
    public partial class AuditSheetQACO : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("Select * from [dbo].[CoreOpsLegend] where CaseID=@CaseID and QAMail=@Username", Con);
            ...
            C18.SelectedItem.Text = dtt.Rows[0]["TraQue8"].ToString();
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            Con.Close();
            //maildetails();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Audit Updated Successfully');window.location ='QADashboardCO.aspx';", true);
        }
    }
}
...
{
    public partial class AuditSheetUserFY21ADX : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                SqlCommand cmd1 = new SqlCommand("Update [dbo].[FY21ADXLegend] SET [AuditStatus]='Viewed' where CaseID=@CaseID and AuditStatus='Not Viewed'", Con);
        ...
        {
            SqlCommand cmd = new SqlCommand("Select * from [dbo].[FY21ADXLegend] where CaseID=@CaseID and Employee_Mail=@Username", Con);
            ...
            Q12a.Text = dtt.Rows[0]["ToolUsage1"].ToString();
            Q12a.ReadOnly = true;

            Q12b.Text = dtt.Rows[0]["ToolUsage2"].ToString();
            Q12b.ReadOnly = true;

            Q12c.Text = dtt.Rows[0]["ToolUsage3"].ToString();
            Q12c.ReadOnly = true;

            Q12d.Text = dtt.Rows[0]["ToolUsage4"].ToString();
            Q12d.ReadOnly = true;

            Q12e.Text = dtt.Rows[0]["ToolUsage5"].ToString();
            Q12e.ReadOnly = true;

            C12.Text = dtt.Rows[0]["ToolUsage_Cmnts"].ToString();
            C12.ReadOnly = true;

            Q02.Text = dtt.Rows[0]["Probing"].ToString();
            Q02.ReadOnly = true;

            C02.Text = dtt.Rows[0]["Probing_Cmnts"].ToString();
            C02.ReadOnly = true;

            Q03.Text = dtt.Rows[0]["Troubleshooting"].ToString();
            Q03.ReadOnly = true;
            ...
            Q05.Text = dtt.Rows[0]["Setting_Expectation"].ToString();
            Q05.ReadOnly = true;

            C05.Text = dtt.Rows[0]["Setting_Expectation_Cmnts"].ToString();
            C05.ReadOnly = true;

            Q06a.Text = dtt.Rows[0]["CaseOwnership1"].ToString();
            Q06a.ReadOnly = true;

            Q06b.Text = dtt.Rows[0]["CaseOwnership2"].ToString();
            Q06b.ReadOnly = true;

            Q06c.Text = dtt.Rows[0]["CaseOwnership3"].ToString();
            Q06c.ReadOnly = true;

            C06.Text = dtt.Rows[0]["CaseOwnership_Cmnts"].ToString();
            C06.ReadOnly = true;

            Q07a.Text = dtt.Rows[0]["Behavioural1"].ToString();
            Q07a.ReadOnly = true;

            Q07b.Text = dtt.Rows[0]["Behavioural2"].ToString();
            Q07b.ReadOnly = true;

            Q07c.Text = dtt.Rows[0]["Behavioural3"].ToString();
            Q07c.ReadOnly = true;

            Q07d.Text = dtt.Rows[0]["Behavioural4"].ToString();
            Q07d.ReadOnly = true;

            Q07e.Text = dtt.Rows[0]["Behavioural5"].ToString();
            Q07e.ReadOnly = true;

            Q07f.Text = dtt.Rows[0]["Behavioural6"].ToString();
            Q07f.ReadOnly = true;

            C07.Text = dtt.Rows[0]["Behavioural_Cmnts"].ToString();
            C07.ReadOnly = true;

            Q08a.Text = dtt.Rows[0]["Communication1"].ToString();
            Q08a.ReadOnly = true;

            Q08b.Text = dtt.Rows[0]["Communication2"].ToString();
            Q08b.ReadOnly = true;

            Q08c.Text = dtt.Rows[0]["Communication3"].ToString();
            Q08c.ReadOnly = true;

            C08.Text = dtt.Rows[0]["Communication_Cmnts"].ToString();
            C08.ReadOnly = true;

            Q09a.Text = dtt.Rows[0]["CallEtiquettes1"].ToString();
            Q09a.ReadOnly = true;

            Q09b.Text = dtt.Rows[0]["CallEtiquettes2"].ToString();
            Q09b.ReadOnly = true;

            Q09c.Text = dtt.Rows[0]["CallEtiquettes3"].ToString();
            Q09c.ReadOnly = true;

            Q09d.Text = dtt.Rows[0]["CallEtiquettes4"].ToString();
            Q09d.ReadOnly = true;

            Q09e.Text = dtt.Rows[0]["CallEtiquettes5"].ToString();
            Q09e.ReadOnly = true;

            Q09f.Text = dtt.Rows[0]["CallEtiquettes6"].ToString();
            Q09f.ReadOnly = true;

            Q09g.Text = dtt.Rows[0]["CallEtiquettes7"].ToString();
            Q09g.ReadOnly = true;

            C09.Text = dtt.Rows[0]["CallEtiquettes_Cmnts"].ToString();
            C09.ReadOnly = true;

            Q10.Text = dtt.Rows[0]["CaseHandling"].ToString();
            Q10.ReadOnly = true;

            C10.Text = dtt.Rows[0]["CaseHandling_Cmnts"].ToString();
            C10.ReadOnly = true;

            Q11.Text = dtt.Rows[0]["WOW_DAB"].ToString();
            Q11.ReadOnly = true;
        ...
        {
            Con.Open();
            SqlCommand cmd = new SqlCommand("Update [dbo].[FY21ADXLegend] SET [AuditStatus]='Accepted by Agent' where CaseID=@CaseID", Con);
            cmd.Parameters.AddWithValue("@CaseID", Request.QueryString["case"].ToString());
            cmd.ExecuteNonQuery();
            Con.Close();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Your Response has been Received successfully');window.location ='UserDashboardFY21ADX.aspx';", true);
        }
        ...
        private bool SendEmail(string to, string from, string password, string subject, string body, string cc)
        {
            ...
            try
            {
                ...
                mail.Subject = "ADX Audit | " + tbId3.Text + " | Dispute";
                mail.Body = body;
        ...
        public bool maildetails()
        {
            ...
            string body = "http://15.42.19.247:120/AuditSheetADXQA.aspx?case=" + tbId6.Text;
        ...
        protected void DisputeOptions(object sender, EventArgs e)
        {
            ...
            {
                Con.Open();
                SqlCommand cmd = new SqlCommand("Update [dbo].[FY21ADXLegend] SET [AuditStatus]='Disputed by Agent' where CaseID=@CaseID", Con);
                cmd.Parameters.AddWithValue("@CaseID", Request.QueryString["case"].ToString());
                cmd.Connection = Con;
                cmd.ExecuteNonQuery();
                Con.Close();

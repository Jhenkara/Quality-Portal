...
{
    public partial class OL_View : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("OL_Login.aspx");
            }
            else
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    string SelectMgr = "SELECT B.ReportingManager AS OM from [dbo].[FY21VoiceLegend] LEFT JOIN tblHeadCount B on Reporting_Manager=B.EmployeeFullName where B.Level2ManagerName='" + emp_name + "' " +
                    "UNION " +
                        "SELECT B.ReportingManager AS OM from[dbo].[FY21SoMeLegend] LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.Level2ManagerName='" + emp_name + "' " +
                    "UNION " +
                        "SELECT B.ReportingManager AS OM from[dbo].[FY21ChatLegend] LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.Level2ManagerName= '" + emp_name + "' " +
                    "UNION " +
                        "SELECT B.ReportingManager AS OM from[dbo].[FY21ADXLegend] LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.Level2ManagerName= '" + emp_name + "' ";
                    ...
                    ddManagerSelect.DataTextField = "OM";
                    ddManagerSelect.DataBind();
        ...
        public void bind_data()
        {
            ...
            else
            {
                ...
                SqlCommand query1 = new SqlCommand("select SUM(Count) as Count from(SELECT AuditResult,count(AuditScore) as Count from[dbo].[FY21VoiceLegend] LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.Level2ManagerName = '" + emp_name + "' GROUP BY AuditResult " +
                    "UNION" +
                    " SELECT AuditResult, count(AuditScore) as Count from[dbo].[FY21SoMeLegend] LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.Level2ManagerName = '" + emp_name + "' GROUP BY AuditResult " +
                    "UNION" +
                    " SELECT AuditResult, count(AuditScore) as Count from[dbo].[FY21ChatLegend] LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.Level2ManagerName = '" + emp_name + "' GROUP BY AuditResult " +
                    "UNION" +
                    " SELECT AuditResult, count(AuditScore) as Count from[dbo].[FY21ADXLegend] LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.Level2ManagerName = '" + emp_name + "' GROUP BY AuditResult) as JointTable", Con);
                ...
                SqlCommand query2 = new SqlCommand("select SUM(Count) as Count from (SELECT AuditResult,count(AuditScore) as Count from [dbo].[FY21VoiceLegend] LEFT JOIN tblHeadCount B on Reporting_Manager=B.EmployeeFullName where B.Level2ManagerName='" + emp_name + "' GROUP BY AuditResult " +
                    "UNION" +
                    " SELECT AuditResult, count(AuditScore) as Count from[dbo].[FY21SoMeLegend] LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.Level2ManagerName = '" + emp_name + "' GROUP BY AuditResult " +
                    "UNION" +
                    " SELECT AuditResult, count(AuditScore) as Count from[dbo].[FY21ChatLegend] LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.Level2ManagerName = '" + emp_name + "' GROUP BY AuditResult " +
                    "UNION" +
                    " SELECT AuditResult, count(AuditScore) as Count from[dbo].[FY21ADXLegend] LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.Level2ManagerName = '" + emp_name + "' GROUP BY AuditResult) as JointTable where AuditResult = 'Pass'", Con);
                ...
                SqlCommand query3 = new SqlCommand("select SUM(Count) as Count from (SELECT AuditResult,count(AuditScore) as Count from [dbo].[FY21VoiceLegend] LEFT JOIN tblHeadCount B on Reporting_Manager=B.EmployeeFullName where B.Level2ManagerName='" + emp_name + "' GROUP BY AuditResult " +
                    "UNION" +
                    " SELECT AuditResult, count(AuditScore) as Count from[dbo].[FY21SoMeLegend] LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.Level2ManagerName = '" + emp_name + "' GROUP BY AuditResult " +
                    "UNION" +
                    " SELECT AuditResult, count(AuditScore) as Count from[dbo].[FY21ChatLegend] LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.Level2ManagerName = '" + emp_name + "' GROUP BY AuditResult " +
                    "UNION" +
                    " SELECT AuditResult, count(AuditScore) as Count from[dbo].[FY21ADXLegend] LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.Level2ManagerName = '" + emp_name + "' GROUP BY AuditResult) as JointTable where AuditResult = 'Fail'", Con);
                ...
                SqlCommand query4 = new SqlCommand("select isnull(CAST(AVG(AverageAuditScore) AS DECIMAL(10,2)),0) AS AuditScore from (SELECT AVG(AuditScore) as AverageAuditScore from [dbo].[FY21VoiceLegend] LEFT JOIN tblHeadCount B on Reporting_Manager=B.EmployeeFullName where B.Level2ManagerName='" + emp_name + "' GROUP BY Reporting_Manager " +
                    "UNION" +
                " SELECT AVG(AuditScore) as AverageAuditScore from[dbo].[FY21SoMeLegend] LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.Level2ManagerName = '" + emp_name + "' GROUP BY Reporting_Manager " +
                    "UNION" +
                " SELECT AVG(AuditScore) as AverageAuditScore from[dbo].[FY21ChatLegend] LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.Level2ManagerName = '" + emp_name + "' GROUP BY Reporting_Manager " +
                    "UNION" +
                " SELECT AVG(AuditScore) as AverageAuditScore from[dbo].[FY21ADXLegend] LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.Level2ManagerName = '" + emp_name + "' GROUP BY Reporting_Manager) as JointTable", Con);
                ...
                "select Reporting_Manager, " +
                 ...
                 "from FY21VoiceLegend where AuditCount > 0 group by Reporting_Manager) as Table1 LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.Level2ManagerName = '" + emp_name + "' GROUP BY Reporting_Manager " +
                ...
                "select Reporting_Manager, " +
                  ...
                  "sum(case when Case_Call_Logging = 'Met' then 0 else 1 end) as Case_Call_Logging, " +
                  "sum(case when Closing = 'Met' or Closing = 'NA' then 0 else 1 end) as Closing " +
                 "from FY21ChatLegend where AuditCount > 0 group by Reporting_Manager) as Table1 LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.Level2ManagerName = '" + emp_name + "' GROUP BY Reporting_Manager " +
                ...
                "select Reporting_Manager, " +
                  ...
                  "sum(case when Case_Call_Logging = 'Met' then 0 else 1 end) as Case_Call_Logging, " +
                  "sum(case when Closing = 'Met' or Closing = 'NA' then 0 else 1 end) as Closing " +
                 "from FY21SoMeLegend where AuditCount > 0 group by Reporting_Manager) as Table1 LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.Level2ManagerName = '" + emp_name + "' GROUP BY Reporting_Manager " +
                ...
                "select Reporting_Manager, " +
                 ...
                 "from FY21ADXLegend where AuditCount > 0 group by Reporting_Manager) as Table1 LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.Level2ManagerName = '" + emp_name + "' GROUP BY Reporting_Manager) AS DefectTotal", Con);
                ...
                SqlDataSource1.SelectCommand = "select OM,SUM(Count) as TotalAudits,CAST(AVG(AverageAuditScore) AS DECIMAL(10,2)) AS AuditScore from (SELECT AVG(AuditScore) as AverageAuditScore,B.ReportingManager AS OM,count(AuditScore) as Count from [dbo].[FY21VoiceLegend] LEFT JOIN tblHeadCount B on Reporting_Manager=B.EmployeeFullName where B.Level2ManagerName='" + emp_name + "' GROUP BY B.ReportingManager " +
                    "UNION" +
                " SELECT AVG(AuditScore) as AverageAuditScore,B.ReportingManager AS OM,count(AuditScore) as Count from[dbo].[FY21SoMeLegend] LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.Level2ManagerName = '" + emp_name + "' GROUP BY B.ReportingManager " +
                    "UNION" +
                " SELECT AVG(AuditScore) as AverageAuditScore,B.ReportingManager AS OM, count(AuditScore) as Count from[dbo].[FY21ChatLegend] LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.Level2ManagerName = '" + emp_name + "' GROUP BY B.ReportingManager " +
                    "UNION" +
                " SELECT AVG(AuditScore) as AverageAuditScore,B.ReportingManager AS OM, count(AuditScore) as Count from[dbo].[FY21ADXLegend] LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.Level2ManagerName = '" + emp_name + "' GROUP BY B.ReportingManager) as JointTable GROUP BY OM";
        ...
        protected void ddManagerSelect_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.Page.Controls.Add(SqlDataSource1);
                SqlDataSource1.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["CString"].ConnectionString;
                SqlDataSource1.SelectCommand = "select OM,SUM(Count) as TotalAudits,CAST(AVG(AverageAuditScore) AS DECIMAL(10,2)) AS AuditScore from (SELECT AVG(AuditScore) as AverageAuditScore,B.ReportingManager AS OM,count(AuditScore) as Count from [dbo].[FY21VoiceLegend] LEFT JOIN tblHeadCount B on Reporting_Manager=B.EmployeeFullName where B.ReportingManager='" + emp_name + "' GROUP BY B.ReportingManager " +
                    "UNION" +
                " SELECT AVG(AuditScore) as AverageAuditScore,B.ReportingManager AS OM,count(AuditScore) as Count from[dbo].[FY21SoMeLegend] LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.ReportingManager = '" + emp_name + "' GROUP BY B.ReportingManager " +
                    "UNION" +
                " SELECT AVG(AuditScore) as AverageAuditScore,B.ReportingManager AS OM, count(AuditScore) as Count from[dbo].[FY21ChatLegend] LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.ReportingManager = '" + emp_name + "' GROUP BY B.ReportingManager " +
                    "UNION" +
                " SELECT AVG(AuditScore) as AverageAuditScore,B.ReportingManager AS OM, count(AuditScore) as Count from[dbo].[FY21ADXLegend] LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.ReportingManager = '" + emp_name + "' GROUP BY B.ReportingManager) as JointTable where OM ='" + ddManagerSelect.SelectedItem.Text + "' GROUP BY OM";
                UserGrid.DataSource = SqlDataSource1;
                UserGrid.DataBind();
            }
        }
        ...
        protected void ddFormSelect_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.Page.Controls.Add(SqlDataSource1);
                SqlDataSource1.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["CString"].ConnectionString;
                SqlDataSource1.SelectCommand = "select OM,SUM(Count) as TotalAudits,CAST(AVG(AverageAuditScore) AS DECIMAL(10,2)) AS AuditScore, AuditFormType from (SELECT AVG(AuditScore) as AverageAuditScore,B.ReportingManager AS OM, count(AuditScore) as Count, AuditFormType from [dbo].[FY21VoiceLegend] LEFT JOIN tblHeadCount B on Reporting_Manager=B.EmployeeFullName where B.Level2ManagerName='" + emp_name + "' GROUP BY B.ReportingManager, AuditFormType " +
                    "UNION" +
                " SELECT AVG(AuditScore) as AverageAuditScore,B.ReportingManager AS OM, count(AuditScore) as Count, AuditFormType from[dbo].[FY21SoMeLegend] LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.Level2ManagerName = '" + emp_name + "' GROUP BY B.ReportingManager, AuditFormType " +
                    "UNION" +
                " SELECT AVG(AuditScore) as AverageAuditScore,B.ReportingManager AS OM, count(AuditScore) as Count, AuditFormType from[dbo].[FY21ChatLegend] LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.Level2ManagerName = '" + emp_name + "' GROUP BY B.ReportingManager, AuditFormType " +
                    "UNION" +
                " SELECT AVG(AuditScore) as AverageAuditScore,B.ReportingManager AS OM, count(AuditScore) as Count, AuditFormType from[dbo].[FY21ADXLegend] LEFT JOIN tblHeadCount B on Reporting_Manager = B.EmployeeFullName where B.Level2ManagerName = '" + emp_name + "' GROUP BY B.ReportingManager, AuditFormType) as JointTable where AuditFormType='" + ddFormSelect.SelectedItem.Text + "' GROUP BY OM, AuditFormType";
                UserGrid.DataSource = SqlDataSource1;
                UserGrid.DataBind();
            }
        }

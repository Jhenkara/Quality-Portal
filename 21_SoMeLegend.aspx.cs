...
{
    public partial class _21_SoMeLegend : System.Web.UI.Page
    {
        ...
        protected void Submit_Button(object sender, EventArgs args)
        {
            ...
            string CommandText = "INSERT INTO [dbo].[FY21SoMeLegend](QAName,QAMail,BusinessUnit,BusinessSegment,SupportType,Month,EmployeeID,Employee_Name,Employee_Mail,TLName,TLMail,Reporting_Manager,Reporting_Manager_Mail,TeamName,CCMail,CallDate,EvaluationDate,CaseID,CallID_SR_ID,CallDuration,AuditType,CaseType,ProblemDescription,Language,NonCompliance,NonComplianceDetail,NonComplianceScore,AuditScore,CustCritical,BusCritical,Opening,Opening1,Opening2,Opening3,Opening4,Opening5,Opening_Cmnts,ToolUsage,ToolUsage1,ToolUsage2,ToolUsage3,ToolUsage4,ToolUsage5,ToolUsage6,ToolUsage_Cmnts,Probing,Probing_Cmnts,Troubleshooting,Troubleshooting_Cmnts,Sol_Res,Sol_Res_Cmnts,Behavioural,Behavioural1,Behavioural2,Behavioural3,Behavioural4,Behavioural5,Behavioural_Cmnts,Communication,Communication1,Communication2,Communication3,Communication4,Communication_Cmnts,CustObsdBehav,CustObsdBehav1,CustObsdBehav2,CustObsdBehav3,CustObsdBehav4,CustObsdBehav5,CustObsdBehav6,CustObsdBehav_Cmnts,TimeManagement,TimeManagement_Cmnts,CaseFollowUp,CaseFollowUp_Cmnts,CaseOwnership,CaseOwnership1,CaseOwnership2,CaseOwnership3,CaseOwnership4,CaseOwnership_Cmnts,Case_Call_Logging,Case_Call_Logging_Cmnts,Closing,Closing_Cmnts,WOW_DAB,WOW_DAB_Cmnts,SAPOS,SAPOS1a,SAPOS1b,SAPOS1_Cmnts,SAPOS2,SAPOS2_Cmnts,SAPOS3,SAPOS3_Cmnts,FCR,FCR_Cmnts,AuditResult) values " +
                "(@QAName,@QAMail,@BusinessUnit,@BusinessSegment,@SupportType,@Month,@EmployeeID,@Employee_Name,@Employee_Mail,@TLName,@TLMail,@Reporting_Manager,@Reporting_Manager_Mail,@TeamName,@CCMail,@CallDate,@EvaluationDate,@CaseID,@CallID_SR_ID,@CallDuration,@AuditType,@CaseType,@ProblemDescription,@Language,@NonCompliance,@NonComplianceDetail,@NonComplianceScore,@AuditScore,@CustCritical,@BusCritical,@Opening,@Opening1,@Opening2,@Opening3,@Opening4,@Opening5,@Opening_Cmnts,@ToolUsage,@ToolUsage1,@ToolUsage2,@ToolUsage3,@ToolUsage4,@ToolUsage5,@ToolUsage6,@ToolUsage_Cmnts,@Probing,@Probing_Cmnts,@Troubleshooting,@Troubleshooting_Cmnts,@Sol_Res,@Sol_Res_Cmnts,@Behavioural,@Behavioural1,@Behavioural2,@Behavioural3,@Behavioural4,@Behavioural5,@Behavioural_Cmnts,@Communication,@Communication1,@Communication2,@Communication3,@Communication4,@Communication_Cmnts,@CustObsdBehav,@CustObsdBehav1,@CustObsdBehav2,@CustObsdBehav3,@CustObsdBehav4,@CustObsdBehav5,@CustObsdBehav6,@CustObsdBehav_Cmnts,@TimeManagement,@TimeManagement_Cmnts,@CaseFollowUp,@CaseFollowUp_Cmnts,@CaseOwnership,@CaseOwnership1,@CaseOwnership2,@CaseOwnership3,@CaseOwnership4,@CaseOwnership_Cmnts,@Case_Call_Logging,@Case_Call_Logging_Cmnts,@Closing,@Closing_Cmnts,@WOW_DAB,@WOW_DAB_Cmnts,@SAPOS,@SAPOS1a,@SAPOS1b,@SAPOS1_Cmnts,@SAPOS2,@SAPOS2_Cmnts,@SAPOS3,@SAPOS3_Cmnts,@FCR,@FCR_Cmnts,@AuditResult)";
            ...
            cmd.Parameters.AddWithValue("@SupportType", ddST.SelectedItem.Text);
            ...
            cmd.Parameters.AddWithValue("@Language", tbLang.Text);
            ...
            Con.Close();
            maildetails();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Audit Saved and Mail sent Successfully');window.location ='21_SoMeLegend.aspx';", true);
        }
        ...
        protected void tbId2_TextChanged(object sender, EventArgs e)
        {
            ...
            //SqlCommand cmd2 = new SqlCommand("SELECT TOP 6 AuditScore,Month FROM [dbo].[FY21SoMeLegend] where EmployeeID=@EmployeeID ORDER BY EvaluationDate DESC", Con);

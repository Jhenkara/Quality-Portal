...
{
    public partial class AuditSheetTL : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("Select * from AuditLegend where CaseID=@CaseID and Reporting_Manager=@Mgr_Name or Employee_Mail=@Username", Con);

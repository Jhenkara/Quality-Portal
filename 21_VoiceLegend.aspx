<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="21_VoiceLegend.aspx.cs" Inherits="Audit_Legends._21_VoiceLegend" %>
...
<body>
    ...
    <div class="auto-style1" style="color:aliceblue;background-color:#4d4e4f;text-align:left;line-height:100px;width:100%">
        ...
        <h1><img src="Images/hp_logo_white.png" style="width:98px;overflow:auto;float:initial;"/> Voice Audit Form </h1>
    </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:DropDownList ID="Q08a" runat="server" Height="20px" Width="150px" Font-Size="X-Small" onchange="DropDownFilter(this);">
                                            <asp:ListItem Selected="true" text="Met" Value="0" ></asp:ListItem>
                                            <asp:ListItem Text="Met" Value="1"></asp:ListItem>
                                            <asp:ListItem Text="Not Met" Value="2"></asp:ListItem>
                                            <asp:ListItem Text="NA" Value="3"></asp:ListItem>
                                            </asp:DropDownList>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="-1" ID="RequiredFieldValidator58" ControlToValidate="Q15a" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </td>

...
{
    public partial class _22_OnsiteAndPURRLegend : System.Web.UI.Page
    {
        ...
        protected void Submit_Button(object sender, EventArgs args)
        {
            ...
            string CommandText = "INSERT INTO [dbo].[FY22OnsitePURRLegend](QAName,QAMail,BusinessUnit,BusinessSegment,Month,EmployeeID,Employee_Name,Employee_Mail,TLName,TLMail,Reporting_Manager,Reporting_Manager_Mail,TeamName,CCMail,CallDate,EvaluationDate,CaseID,CallID_SR_ID,CallDuration,CallType,ProblemDescription,NonCompliance,NonComplianceDetail,NonComplianceScore,AuditScore,CustCritical,BusCritical,TAT,TAT_Cmnts,WorkOrder_PURR,WorkOrder_PURR_Cmnts,DeliveryInstructions,DeliveryInstructions_Cmnts,RDT_Documentation,RDT_Documentation_Cmnts,KCI_SettingExpectation,KCI_SettingExpectation_Cmnts,ConsignmentDetails,ConsignmentDetails_Cmnts,CorrectDispatch,CorrectDispatch_Cmnts,GoogleSheets_Sharepoint,GoogleSheets_Sharepoint_Cmnts,ConfirmAddress,ConfirmAddress_Cmnts,AuditResult) values " +
                "(@QAName,@QAMail,@BusinessUnit,@BusinessSegment,@Month,@EmployeeID,@Employee_Name,@Employee_Mail,@TLName,@TLMail,@Reporting_Manager,@Reporting_Manager_Mail,@TeamName,@CCMail,@CallDate,@EvaluationDate,@CaseID,@CallID_SR_ID,@CallDuration,@CallType,@ProblemDescription,@NonCompliance,@NonComplianceDetail,@NonComplianceScore,@AuditScore,@CustCritical,@BusCritical,@TAT,@TAT_Cmnts,@WorkOrder_PURR,@WorkOrder_PURR_Cmnts,@DeliveryInstructions,@DeliveryInstructions_Cmnts,@RDT_Documentation,@RDT_Documentation_Cmnts,@KCI_SettingExpectation,@KCI_SettingExpectation_Cmnts,@ConsignmentDetails,@ConsignmentDetails_Cmnts,@CorrectDispatch,@CorrectDispatch_Cmnts,@GoogleSheets_Sharepoint,@GoogleSheets_Sharepoint_Cmnts,@ConfirmAddress,@ConfirmAddress_Cmnts,@AuditResult)";
            ...
            Con.Close();
            maildetails();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Audit Saved and Mail sent Successfully');window.location ='22_OnsiteAndPURRLegend.aspx';", true);
        }
        ...
        private bool SendEmail(string to, string from, string password, string subject, string body, string cc, string tl)
        {
            ...
            try
            {
                ...
                mail.Subject = "Onsite and PURR Audit | " + ddMonth.SelectedItem.Text + " | " + tbId3.Text;
                mail.Body = body;
        ...
        public bool maildetails()
        {
            ...
            string body4 = "http://15.42.19.247:120/AuditSheetMgrFY22OnsitePURR.aspx?case=" + tbId7.Text;

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditFeedbackFormDaaS.aspx.cs" Inherits="Audit_Legends.AuditFeedbackFormDaaS" %>
...
<head>
    ...
    <title>India and APJ DaaS Audit Feedback Form</title>
...
<body>
    ...
    <div class="auto-style1" style="color:aliceblue;background-color:black;text-align:left;line-height:100px;width:100%">
        ...
        <h1><img src="Images/HP logoblu.png" style="width:98px;overflow:auto;float:initial;"/> India and APJ DaaS Audit Feedback Form </h1>
    </div>
    ...
    <div style="text-align:right;height:80px;">
        ...
        <div>
            ...
            <tr>
                <th>
                    Enter a Call Id to send Feedback
                </th>

                <td>
                    <asp:TextBox ID="CallId" TextMode="MultiLine" AutoPostBack="true" placeholder="* Enter a valid Call ID here" OnTextChanged="btnFeedBk_Click" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server" Height="50px" Width="300px"></asp:TextBox>
                    <%--<br />
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="CaseID" CssClass="form-control" TextMode="MultiLine" AutoPostBack="true" OnTextChanged="btnFeedBk_Click" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server" Height="50px" Width="300px"></asp:TextBox>
                    <%--<br />
                    <asp:Button ID="btnFeedBk" Text="Search" runat="server" />--%>
                </td>
            </tr>

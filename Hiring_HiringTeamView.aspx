<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Hiring_HiringTeamView.aspx.cs" Inherits="Audit_Legends.Hiring_HiringTeamView" %>
...
<head>
    ...
    <title>Hiring Form | Hiring Team View</title>
...
<body>
    ...
    <script type="text/javascript">
        $(function () {
            $("#tbId9").datepicker(null);
            $("#tbId10").datepicker(null);
            $("#tbId11").datepicker(null);
        });
    </script>
    ...
    <div class="auto-style1" style="color:aliceblue;background-color:#4d4e4f;text-align:left;line-height:100px;width:100%">
        ...
        <h1><%--<img src="Images/hp_logo_white.png" style="width:98px;overflow:auto;float:initial;"/>--%> Hiring Form | Hiring Team View </h1>
    </div>
                    ...
                    <div class="row">
                        ...
                        <table id="table2">
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddVendor" CssClass="form-control input-xs" runat="server" BorderStyle="Inset" AutoPostBack="true">
                                        <asp:ListItem Enabled="true" text="--Choose--" Value="-1" ></asp:ListItem>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="tbId9" CssClass="form-control input-xs" placeholder="Choose / type in 'MM/DD/YYYY' Format" AutoPostBack="true" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="tbId10" CssClass="form-control input-xs" placeholder="Choose / type in 'MM/DD/YYYY' Format" AutoPostBack="true" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="tbId11" CssClass="form-control input-xs" placeholder="Choose / type in 'MM/DD/YYYY' Format" AutoPostBack="true" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="tbId12" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddStatus" CssClass="form-control input-xs" runat="server" AutoPostBack="true" BorderStyle="Inset">
                                        <asp:ListItem Enabled="true" text="--Choose--" Value="-1" ></asp:ListItem>
                        ...
                        <table id="table4">
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="tbId13" CssClass="form-control input-xs" placeholder="Choose / type in 'MM/DD/YYYY' Format" AutoPostBack="true" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server" Enabled="false"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="tbId14" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server" Enabled="false"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="tbId15" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server" Enabled="false"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="tbId16" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server" Enabled="false"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="tbId17" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server" Enabled="false"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="tbId18" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server" Enabled="false"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="tbId19" CssClass="form-control input-xs" placeholder="Choose / type in 'MM/DD/YYYY' Format" AutoPostBack="true" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server" Enabled="false"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="tbId20" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server" Enabled="false"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="tbId21" CssClass="form-control input-xs" placeholder="Choose / type in 'MM/DD/YYYY' Format" AutoPostBack="true" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server" Enabled="false"></asp:TextBox>

...
{
    public partial class OL_Login : System.Web.UI.Page
    {
        ...
        protected void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            string query = "SELECT COUNT(1) FROM UserCredentials where Username=@Username and Password=@Password and Roles='OL'";
            ...
            {
                Session["Username"] = tbUsername.Text.Trim();
                Response.Redirect("OL_View.aspx");
            }
            else
            {

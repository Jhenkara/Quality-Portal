...
{
    public partial class QADashboardFY21DOALegend : System.Web.UI.Page
    {
        ...
        public void bind_data()
        {
            ...
            else
            {
                ...
                SqlCommand query1 = new SqlCommand("SELECT count(AuditResult) from [dbo].[FY21DOALegend] where QAName='" + emp_name + "'", Con);
                ...
                SqlCommand query2 = new SqlCommand("SELECT count(AuditResult) from [dbo].[FY21DOALegend] where QAName='" + emp_name + "' and AuditResult = 'Pass'", Con);
                ...
                SqlCommand query3 = new SqlCommand("SELECT count(AuditResult) from [dbo].[FY21DOALegend] where QAName='" + emp_name + "' and AuditResult = 'Fail'", Con);
                ...
                SqlCommand query4 = new SqlCommand("SELECT ISNULL(AVG([AuditScore]),0) from [dbo].[FY21DOALegend] where QAName='" + emp_name + "'", Con);
                ...
                "select QAName, " +
                 ...
                 "from FY21DOALegend where AuditCount > 0 group by QAName) as Table1 where QAName = '" + emp_name + "' group by QAName", Con);
                ...
                SqlDataSource1.SelectCommand = "select EmployeeID,Employee_Name,CallID_SR_ID,CallDate,EvaluationDate,QAName,AuditStatus,AuditScore FROM [dbo].[FY21DOALegend] where QAName='" + emp_name + "' order by AuditCount desc";
        ...
        protected void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("AuditSheetDOAQA.aspx?case=" + cass);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.Page.Controls.Add(SqlDataSource1);
                SqlDataSource1.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["CString"].ConnectionString;
                SqlDataSource1.SelectCommand = "select EmployeeID,Employee_Name,CallID_SR_ID,CallDate,EvaluationDate,QAName,AuditStatus,AuditScore FROM [dbo].[FY21DOALegend] where CaseID='" + searchbar.Text + "' or EmployeeID='" + searchbar.Text + "' order by AuditCount desc";
                UserGrid.DataSource = SqlDataSource1;
                UserGrid.DataBind();
            }
            catch (Exception ex)

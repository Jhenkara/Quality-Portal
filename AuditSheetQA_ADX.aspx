<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditSheetQA_ADX.aspx.cs" Inherits="Audit_Legends.AuditSheetQA_ADX" %>
...
<head>
    ...
    <title>ADX Commercial Legend</title>
...
<body>
    ...
    <div class="auto-style1" style="color:aliceblue;background-color:black;text-align:left;line-height:100px;width:100%">
        ...
        <h1><img src="Images/HP logoblu.png" style="width:98px;overflow:auto;float:initial;"/> ADX Commercial Legend </h1>
    </div>
    ...
    <br />
        ...
        <tbody>
                <tr>
                    <th>Did the Engineer process/ action the case within the given time frame?
                    </th>
                ...
                <tr>
                    <td>Did the Engineer follow up on the case?</td>
                ...
                <tr>
                    <td>Did the Engineer capture the correct name, phone, address.. Etc.?
                    </td>
                ...
                <tr>
                    <td>Did the Engineer probe and perform Logical Troubleshooting steps based on the issue description ?</td>
                ...
                <tr>
                    <td>Did the Engineer provide right resolution/solution?</td>
                ...
                <tr>
                    <td>Did the Engineer set right expectations to the customer as per the situation?</td>
                ...
                <tr>
                    <td>Did the Engineer display good communication skills on email?</td>
                ...
                <tr>
                    <td>Did the Engineer adhere to the case logging process and documented details accurately? </td>
                    <td><asp:DropDownList ID="C08" runat="server" Height="25px" Width="150px" onchange="DropDownFilter(this);">
                        <asp:ListItem Enabled="true" text="--Choose--" Value="0" ></asp:ListItem>
                        <asp:ListItem Text="Yes" Value=""></asp:ListItem>
                        <asp:ListItem Text="Partial" Value="10"></asp:ListItem>

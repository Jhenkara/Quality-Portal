...
{
    public partial class OM_Login : System.Web.UI.Page
    {
        ...
        protected void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            string query = "SELECT COUNT(1) FROM UserCredentials where Username=@Username and Password=@Password and Roles in ('OL','OM')";
            ...
            {
                Session["Username"] = tbUsername.Text.Trim();
                Response.Redirect("OM_View.aspx");
            }
            else
            {

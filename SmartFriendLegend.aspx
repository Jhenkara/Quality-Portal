<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SmartFriendLegend.aspx.cs" Inherits="Audit_Legends.SmartFriendLegend" %>
...
<body>
    ...
    <div class="auto-style1" style="color:aliceblue;background-color:black;text-align:left;line-height:100px;width:100%">
        ...
        <h1><img src="Images/HP logoblu.png" style="width:98px;overflow:auto;float:initial;"/> Smart Friend Legend</h1>
    </div>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddTeamName" runat="server" Height="25px" Width="300px">
                        <asp:ListItem Enabled="true" text="--Choose--" Value="-1" ></asp:ListItem>
                        <asp:ListItem Text="Smart Friend" Value="0"></asp:ListItem>
                    </asp:DropDownList>
        ...
        <table id="table2" border="1">
            ...
            <tbody>
                <tr>
                    ...
                    <td>Gathered information effortlessly (Aggrement Number / Customer Details /unit info / Case History)<br />
                ...
                <tr>
                    ...
                    <td><asp:DropDownList ID="C05" runat="server" Height="25px" Width="150px" onchange="DropDownFilter(this);">
                        ...
                        <asp:ListItem Text="No" Value="15"></asp:ListItem></asp:DropDownList></td>
                    <td>

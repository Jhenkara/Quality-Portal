<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TLLogin.aspx.cs" Inherits="Audit_Legends.TLLogin" %>
...
<body>
    ...
    <div class="panel-body" id="LoginDiv">
        <div class="row-center" >
            ...
            <h1 class="navbar-brand pull-right" style="color:white;font-weight:bold;">  TL Login</h1>
            <br /><br />
        </div>
        <form runat="server" >

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditSheetQASoMe.aspx.cs" Inherits="Audit_Legends.AuditSheetQASoMe" %>
...
<body>
    ...
    <div class="auto-style1" style="color:aliceblue;background-color:black;text-align:left;line-height:100px;width:100%">
        ...
        <h1><img src="Images/HP logoblu.png" style="width:98px;overflow:auto;float:initial;"/> SoMe Facebook and Twitter Legend</h1>
    </div>
    ...
    <br />
        ...
        <table id="table2" border="1">
            ...
            <tbody>
                ...
                <tr>
                    <td>A1</td>
                    <th rowspan="4" scope="rowgroup">Engagement & Etiquette</th>
                    ...
                    <td><asp:DropDownList ID="A1" runat="server" Height="25px" Width="150px" onchange="DropDownFilter(this);">
                        ...
                        <asp:ListItem Text="No" Value="7.5"></asp:ListItem>
                        </asp:DropDownList></td>
                    <td>
                ...
                <tr>
                    <td>A4</td>
                    <td>The agent managed the direction of the interaction relative to the customer's inquiry and level of technical understanding & also Paraphrased the issue.</td>
                ...
                <tr>
                    <td>B1</td>
                    <th rowspan="3" scope="rowgroup">Investigation</th>
                ...
                <tr>
                    <td>B3</td>
                    <td>Did the Agent follow Structured Approach to assist the Customer and follow the case to ensure sNPS is achieved.</td>
                    <td><asp:DropDownList ID="B3" runat="server" Height="25px" Width="150px" onchange="DropDownFilter(this);">
                        <asp:ListItem Enabled="true" text="--Choose--" Value="0" ></asp:ListItem>
                        <asp:ListItem Text="Yes" Value=""></asp:ListItem>
                        <asp:ListItem Text="Partial" Value="5"></asp:ListItem>
                        <asp:ListItem Text="No" Value="10"></asp:ListItem>
                ...
                <tr>
                    <td>C1</td>
                    <th rowspan="4" scope="rowgroup">Tools & Resources</th>
                ...
                <tr>
                    ...
                    <td>The agent provided a succinct sequence of steps when troubleshooting.</td>
                ...
                <tr>
                    <td>D3</td>
                    <td>The agent did not use abbreviations of words(u, ur etc…).</td>
                ...
                <tr>
                    <td>E1</td>
                    <th rowspan="3" scope="rowgroup">Follow-up & Closure</th>
                ...
                <tr>
                    <td>E3</td>
                    <td>The agent used proper signature formatting.</td>

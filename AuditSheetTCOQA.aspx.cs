...
{
    public partial class AuditSheetTCOQA : System.Web.UI.Page
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("Select * from [dbo].[FY22TCOLegend] where CallID_SR_ID=@CallID_SR_ID and QAMail=@Username", Con);
            ...
            Q01.SelectedItem.Text = dtt.Rows[0]["HPBranding"].ToString();

            C01.Text = dtt.Rows[0]["HPBranding_Cmnts"].ToString();

            Q02.SelectedItem.Text = dtt.Rows[0]["Case_Study"].ToString();

            C02.Text = dtt.Rows[0]["Case_Study_Cmnts"].ToString();

            Q03.SelectedItem.Text = dtt.Rows[0]["Probing_Logical_Troubleshooting"].ToString();

            C03.Text = dtt.Rows[0]["Probing_Logical_Troubleshooting_Cmnts"].ToString();

            Q04.SelectedItem.Text = dtt.Rows[0]["Resolution_CaseStatus"].ToString();

            C04.Text = dtt.Rows[0]["Resolution_CaseStatus_Cmnts"].ToString();

            Q05.SelectedItem.Text = dtt.Rows[0]["Communication"].ToString();

            C05.Text = dtt.Rows[0]["Communication_Cmnts"].ToString();

            Q06.SelectedItem.Text = dtt.Rows[0]["Call_Logging_Documentation"].ToString();

            C06.Text = dtt.Rows[0]["Call_Logging_Documentation_Cmnts"].ToString();

            Q07.SelectedItem.Text = dtt.Rows[0]["Additional_Assistance"].ToString();

            C07.Text = dtt.Rows[0]["Additional_Assistance_Cmnts"].ToString();

            Q08.SelectedItem.Text = dtt.Rows[0]["Callback"].ToString();

            C08.Text = dtt.Rows[0]["Callback_Cmnts"].ToString();

            Q09.SelectedItem.Text = dtt.Rows[0]["Callback_ValueAdd"].ToString();

            C09.Text = dtt.Rows[0]["Callback_ValueAdd_Cmnts"].ToString();
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            string CommandText = "UPDATE [dbo].[FY22TCOLegend] SET Month=@Month,EmployeeID=@EmployeeID,Employee_Name=@Employee_Name,Employee_Mail=@Employee_Mail,TLName=@TLName,TLMail=@TLMail,Reporting_Manager=@Reporting_Manager,Reporting_Manager_Mail=@Reporting_Manager_Mail,TeamName=@TeamName,CCMail=@CCMail,CaseID=@CaseID,CallID_SR_ID=@CallID_SR_ID,NonCompliance=@NonCompliance,NonComplianceDetail=@NonComplianceDetail,NonComplianceScore=@NonComplianceScore,AuditScore=@AuditScore,CustCritical=@CustCritical,BusCritical=@BusCritical,HPBranding=@HPBranding,HPBranding_Cmnts=@HPBranding_Cmnts,Case_Study=@Case_Study,Case_Study_Cmnts=@Case_Study_Cmnts,Probing_Logical_Troubleshooting=@Probing_Logical_Troubleshooting,Probing_Logical_Troubleshooting_Cmnts=@Probing_Logical_Troubleshooting_Cmnts,Resolution_CaseStatus=@Resolution_CaseStatus,Resolution_CaseStatus_Cmnts=@Resolution_CaseStatus_Cmnts,Communication=@Communication,Communication_Cmnts=@Communication_Cmnts,Call_Logging_Documentation=@Call_Logging_Documentation,Call_Logging_Documentation_Cmnts=@Call_Logging_Documentation_Cmnts,Additional_Assistance=@Additional_Assistance,Additional_Assistance_Cmnts=@Additional_Assistance_Cmnts,Callback=@Callback,Callback_Cmnts=@Callback_Cmnts,Callback_ValueAdd=@Callback_ValueAdd,CallBack_ValueAdd_Cmnts=@CallBack_ValueAdd_Cmnts,AuditResult=@AuditResult,[AuditStatus]='Resolved' WHERE CallID_SR_ID=@CallID_SR_ID";
            ...
            cmd.Parameters.AddWithValue("@HPBranding", Q01.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@HPBranding_Cmnts", C01.Text);
            cmd.Parameters.AddWithValue("@Case_Study", Q02.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Case_Study_Cmnts", C02.Text);
            cmd.Parameters.AddWithValue("@Probing_Logical_Troubleshooting", Q03.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Probing_Logical_Troubleshooting_Cmnts", C03.Text);
            cmd.Parameters.AddWithValue("@Resolution_CaseStatus", Q04.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Resolution_CaseStatus_Cmnts", C04.Text);
            cmd.Parameters.AddWithValue("@Communication", Q05.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Communication_Cmnts", C05.Text);
            cmd.Parameters.AddWithValue("@Call_Logging_Documentation", Q06.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Call_Logging_Documentation_Cmnts", C06.Text);
            cmd.Parameters.AddWithValue("@Additional_Assistance", Q07.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Additional_Assistance_Cmnts", C07.Text);
            cmd.Parameters.AddWithValue("@Callback", Q08.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Callback_Cmnts", C08.Text);
            cmd.Parameters.AddWithValue("@Callback_ValueAdd", Q09.SelectedItem.Text);
            cmd.Parameters.AddWithValue("@Callback_ValueAdd_Cmnts", C09.Text);
            cmd.Parameters.AddWithValue("@AuditResult", hfv_AuditRes.Value);
            SqlDataReader dr = cmd.ExecuteReader();
            Con.Close();
            maildetails();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Audit Updated Successfully');window.location ='QADashboardFY22TCOLegend.aspx';", true);
        }
        ...
        private bool SendEmail(string to, string from, string password, string subject, string body, string cc, string tl)
        {
            ...
            try
            {
                ...
                mail.Subject = "Resolved TCO Audit | " + ddMonth.SelectedItem.Text + " | " + tbId3.Text;
                mail.Body = body;
        ...
        public bool maildetails()
        {
            ...
            string body = "http://15.42.19.247:120/AuditSheetUserFY22TCO.aspx?case=" + tbId7.Text;
            ...
            string body4 = "http://15.42.19.247:120/AuditSheetMgrFY22TCO.aspx?case=" + tbId7.Text;
        ...
        {
            Response.Redirect("~/Download/FY23 TCO Report.xlsx");
        }

        protected void QADashboard_Click(object sender, EventArgs e)
        {
            Response.Redirect("QADashboardFY22TCOLegend.aspx");
        }

        protected void btnCaseIdCheck_Click(object sender, EventArgs e)
        {
            Con.Open();
            SqlCommand cmd = new SqlCommand("select * from [dbo].[FY22TCOLegend] where CaseID=@CaseId", Con);
            cmd.Parameters.AddWithValue("@CaseId", tbId6.Text);
            cmd.Connection = Con;
            SqlDataReader dr = cmd.ExecuteReader();
        ...
        {
            Con.Open();
            SqlCommand cmd = new SqlCommand("select * from [dbo].[FY22TCOLegend] where CallID_SR_ID=@CallID_SR_ID", Con);
            cmd.Parameters.AddWithValue("@CallID_SR_ID", tbId7.Text);
            cmd.Connection = Con;
            SqlDataReader dr = cmd.ExecuteReader();
        ...
        {
            Response.Redirect("AuditFeedbackFormTCO.aspx");
        }

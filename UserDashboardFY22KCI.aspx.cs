...
{
    public partial class UserDashboardFY22KCI : System.Web.UI.Page
    {
        ...
        public void bind_data()
        {
            ...
            else
            {
                ...
                SqlCommand query1 = new SqlCommand("SELECT count(AuditResult) from [dbo].[FY22KCI2Legend] where Employee_Name='" + emp_name + "'", Con);
                ...
                SqlCommand query2 = new SqlCommand("SELECT count(AuditResult) from [dbo].[FY22KCI2Legend] where Employee_Name='" + emp_name + "' and AuditResult = 'Pass'", Con);
                ...
                SqlCommand query3 = new SqlCommand("SELECT count(AuditResult) from [dbo].[FY22KCI2Legend] where Employee_Name='" + emp_name + "' and AuditResult = 'Fail'", Con);
                ...
                SqlCommand query4 = new SqlCommand("SELECT ISNULL(AVG([AuditScore]),0) from [dbo].[FY22KCI2Legend] where Employee_Name='" + emp_name + "'", Con);
                ...
                "select Employee_Name, " +
                 ...
                 "from FY22KCI2Legend where AuditCount > 0 group by Employee_Name) as Table1 where Employee_Name = '" + emp_name + "' group by Employee_Name", Con);
                ...
                SqlDataSource1.SelectCommand = "select EmployeeID,Employee_Name,CallID_SR_ID,CallDate,EvaluationDate,QAName,AuditStatus,AuditScore FROM [dbo].[FY22KCI2Legend] where Employee_Mail='" + emp_mail + "' order by AuditCount desc";
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("AuditSheetUserFY22KCI.aspx?case=" + cass);
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.Page.Controls.Add(SqlDataSource1);
                SqlDataSource1.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["CString"].ConnectionString;
                SqlDataSource1.SelectCommand = "select EmployeeID,Employee_Name,CallID_SR_ID,CallDate,EvaluationDate,QAName,AuditStatus,AuditScore FROM [dbo].[FY22KCI2Legend] where CallID_SR_ID='" + searchbar.Text + "' order by AuditCount desc";
                UserGrid.DataSource = SqlDataSource1;
                UserGrid.DataBind();
            }
            catch (Exception ex)

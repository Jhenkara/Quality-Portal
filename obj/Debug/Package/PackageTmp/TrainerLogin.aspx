<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainerLogin.aspx.cs" Inherits="Audit_Legends.TrainerLogin" %>
...
<body>
    ...
    <div class="panel-body" id="LoginDiv">
        <div class="row-center" >
            ...
            <h1 class="navbar-brand pull-right" style="color:white;font-weight:bold;">  Trainer Login</h1>
            <br /><br />
        </div>
        <form runat="server" >

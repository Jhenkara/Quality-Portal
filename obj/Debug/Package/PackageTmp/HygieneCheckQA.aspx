<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HygieneCheckQA.aspx.cs" Inherits="Audit_Legends.HygieneCheckQA" %>
...
<head runat="server">
    ...
    <title>Hygiene Check (QA) Login Page</title>
    <link rel="shortcut icon" href="Images/HP logoblu.png"  />
    <link href="QALogin.css" rel="stylesheet" type="text/css" />
</head>
<body>
    ...
    <div class="panel-body" id="LoginDiv">
        <div class="row-center" >
            ...
            <h1 class="navbar-brand pull-right" style="color:white;font-weight:bold;font-size:22px;"> Hygiene Check (QA) Login Page </h1>
            <br /><br />
        </div>
        <form runat="server" >

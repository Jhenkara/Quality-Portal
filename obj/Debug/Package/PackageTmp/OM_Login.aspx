<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OM_Login.aspx.cs" Inherits="Audit_Legends.OM_Login" %>
...
<body>
    ...
    <div class="panel-body" id="LoginDiv">
        <div class="row-center" >
            ...
            <h1 class="navbar-brand pull-right" style="color:white;font-weight:bold;font-size:22px;">  OM / OL Login</h1>
            <br /><br />
        </div>
        <form runat="server" >

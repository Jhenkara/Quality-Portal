<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditSheetUser.aspx.cs" Inherits="Audit_Legends.AuditSheetUser" %>
...
<body>
    ...
    <div class="auto-style1" style="color:aliceblue;background-color:black;text-align:left;line-height:100px;">
        ...
        <h1><img src="HP-blue.png" style="width:98px;overflow:auto;float:initial;"/> Premium Consumer Legend </h1>
    </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TOC_Legend.aspx.cs" Inherits="Audit_Legends.TOC_Legend" %>
...
<body>
    ...
    <div style="text-align:right;height:80px;">
        ...
        <asp:Button ID="Download" CssClass="MenuButtons" CausesValidation="false" runat="server" Text="Download" OnClick="FileDownload" />
        ...
        <table id="table1" style="float: left">
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator InitialValue="-1" ID="RequiredFieldValidator10" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" ControlToValidate="ddProbDes" SetFocusOnError="true"></asp:RequiredFieldValidator>
                </td>
            </tr>

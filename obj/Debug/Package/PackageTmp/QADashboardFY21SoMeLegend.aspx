<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QADashboardFY21SoMeLegend.aspx.cs" Inherits="Audit_Legends.QADashboardFY21SoMeLegend" %>
            ...
            <div class="col-sm-12">
                <asp:GridView ID="TrendGrid" runat="server" AutoGenerateEditButton="false" CellSpacing="2" CssClass=" table table-bordered table-responsive rounded_corners" AutoGenerateColumns="false" Width="100%" HeaderStyle-BackColor="#3AC0F2"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="CaseFollowUp" HeaderText="Case FollowUp" />

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditSheetADXQA.aspx.cs" Inherits="Audit_Legends.AuditSheetADXQA" %>
    ...
    <script type="text/javascript">
        ...
        function DropDownFilter() {
            ...
            if ((q12.options[q12.selectedIndex].text == 'Met') || (q12.options[q12.selectedIndex].text == 'NA')) {
                ...
                if ((q12a.options[q12a.selectedIndex].text == 'Not Met') || (q12b.options[q12b.selectedIndex].text == 'Not Met') || (q12c.options[q12c.selectedIndex].text == 'Not Met') || (q12d.options[q12d.selectedIndex].text == 'Not Met')) {
                    SelectedValue += Number(5);
                    CC += Number(5);
                }
            }//Qstn 12

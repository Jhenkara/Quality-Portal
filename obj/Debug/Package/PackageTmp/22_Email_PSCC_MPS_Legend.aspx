<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="22_Email_PSCC_MPS_Legend.aspx.cs" Inherits="Audit_Legends._22_Email_PSCC_MPS_Legend" %>
...
<%--                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" ControlToValidate="tbId6" runat="server" ErrorMessage="* Must be exactly 10 Characters" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Smaller" ForeColor="Red" SetFocusOnError="true" ValidationExpression="^[0-9]{10}$"></asp:RegularExpressionValidator>--%>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator InitialValue="-1" ID="RequiredFieldValidator8" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" ControlToValidate="ddBS" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ControlToValidate="Q02" ID="RequiredFieldValidator10" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="Q03" runat="server" Height="20px" Width="150px" Font-Size="X-Small" onchange="DropDownFilter(this);">
                                            <asp:ListItem Enabled="true" text="--Choose--" Value="0" ></asp:ListItem>
                                            <asp:ListItem Text="Met" Value="1"></asp:ListItem>
                                            <asp:ListItem Text="Partial" Value="2"></asp:ListItem>
                                            <asp:ListItem Text="Not Met" Value="3"></asp:ListItem>
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ControlToValidate="Q03" ID="RequiredFieldValidator15" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>Behavioural skill opportunity<br />
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ControlToValidate="Q05" ID="RequiredFieldValidator4" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:DropDownList ID="Q07" runat="server" Height="20px" Width="150px" Font-Size="X-Small" onchange="DropDownFilter(this);">
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ID="RequiredFieldValidator39" ControlToValidate="Q07" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                    ...
                                    <tr>
                                        <td>Did the Engineer showcase ownership?<br />
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ControlToValidate="Q08" ID="RequiredFieldValidator9" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:DropDownList ID="Q09" runat="server" Height="20px" Width="150px" Font-Size="X-Small" onchange="DropDownFilter(this);">
                                            ...
                                            <asp:ListItem Text="Inaccurate / Incomplete Contact Information" Value="4"></asp:ListItem>
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:DropDownList ID="Q10" runat="server" Height="20px" Width="150px" Font-Size="X-Small" onchange="DropDownFilter(this);">
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ID="RequiredFieldValidator52" ControlToValidate="Q10" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>
    ...
    <script type="text/javascript">
        ...
        function DropDownFilter() {
            ...
            if ((q5.options[q5.selectedIndex].text == 'Met') || (q5.options[q5.selectedIndex].text == 'NA')) {
                ...
                if ((q5a.options[q5a.selectedIndex].text == 'Not Met') || (q5b.options[q5b.selectedIndex].text == 'Not Met') || (q5c.options[q5c.selectedIndex].text == 'Not Met') || (q5d.options[q5d.selectedIndex].text == 'Not Met') || (q5e.options[q5e.selectedIndex].text == 'Not Met') || (q5f.options[q5f.selectedIndex].text == 'Not Met')) {
                    SelectedValue += Number(13);
                    CC += Number(13);
                }
            }//Qstn 5
            ...
            if ((q7.options[q7.selectedIndex].text == 'Did not set Expectations') || (q7.options[q7.selectedIndex].text == 'Incorrect Expectations') || (q7.options[q7.selectedIndex].text == 'KCI'))
            {
                SelectedValue += Number(14);
                CC += Number(14);
            }//Qstn 7
            ...
            if ((q8.options[q8.selectedIndex].text == 'Met') || (q8.options[q8.selectedIndex].text == 'NA')) {
                ...
                if ((q8a.options[q8a.selectedIndex].text == 'Not Met') || (q8b.options[q8b.selectedIndex].text == 'Not Met') || (q8c.options[q8c.selectedIndex].text == 'Not Met') || (q8d.options[q8d.selectedIndex].text == 'Not Met')) {
                    SelectedValue += Number(10);
                    CC += Number(10);
                }
            }//Qstn 8

            if ((q9.options[q9.selectedIndex].text == 'Fabrication') || (q9.options[q9.selectedIndex].text == 'No Documentation') || (q9.options[q9.selectedIndex].text == 'Usage of Relevant templates') ||(q9.options[q9.selectedIndex].text == 'Inaccurate / Incomplete Contact Information')) {
                SelectedValue += Number(10);
                BC += Number(10);
            }//Qstn 9

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QADashboardFY21VoiceLegend.aspx.cs" Inherits="Audit_Legends.QADashboardFY21VoiceLegend" %>
...
<body>
    ...
    <div class="col-sm-6" style="margin-left:30px;">
        <br />
        <asp:TextBox ID="searchbar" CssClass="form-check-inline" AutoCompleteType="Disabled" placeholder="Enter the Employee ID or the Call ID here" BorderStyle="Inset" runat="server" Height="25px" Width="400px"></asp:TextBox>

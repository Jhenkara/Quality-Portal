<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HygieneCheckUser.aspx.cs" Inherits="Audit_Legends.HygieneCheckUser" %>
...
<head runat="server">
    ...
    <title>Engineer Login Page</title>
    <link rel="shortcut icon" href="Images/HP logoblu.png"  />
    <link href="AgentLogin.css" rel="stylesheet" type="text/css" />
</head>
<body>
    ...
    <div class="panel-body" id="LoginDiv">
        <div class="row-center" >
            ...
            <h1 class="navbar-brand pull-right" style="color:white;font-weight:bold;font-size:22px;">  Engineer Login</h1>
            <br /><br />
        </div>
        <form runat="server" >
            <div class="form-horizontal">
                <div class="form-group">
                    ...
                    <asp:RequiredFieldValidator ID="errUser" CssClass="validation" runat="server" ErrorMessage="required" ControlToValidate="tbUsername"></asp:RequiredFieldValidator>

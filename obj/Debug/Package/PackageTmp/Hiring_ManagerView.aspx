<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Hiring_ManagerView.aspx.cs" Inherits="Audit_Legends.Hiring_ManagerView" %>
...
<head>
    ...
    <title>Hiring Form | Manager View</title>
...
<body>
    ...
    <div class="auto-style1" style="color:aliceblue;background-color:#4d4e4f;text-align:left;line-height:100px;width:100%">
        ...
        <h1><%--<img src="Images/hp_logo_white.png" style="width:98px;overflow:auto;float:initial;"/>--%> Hiring Form | Manager View </h1>
    </div>
                    ...
                    <div class="row">
                        ...
                        <table id="table1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddBU" CssClass="form-control input-xs" runat="server" AutoPostBack="true">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="tbId4" CssClass="form-control input-xs" AutoPostBack="true" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddJobDesc" CssClass="form-control input-xs" runat="server" AutoPostBack="true">
                                        <asp:ListItem Enabled="true" text="--Choose--" Value="-1" ></asp:ListItem>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddReq" CssClass="form-control input-xs" runat="server" AutoPostBack="true">
                                        <asp:ListItem Enabled="true" text="--Choose--" Value="-1" ></asp:ListItem>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="tbId6" CssClass="form-control input-xs" placeholder="Choose / type in 'MM/DD/YYYY' Format" AutoPostBack="true" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server"></asp:TextBox>

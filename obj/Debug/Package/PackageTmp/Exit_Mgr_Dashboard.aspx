<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Exit_Mgr_Dashboard.aspx.cs" Inherits="Audit_Legends.Exit_Mgr_Dashboard" %>
            ...
            <div class="col-sm-12">
                <asp:GridView ID="UserGrid" runat="server" AutoGenerateEditButton="false" CellSpacing="2" CssClass=" table table-bordered table-responsive rounded_corners" AutoGenerateColumns="false" Width="100%" HeaderStyle-BackColor="#3AC0F2"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="ManagerSubmission" HeaderText="Manager Submission" />

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditSheetUserFY21Chat.aspx.cs" Inherits="Audit_Legends.AuditSheetUserFY21Chat" %>
...
<body>
    ...
    <div class="container-fluid" style="text-align:right;align-items:center;height:60px;width:95%;">
        ...
        <asp:Button ID="Chat_GuideLines" CausesValidation="false" runat="server" Text="View Guidelines" target="_blank" CssClass="MenuButtons" OnClientClick="SetTarget();return false;" />
        <script type="text/javascript">
        function SetTarget() {
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:TextBox ID="Q13d" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server"></asp:TextBox>

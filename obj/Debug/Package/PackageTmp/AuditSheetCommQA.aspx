<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditSheetCommQA.aspx.cs" Inherits="Audit_Legends.AuditSheetCommQA" %>
...
<body>
    ...
    <div class="auto-style1" style="color:aliceblue;background-color:black;text-align:left;line-height:100px;width:100%">
        ...
        <h1><img src="Images/HP logoblu.png" style="width:98px;overflow:auto;float:initial;"/> Commercial Legend</h1>
    </div>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddDeliType" runat="server" Height="25px" Width="300px">
                        ...
                        <asp:ListItem Text="Tech Assist" Value="3"></asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
        ...
        <table id="table4" style="float:left;margin-left:30px;position:center">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddCaseType" runat="server" Height="25px" Width="300px">
                        ...
                        <asp:ListItem Text="RCD" Value="4"></asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="* CC Mail ID required!!" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" ControlToValidate="TextBox4" SetFocusOnError="true"></asp:RequiredFieldValidator>
                </td>
            </tr>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="22_TCOLegend.aspx.cs" Inherits="Audit_Legends._22_TCOLegend" %>
...
<body>
    ...
    <div class="auto-style1" style="color:aliceblue;background-color:#4d4e4f;text-align:left;line-height:100px;width:100%">
        ...
        <h1><img src="Images/hp_logo_white.png" style="width:98px;overflow:auto;float:initial;"/> TCO Audit Form </h1>
    </div>
    ...
    <div class="container-fluid" style="text-align:right;align-items:center;height:60px;width:95%;">
        ...
        <script type="text/javascript">
        function SetTarget() {
            window.open("22_TCOLegendGL.aspx");
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddCallType" CssClass="form-control input-xs" runat="server">
                                        <asp:ListItem Enabled="true" text="--Choose--" Value="-1" ></asp:ListItem>
                                        <asp:ListItem Text="Resolution Check" Value="0"></asp:ListItem>
                                        <asp:ListItem Text="Staus Check" Value="1"></asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:RequiredFieldValidator InitialValue="-1" ID="RequiredFieldValidator12" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" ControlToValidate="ddCallType" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                        ...
                        <div class="row">
                            ...
                            <table id="table2" border="1" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td >Did the Engineer Introduce himself with HP branding and read out the case number? <br />
                                        </td>
                                        <td></td>
                                        <td><asp:DropDownList ID="Q01" runat="server" Height="20px" Width="150px" Font-Size="X-Small" onchange="DropDownFilter(this);">
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ID="RequiredFieldValidator1" ControlToValidate="Q01" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                    ...
                                    <tr>
                                        <td>Did the Engineer do case study before calling the customer? </td>
                                        <td></td>
                                    ...
                                    <tr>
                                        <td>
                                            Did the engineer probe and follow logical troubleshooting?</td>
                                        <td>
                                        </td>
                                    ...
                                    <tr>
                                        <td>Did the Engineer check for resolution\case status?</td>
                                        <td>
                                        </td>
                                    ...
                                    <tr>
                                        <td>Was the Engineer's communication satisfactory on the call? <br />
                                        </td>
                                        <td>
                                        </td>
                                        <td><asp:DropDownList ID="Q05" runat="server" Height="20px" Width="150px" Font-Size="X-Small" onchange="DropDownFilter(this);">
                                            ...
                                            <asp:ListItem Text="Met" Value="1"></asp:ListItem>
                                            <asp:ListItem Text="Matching Customer Skill Level" Value="2"></asp:ListItem>
                                            <asp:ListItem Text="Courtesy / Empathy" Value="3"></asp:ListItem>
                                            <asp:ListItem Text="Tone of Voice" Value="4"></asp:ListItem>
                                            <asp:ListItem Text="Educating the Customer" Value="5"></asp:ListItem>
                                            <asp:ListItem Text="Active Listening" Value="6"></asp:ListItem>
                                            <asp:ListItem Text="Rate of Speech" Value="7"></asp:ListItem>
                                            <asp:ListItem Text="Accent / Language" Value="8"></asp:ListItem>
                                            <asp:ListItem Text="Unprofessionlism" Value="9"></asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator InitialValue="0" ControlToValidate="Q05" ID="RequiredFieldValidator7" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                    ...
                                    <tr>
                                        <td>Did the Engineer adhere to the Call Logging Process and Documented Conversation details accurately? <br />
                                        </td>
                                        <td>
                                        </td>
                                        <td><asp:DropDownList ID="Q06" runat="server" Height="20px" Width="150px" Font-Size="X-Small" onchange="DropDownFilter(this);">
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ControlToValidate="Q06" ID="RequiredFieldValidator4" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>Did the Engineer offer  additional assistance and close the call HP way<br />
                                        </td>
                                        <td></td>
                                    ...
                                    <tr>
                                        <td>Call back done as per the commitment(please look at previous call back logs for misses)<br />
                                        </td>
                                        <td>
                                            
                                        </td>
                                        <td><asp:DropDownList ID="Q08" runat="server" Height="20px" Width="150px" Font-Size="X-Small">
                                            <asp:ListItem Enabled="true" text="--Choose--" Value="0" ></asp:ListItem>
                                            <asp:ListItem Text="Met" Value="1"></asp:ListItem>
                                            <asp:ListItem Text="Not Met" Value="2"></asp:ListItem>
                                            <asp:ListItem Text="NA" Value="3"></asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator InitialValue="0" ID="RequiredFieldValidator9" ControlToValidate="Q08" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>Was there a value add for the call back?<br />
                                        </td>
                                        <td>
                                            
                                        </td>
                                        <td><asp:DropDownList ID="Q09" runat="server" Height="20px" Width="150px" Font-Size="X-Small">
                                            <asp:ListItem Enabled="true" text="--Choose--" Value="0" ></asp:ListItem>
                                            <asp:ListItem Text="Issue Resolution" Value="1"></asp:ListItem>
                                            <asp:ListItem Text="Extra Mile" Value="2"></asp:ListItem>
                                            <asp:ListItem Text="Customer Centricity" Value="3"></asp:ListItem>
                                            <asp:ListItem Text="No" Value="4"></asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator InitialValue="0" ID="RequiredFieldValidator14" ControlToValidate="Q09" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:DropDownList ID="ddNonComp" runat="server" Height="20px" Width="150px" Font-Size="X-Small" onchange="DropDownFilter(this);">
                                            ...
                                            <asp:ListItem Text="NA" Value="13"></asp:ListItem>
                                        </asp:DropDownList>
    ...
    <script type="text/javascript">
        ...
        function DropDownFilter() {
            ...
            if ((q4.options[q4.selectedIndex].text == 'Met') || (q4.options[q4.selectedIndex].text == 'NA') || (q4.options[q4.selectedIndex].text == '--Choose--')) {
                SelectedValue += Number(0);
                BC += Number(0);
            }
            ...
            if ((q5.options[q5.selectedIndex].text == 'Met') || (q5.options[q5.selectedIndex].text == '--Choose--'))
            {
                SelectedValue += Number(0);
                BC += Number(0);
            }
            ...
            if ((q6.options[q6.selectedIndex].text == 'Met') || (q6.options[q6.selectedIndex].text == '--Choose--'))
            {
                SelectedValue += Number(0);
                CC += Number(0);
            }
            else if ((q6.options[q6.selectedIndex].text == 'Partial')) {
                
                SelectedValue += Number(5);
                CC += Number(5);
            }
            else if ((q6.options[q6.selectedIndex].text == 'Missed Case Creation') || (q6.options[q6.selectedIndex].text == 'Missed QC') || (q6.options[q6.selectedIndex].text == 'Fabrication')) {

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TrainingType1.aspx.cs" Inherits="Audit_Legends.TrainingType1" %>
...
<body>
    ...
    <div style="text-align:right;height:80px;">
        ...
        <asp:Button ID="DataUpload" CausesValidation="false" runat="server" Text="Data Upload" OnClick="DataUpload_Click" />
...
--%>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddl7" runat="server" Height="25px" Width="300px">
                        <asp:ListItem Enabled="true" text="--Choose--" Value="-1" ></asp:ListItem>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Attrition_HiringLogin.aspx.cs" Inherits="Audit_Legends.Attrition_HiringLogin" %>
...
<body>
    ...
    <div class="panel-body" id="LoginDiv">
        <div class="row-center" >
            ...
            <h1 class="navbar-brand pull-right" style="color:white;font-weight:bold;font-size:22px;">  Hiring Team Login</h1>
            <br /><br />
        </div>
        <form runat="server" >

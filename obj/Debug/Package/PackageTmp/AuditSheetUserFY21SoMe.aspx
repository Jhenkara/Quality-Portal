<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditSheetUserFY21SoMe.aspx.cs" Inherits="Audit_Legends.AuditSheetUserFY21SoMe" %>
...
<head>
    ...
    <title>FY21 SoMe Audit Form</title>
...
<body>
    ...
    <div class="auto-style1" style="color:aliceblue;background-color:#4d4e4f;text-align:left;line-height:100px;width:100%">
        ...
        <h1><img src="Images/hp_logo_white.png" style="width:98px;overflow:auto;float:initial;"/> FY21 SoMe Audit Form </h1>
    </div>
                    ...
                    <div class="row">
                        ...
                        <table id="table1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="tbST" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server"></asp:TextBox>
                                </td>
                            </tr>
                            ...
                            <table id="table2" border="1" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="Q01a" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server"></asp:TextBox>
                                            ...
                                            <asp:TextBox ID="Q01e" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server"></asp:TextBox>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="Q02a" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server" Height=27px></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="Q06a" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="Q07a" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="Q08a" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server"></asp:TextBox>
                                            ...
                                            <asp:TextBox ID="Q08f" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server"></asp:TextBox>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="Q10a" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server"></asp:TextBox>
                                        
                                            <asp:TextBox ID="Q10b" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server"></asp:TextBox>
                                        
                                            <asp:TextBox ID="Q10c" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server"></asp:TextBox>
                                        
                                            <asp:TextBox ID="Q10d" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server"></asp:TextBox>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="Q13" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server"></asp:TextBox>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="Q14a" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="Q14" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server"></asp:TextBox>

                                            <asp:TextBox ID="Q14b" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server"></asp:TextBox>
                                        </td>
                                        <td>

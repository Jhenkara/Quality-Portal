<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditSheetQARR.aspx.cs" Inherits="Audit_Legends.AuditSheetQARR" %>
...
<body>
    ...
    <div class="auto-style1" style="color:aliceblue;background-color:black;text-align:left;line-height:100px;width:100%">
        ...
        <h1><img src="Images/HP logoblu.png" style="width:98px;overflow:auto;float:initial;"/> Rio Rancho Legend</h1>
    </div>

    <div style="text-align:right">
        <asp:Label ID="lblUserDetails" runat="server" Text=""></asp:Label>
        <asp:Button ID="QADashboard" runat="server" Text="QA Dashboard" OnClick="QADashboard_Click" />
    ...
    <div class="row" style="margin-left:20px;margin-top:20px;">
        ...
        <table id="table1" style="float: left">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList AutoPostBack="false" ID="ddCusType" runat="server" Height="25px" Width="300px">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddBU" runat="server" Height="25px" Width="300px">
                        <asp:ListItem Enabled="true" text="--Choose--" Value="-1" ></asp:ListItem>
                        <asp:ListItem Text="Rio" Value="0"></asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddTeamName" runat="server" Height="25px" Width="300px">
                        <asp:ListItem Enabled="true" text="--Choose--" Value="-1" ></asp:ListItem>
                        <asp:ListItem Text="Rio Omen" Value="0"></asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TextBox4" TextMode="MultiLine" CssClass="form-control" AutoCompleteType="Disabled" BorderStyle="Inset" placeholder="* For more than one email, seperate it with ';'" runat="server" Height="80px" Width="300px"></asp:TextBox>
        ...
        <table id="table4" style="float:left;margin-left:30px;position:center">
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddPersona" DataTextField="hI" runat="server" Height="25px" Width="300px">
                        <asp:ListItem Enabled="true" text="--Choose--" Value="-1" ></asp:ListItem>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="tbNonComp" TextMode="MultiLine" CssClass="form-control" AutoPostBack="false" AutoCompleteType="Disabled" BorderStyle="Inset" placeholder="" runat="server" Height="60px" Width="300px"></asp:TextBox>
                </td>
            </tr>
        ...
        <table id="table2" border="1">
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="TextBox6" TextMode="MultiLine" AutoCompleteType="Disabled" placeholder="* Only use to copy, this box doesn't get submitted" BorderStyle="Inset" runat="server" Height="50px" Width="250px"></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><asp:DropDownList ID="C11" runat="server" Height="25px" Width="150px" onchange="DropDownFilter(this);">
                        <asp:ListItem Enabled="true" text="--Choose--" Value="0" ></asp:ListItem>
                        <asp:ListItem Text="Yes" Value=""></asp:ListItem>
                        <asp:ListItem Text="Partial" Value="5"></asp:ListItem>
                        <asp:ListItem Text="No" Value="10"></asp:ListItem></asp:DropDownList></td>
                ...
                <tr>
                    <th>Stroke Economy</th>
                    <td>Applied the right Stroke Economy</td>
                    <td>Interact with the customer in accordance with the traits showcased by the customer</td>
                    <td><asp:DropDownList ID="C12" runat="server" Height="25px" Width="150px" onchange="DropDownFilter(this);">
                        <asp:ListItem Enabled="true" text="--Choose--" Value="0" ></asp:ListItem>
                        <asp:ListItem Text="Yes" Value=""></asp:ListItem>
                        <asp:ListItem Text="Partial" Value="5"></asp:ListItem>
                        <asp:ListItem Text="No" Value="10"></asp:ListItem>
                ...
                <tr>
                    <th rowspan="10" scope="rowgroup">Tracking Questions</th>
                    <th>Stroke Application</th>
                    <td>Right Stroke Economy - Missed Opportunities</td>
                    <td><asp:TextBox ID="C13" TextMode="MultiLine" CssClass="form-control" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server" Height="40px" Width="240px"></asp:TextBox></td>
                </tr>
                ...
                <tr>
                    ...
                    <td></td>
                        <td><asp:DropDownList ID="C19" runat="server" Height="25px" Width="150px">
                        <asp:ListItem Enabled="true" Text="NA" Value="-1" ></asp:ListItem>
                        <asp:ListItem Text="Yes" Value="0"></asp:ListItem>
                        <asp:ListItem Text="No" Value="5"></asp:ListItem>
                        </asp:DropDownList></td>
                ...
                <tr>
                    ...
                    <td></td>
                        <td><asp:DropDownList ID="C20" runat="server" Height="25px" Width="150px">
                        <asp:ListItem Enabled="true" Text="NA" Value="-1" ></asp:ListItem>
                        <asp:ListItem Text="Yes" Value="0"></asp:ListItem>
                        <asp:ListItem Text="No" Value="5"></asp:ListItem>
                        </asp:DropDownList></td>
                ...
                <tr>
                    ...
                    <td></td>
                        <td><asp:DropDownList ID="C21" runat="server" Height="25px" Width="150px">
                        <asp:ListItem Enabled="true" Text="NA" Value="-1" ></asp:ListItem>
                        <asp:ListItem Text="Yes" Value="0"></asp:ListItem>
                        <asp:ListItem Text="No" Value="5"></asp:ListItem>
                        </asp:DropDownList></td>
                ...
                <tr>
                    <th>What was your opening statement on this call?</th>
                    <td></td>
                    <td>
                        <asp:TextBox ID="TextBox7" TextMode="MultiLine" CssClass="form-control" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server" Height="40px" Width="240px"></asp:TextBox>
                    </td>
                </tr>

                <tr>
                    <th>Did you provide an empathy statement?</th>
                    <td></td>
                        <td><asp:DropDownList ID="C19" runat="server" Height="25px" Width="150px">
                        <asp:ListItem Enabled="true" Text="--Choose--" Value="-1" ></asp:ListItem>
                        <asp:ListItem Text="Yes" Value="0"></asp:ListItem>
                ...
                <tr>
                    <th>What was the most impactful empathy statement made on this call?</th>
                    <td></td>
                    <td>
                        <asp:TextBox ID="TextBox8" TextMode="MultiLine" CssClass="form-control" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server" Height="40px" Width="240px"></asp:TextBox>
                    </td>
                </tr>

                <tr>
                    <th>What did you learn about this customer other than reason for the call today?</th>
                    <td></td>
                    <td>
                        <asp:TextBox ID="TextBox9" TextMode="MultiLine" CssClass="form-control" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server" Height="40px" Width="240px"></asp:TextBox>
                    </td>
                </tr>

                <tr>
                    <th>Did you recap this call?</th>
                    <td></td>
                        <td><asp:DropDownList ID="C20" runat="server" Height="25px" Width="150px">
                        <asp:ListItem Enabled="true" Text="--Choose--" Value="-1" ></asp:ListItem>
                        <asp:ListItem Text="Yes" Value="0"></asp:ListItem>
                ...
                <tr>
                    <th>What was your recap statement on this call?</th>
                    <td></td>
                    <td>
                        <asp:TextBox ID="TextBox10" TextMode="MultiLine" CssClass="form-control" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server" Height="40px" Width="240px"></asp:TextBox>
                    </td>
                </tr>

                <tr>
                    <th>Did you invite the customer to take the survey on this call?</th>
                    <td></td>
                        <td><asp:DropDownList ID="C22" runat="server" Height="25px" Width="150px">
                        <asp:ListItem Enabled="true" Text="--Choose--" Value="-1" ></asp:ListItem>
                        <asp:ListItem Text="Yes" Value="0"></asp:ListItem>
                        <asp:ListItem Text="No" Value="5"></asp:ListItem>
                        </asp:DropDownList></td>

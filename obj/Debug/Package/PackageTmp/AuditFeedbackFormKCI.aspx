<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditFeedbackFormKCI.aspx.cs" Inherits="Audit_Legends.AuditFeedbackFormKCI" %>
...
<head>
    ...
    <title>KCI 2.0 Audit Feedback Form</title>
...
<body>
    ...
    <div class="auto-style1" style="color:aliceblue;background-color:black;text-align:left;line-height:100px;width:100%">
        ...
        <h1><img src="Images/HP logoblu.png" style="width:98px;overflow:auto;float:initial;"/> KCI 2.0 Audit Feedback Form </h1>
    </div>

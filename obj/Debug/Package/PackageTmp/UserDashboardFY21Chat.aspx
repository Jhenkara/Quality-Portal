<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserDashboardFY21Chat.aspx.cs" Inherits="Audit_Legends.UserDashboardFY21Chat" %>
...
<body>
    ...
    <div class="col-sm-6" style="margin-left:20px;">
        <asp:TextBox ID="searchbar" CssClass="form-check-inline" AutoCompleteType="Disabled" placeholder="Enter the Chat ID here" BorderStyle="Inset" runat="server" Height="25px" Width="400px"></asp:TextBox>

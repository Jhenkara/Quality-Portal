<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="21_ChatLegend.aspx.cs" Inherits="Audit_Legends._21_ChatLegend" %>
...
<body>
    ...
    <div class="auto-style1" style="color:aliceblue;background-color:#4d4e4f;text-align:left;line-height:100px;width:100%">
        ...
        <h1><img src="Images/hp_logo_white.png" style="width:98px;overflow:auto;float:initial;"/> Chat Audit Form </h1>
    </div>
    ...
    <div class="container-fluid" style="text-align:right;align-items:center;height:60px;width:95%;">
        ...
        <script type="text/javascript">
        function SetTarget() {
            window.open("21_ChatLegendGL.aspx");        }
    </script>
                        ...
                        <table id="table1">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator15" ControlToValidate="tbId7" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Smaller" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:DropDownList ID="ddChatDuration" CssClass="form-control input-xs" runat="server">
                                        <asp:ListItem Enabled="true" text="--Choose--" Value="-1" ></asp:ListItem>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" ControlToValidate="ddChatDuration" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator InitialValue="-1" ID="RequiredFieldValidator21" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" ControlToValidate="ddBS" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:DropDownList ID="Q04" runat="server" Height="20px" Width="150px" Font-Size="X-Small" onchange="DropDownFilter(this);">
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ID="RequiredFieldValidator18" ControlToValidate="Q04" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:DropDownList ID="Q05" runat="server" Height="20px" Width="150px" Font-Size="X-Small" onchange="DropDownFilter(this);">
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ID="RequiredFieldValidator19" ControlToValidate="Q05" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>Behavioural skill opportunities<br />
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ControlToValidate="Q06" ID="RequiredFieldValidator8" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>Communication opportunities<br />
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ControlToValidate="Q07" ID="RequiredFieldValidator10" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>
                                            
                                            End to End CRM skills<br />
                                            Rate of Speech<br />
                                            Tone of Voice<br />
                                            Language
                                        </td>
                                    ...
                                    <tr>
                                        <td>Customer Obsessed Behaviour<br />
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ControlToValidate="Q08" ID="RequiredFieldValidator16" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>
                                            Rapport Building<br />
                                            Assurance<br />
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:DropDownList ID="Q09" runat="server" Height="20px" Width="150px" Font-Size="X-Small" onchange="DropDownFilter(this);">
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ID="RequiredFieldValidator3" ControlToValidate="Q09" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:DropDownList ID="Q12" runat="server" Height="20px" Width="150px" Font-Size="X-Small" onchange="DropDownFilter(this);">
                                            <asp:ListItem Enabled="true" text="--Choose--" Value="0" ></asp:ListItem>
                                            <asp:ListItem Text="Met" Value="1"></asp:ListItem>
                                            <asp:ListItem Text="Email Follow-up" Value="2"></asp:ListItem>
                                            <asp:ListItem Text="Snooze" Value="3"></asp:ListItem>
                                            <asp:ListItem Text="Call back adherence" Value="4"></asp:ListItem>
                                            <asp:ListItem Text="NA" Value="5"></asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:RequiredFieldValidator InitialValue="0" ID="RequiredFieldValidator39" ControlToValidate="Q12" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                    ...
                                    <tr>
                                        <td>Did the Engineer showcased ownership/ escalated the chat if required?<br />
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ControlToValidate="Q13" ID="RequiredFieldValidator20" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>
                                        ...
                                        <br />
                                            <asp:DropDownList ID="Q13d" runat="server" Height="20px" Width="150px" Font-Size="X-Small" onchange="DropDownFilter(this);">
                                            <asp:ListItem Enabled="true" text="Met" Value="0" ></asp:ListItem>
                                            <asp:ListItem Text="Met" Value="1"></asp:ListItem>
                                            <asp:ListItem Text="Not Met" Value="2"></asp:ListItem>
                                            <asp:ListItem Text="NA" Value="3"></asp:ListItem>
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:DropDownList ID="Q10" runat="server" Height="20px" Width="150px" Font-Size="X-Small" onchange="DropDownFilter(this);">
                                            ...
                                            <asp:ListItem Text="Fabrication" Value="4"></asp:ListItem>
                                            <asp:ListItem Text="No Documentation" Value="5"></asp:ListItem>
                                            <asp:ListItem Text="Did not link chat to CDAX" Value="6"></asp:ListItem>
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:DropDownList ID="Q11" runat="server" Height="20px" Width="150px" Font-Size="X-Small" onchange="DropDownFilter(this);">
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ID="RequiredFieldValidator7" ControlToValidate="Q11" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:DropDownList ID="Q14" runat="server" Height="20px" Width="150px" Font-Size="X-Small" onchange="DropDownFilter(this);">
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ID="RequiredFieldValidator52" ControlToValidate="Q14" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ID="RequiredFieldValidator58" ControlToValidate="Q15a" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:DropDownList ID="Q16" runat="server" Height="20px" Width="150px" Font-Size="X-Small" onchange="DropDownFilter(this);">
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ID="RequiredFieldValidator54" ControlToValidate="Q16" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:DropDownList ID="Q17" runat="server" Height="20px" Width="150px" Font-Size="X-Small" onchange="DropDownFilter(this);">
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ID="RequiredFieldValidator55" ControlToValidate="Q17" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:DropDownList ID="Q18" runat="server" Height="20px" Width="150px" Font-Size="X-Small" onchange="DropDownFilter(this);">
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ID="RequiredFieldValidator56" ControlToValidate="Q18" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>
    ...
    <script type="text/javascript">
        ...
        function DropDownFilter() {
            ...
            var q13d = document.getElementById("Q13d");
            ...
            if ((q10.options[q10.selectedIndex].text == 'Missed Case Creation') || (q10.options[q10.selectedIndex].text == 'Fabrication') || (q10.options[q10.selectedIndex].text == 'No Documentation') || (q10.options[q10.selectedIndex].text == 'Did not link chat to CDAX')) {
            ...
            if ((q13.options[q13.selectedIndex].text == 'Met')) {
                ...
                document.getElementById('Q13d').disabled = true;
            }
                ...
                document.getElementById('Q13d').disabled = false;
            }
                ...
                document.getElementById('Q13c').disabled = false;
                document.getElementById('Q13d').disabled = false;
                if ((q13a.options[q13a.selectedIndex].text == 'Not Met') || (q13b.options[q13b.selectedIndex].text == 'Not Met') || (q13c.options[q13c.selectedIndex].text == 'Not Met') || (q13d.options[q13d.selectedIndex].text == 'Not Met')) {
                    SelectedValue += Number(10);
                    CC += Number(10);
                }
            }//Qstn 13

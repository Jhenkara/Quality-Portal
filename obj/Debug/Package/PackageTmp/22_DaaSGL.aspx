<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="22_DaaSGL.aspx.cs" Inherits="Audit_Legends._22_DaaSGL" %>
...
<head>
    ...
    <title>FY22 DaaS Legend Guidelines</title>
...
<body style="background-image:url('images/guidelines.jpg');">
    ...
    <div class="auto-style1" style="color:aliceblue;background-color:black;text-align:left;line-height:100px;max-width:100%">
        ...
        <h1><img src="Images/HP logoblu.png" style="width:98px;overflow:auto;float:initial;"/> FY22 DaaS Legend Guidelines </h1>
    </div>

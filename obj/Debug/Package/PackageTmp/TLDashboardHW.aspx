<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TLDashboardHW.aspx.cs" Inherits="Audit_Legends.TLDashboardHW" %>
...
<head runat="server">
    ...
    <link href="TLDashboardHW.css" rel="stylesheet" type="text/css" />
</head>
<body>
    ...
    <div>
        <table id="Table2" style="border:1px solid black;font-family:Arial;margin-left:30px;">
            ...
            <tr>
                <td>
                <asp:Button ID="Button2" runat="server" Text="Apply Filters"/>
                </td>
            </tr>

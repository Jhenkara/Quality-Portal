<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditSheetUserFY22Swivel.aspx.cs" Inherits="Audit_Legends.AuditSheetUserFY22Swivel" %>
                    ...
                    <div class="row">
                        ...
                        <table id="table1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="tbSupportMed" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" runat="server"></asp:TextBox>
                                </td>
                            </tr>
                            ...
                            <table id="table2" border="1" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="Q01" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" Enabled="false" runat="server"></asp:TextBox>                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="Q02" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" Enabled="false" runat="server"></asp:TextBox></td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="Q03" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" Enabled="false" runat="server"></asp:TextBox></td>
                                        <td>
...
<%--                                    <tr style="background-color:#1e5eb3;color:white">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="Q05a" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" Enabled="false" runat="server"></asp:TextBox>
                                        <br />
                                    ...
                                    <tr>
                                        <td>Email Communication<br />
                                            <asp:TextBox ID="Q06" TextMode="MultiLine" AutoCompleteType="Disabled" placeholder="* Comments" runat="server" Height="60px" Width="250px"></asp:TextBox></td>
                                        <td>
                                        ...
                                        <td>
                                            <asp:TextBox ID="Q06a" TextMode="MultiLine" AutoCompleteType="Disabled" placeholder="* Comments" runat="server" Height="60px" Width="250px"></asp:TextBox>
                                        <br />
                                            <asp:TextBox ID="Q06b" TextMode="MultiLine" AutoCompleteType="Disabled" placeholder="* Comments" runat="server" Height="60px" Width="250px"></asp:TextBox>
                                        <br />
                                            <asp:TextBox ID="Q06c" TextMode="MultiLine" AutoCompleteType="Disabled" placeholder="* Comments" runat="server" Height="60px" Width="250px"></asp:TextBox>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="Q07" TextMode="MultiLine" AutoCompleteType="Disabled" placeholder="* Comments" runat="server" Height="60px" Width="250px"></asp:TextBox>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td>
                                            <asp:TextBox ID="Q08" TextMode="MultiLine" AutoCompleteType="Disabled" placeholder="* Comments" runat="server" Height="60px" Width="250px"></asp:TextBox>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>Did the Engineer showcase ownership?<br />
                                            <asp:TextBox ID="Q09" TextMode="MultiLine" AutoCompleteType="Disabled" placeholder="* Comments" runat="server" Height="60px" Width="250px"></asp:TextBox></td>
                                        <td>
                                            Follow-up emails<br />
                                        ...
                                        <td>
                                            <asp:TextBox ID="Q09a" TextMode="MultiLine" AutoCompleteType="Disabled" placeholder="* Comments" runat="server" Height="60px" Width="250px"></asp:TextBox>
                                        <br />
                                            <asp:TextBox ID="Q09b" TextMode="MultiLine" AutoCompleteType="Disabled" placeholder="* Comments" runat="server" Height="60px" Width="250px"></asp:TextBox>
                                        <br />
                                            <asp:TextBox ID="Q09c" TextMode="MultiLine" AutoCompleteType="Disabled" placeholder="* Comments" runat="server" Height="60px" Width="250px"></asp:TextBox>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="Q10" TextMode="MultiLine" AutoCompleteType="Disabled" placeholder="* Comments" runat="server" Height="60px" Width="250px"></asp:TextBox>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:TextBox ID="NonComptb" CssClass="form-control input-xs" AutoCompleteType="Disabled" BorderStyle="Inset" Enabled="false" runat="server"></asp:TextBox></td>
                                        <td>

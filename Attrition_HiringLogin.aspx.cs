...
{
    public partial class Attrition_HiringLogin : System.Web.UI.Page
    {
        ...
        protected void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            string query = "SELECT COUNT(1) FROM UserCredentials where Username=@Username and Password=@Password and Roles in ('Hiring')";
            ...
            {
                Session["Username"] = tbUsername.Text.Trim();
                Response.Redirect("Attrition_Hiring_SelectOptions.aspx");
            }
            else
            {

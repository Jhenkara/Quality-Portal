<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="22_DaaSLegend.aspx.cs" Inherits="Audit_Legends._22_DaaSLegend" %>
...
<head>
    ...
    <title>India and APJ DaaS Audit Form</title>
...
<body>
    ...
    <div class="auto-style1" style="color:aliceblue;background-color:#4d4e4f;text-align:left;line-height:100px;width:100%">
        ...
        <h1><img src="Images/hp_logo_white.png" style="width:98px;overflow:auto;float:initial;"/> India and APJ DaaS Audit Form </h1>
    </div>
...
<%--                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" ControlToValidate="tbId7" runat="server" ErrorMessage="* Must be exactly 32 Characters" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Smaller" ForeColor="Red" SetFocusOnError="true" ValidationExpression="^[a-zA-Z0-9]{32}$"></asp:RegularExpressionValidator>--%>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator InitialValue="-1" ID="RequiredFieldValidator12" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" ControlToValidate="ddSupportMed" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:DropDownList ID="Q10" runat="server" Height="20px" Width="150px" Font-Size="X-Small" onchange="DropDownFilter(this);">
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ID="RequiredFieldValidator39" ControlToValidate="Q10" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                    ...
                                    <tr>
                                        <td>Did the Engineer showcased ownership/ escalated the call if required? <br />
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ControlToValidate="Q11" ID="RequiredFieldValidator20" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:DropDownList ID="Q12" runat="server" Height="20px" Width="150px" Font-Size="X-Small" onchange="DropDownFilter(this);">
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ID="RequiredFieldValidator14" ControlToValidate="Q12" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                    ...
                                    <tr>
                                        ...
                                        <td><asp:DropDownList ID="Q13" runat="server" Height="20px" Width="150px" Font-Size="X-Small" onchange="DropDownFilter(this);">
                                            ...
                                            <asp:RequiredFieldValidator InitialValue="0" ID="RequiredFieldValidator7" ControlToValidate="Q13" runat="server" ErrorMessage="*" CssClass="form-control" Display="Dynamic" Font-Italic="true" Font-Size="Medium" ForeColor="Red" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>
    ...
    <script type="text/javascript">
        ...
        function DropDownFilter() {
            ...
            if ((q11.options[q11.selectedIndex].text == 'Met')) {
            ...
            else if ((q11.options[q11.selectedIndex].text == 'NA')) {
                SelectedValue += Number(0);
                ...
                document.getElementById('Q11b').disabled = false;
                document.getElementById('Q11c').disabled = false;
                if ((q11a.options[q11a.selectedIndex].text == 'Not Met') || (q11b.options[q11b.selectedIndex].text == 'Not Met') || (q11c.options[q11c.selectedIndex].text == 'Not Met')) {
            ...
            if ((q12.options[q12.selectedIndex].text == 'Missed Case Creation') || (q12.options[q12.selectedIndex].text == 'Fabrication') || (q12.options[q12.selectedIndex].text == 'No Documentation') || (q12.options[q12.selectedIndex].text == 'Inaccurate/Incomplete Contact Info') || (q12.options[q12.selectedIndex].text == 'Missed QC')) {
                SelectedValue += Number(5);
                CC += Number(5);
            }
            else if ((q12.options[q12.selectedIndex].text == 'Partial'))
            {
                SelectedValue += Number(2.5);
                CC += Number(2.5);
            }//Qstn 12

            if ((q13.options[q13.selectedIndex].text == 'Offer Additional assistance') || (q13.options[q13.selectedIndex].text == 'HP Branding')) {
                SelectedValue += Number(5);
            }//Qstn 13

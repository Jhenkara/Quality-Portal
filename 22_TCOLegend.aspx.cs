...
{
    public partial class _22_TCOLegend : System.Web.UI.Page
    {
        ...
        protected void Submit_Button(object sender, EventArgs args)
        {
            ...
            string CommandText = "INSERT INTO [dbo].[FY22TCOLegend](QAName,QAMail,BusinessUnit,BusinessSegment,Month,EmployeeID,Employee_Name,Employee_Mail,TLName,TLMail,Reporting_Manager,Reporting_Manager_Mail,TeamName,CCMail,CallDate,EvaluationDate,CaseID,CallID_SR_ID,CallDuration,CallType,ProblemDescription,NonCompliance,NonComplianceDetail,NonComplianceScore,AuditScore,CustCritical,BusCritical,HPBranding,HPBranding_Cmnts,Case_Study,Case_Study_Cmnts,Probing_Logical_Troubleshooting,Probing_Logical_Troubleshooting_Cmnts,Resolution_CaseStatus,Resolution_CaseStatus_Cmnts,Communication,Communication_Cmnts,Call_Logging_Documentation,Call_Logging_Documentation_Cmnts,Additional_Assistance,Additional_Assistance_Cmnts,Callback,Callback_Cmnts,Callback_ValueAdd,CallBack_ValueAdd_Cmnts,AuditResult) values " +
                "(@QAName,@QAMail,@BusinessUnit,@BusinessSegment,@Month,@EmployeeID,@Employee_Name,@Employee_Mail,@TLName,@TLMail,@Reporting_Manager,@Reporting_Manager_Mail,@TeamName,@CCMail,@CallDate,@EvaluationDate,@CaseID,@CallID_SR_ID,@CallDuration,@CallType,@ProblemDescription,@NonCompliance,@NonComplianceDetail,@NonComplianceScore,@AuditScore,@CustCritical,@BusCritical,@HPBranding,@HPBranding_Cmnts,@Case_Study,@Case_Study_Cmnts,@Probing_Logical_Troubleshooting,@Probing_Logical_Troubleshooting_Cmnts,@Resolution_CaseStatus,@Resolution_CaseStatus_Cmnts,@Communication,@Communication_Cmnts,@Call_Logging_Documentation,@Call_Logging_Documentation_Cmnts,@Additional_Assistance,@Additional_Assistance_Cmnts,@Callback,@Callback_Cmnts,@Callback_ValueAdd,@CallBack_ValueAdd_Cmnts,@AuditResult)";
            ...
            Con.Close();
            maildetails();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Audit Saved and Mail sent Successfully');window.location ='22_TCOLegend.aspx';", true);
        }
        ...
        private bool SendEmail(string to, string from, string password, string subject, string body, string cc, string tl)
        {
            ...
            try
            {
                ...
                mail.Subject = "TCO Audit | " + ddMonth.SelectedItem.Text + " | " + tbId3.Text;
                mail.Body = body;

...
{
    public partial class _22_Email_PSCC_MPS_Legend : System.Web.UI.Page
    {
        ...
        protected void Submit_Button(object sender, EventArgs args)
        {
            ...
            string CommandText = "INSERT INTO [dbo].[FY22MPS_EmailLegend](QAName,QAMail,BusinessUnit,BusinessSegment,Month,EmployeeID,Employee_Name,Employee_Mail,TLName,TLMail,Reporting_Manager,Reporting_Manager_Mail,TeamName,CCMail,CallDate,EvaluationDate,CaseID,CallID_SR_ID,CallDuration,CaseType,ProblemDescription,NonCompliance,NonComplianceDetail,NonComplianceScore,AuditScore,CustCritical,BusCritical,ActionCaseWithinTime,ActionCaseWithinTime1,ActionCaseWithinTime2,ActionCaseWithinTime_Cmnts,ActionWithRightDocs,ActionWithRightDocs_Cmnts,RightTonerSupplies,RightTonerSupplies_Cmnts,Res_Info,Res_Info_Cmnts,Behavioural,Behavioural1,Behavioural2,Behavioural3,Behavioural4,Behavioural5,Behavioural6,Behavioural_Cmnts,EmailCommunication,EmailCommunication1,EmailCommunication2,EmailCommunication3,EmailCommunication_Cmnts,Setting_Expectation,Setting_Expectation_Cmnts,CaseOwnership,CaseOwnership1,CaseOwnership2,CaseOwnership3,CaseOwnership4,CaseOwnership_Cmnts,Documentation,Documentation_Cmnts,WOW_DAB,WOW_DAB_Cmnts,AuditResult) values " +
                "(@QAName,@QAMail,@BusinessUnit,@BusinessSegment,@Month,@EmployeeID,@Employee_Name,@Employee_Mail,@TLName,@TLMail,@Reporting_Manager,@Reporting_Manager_Mail,@TeamName,@CCMail,@CallDate,@EvaluationDate,@CaseID,@CallID_SR_ID,@CallDuration,@CaseType,@ProblemDescription,@NonCompliance,@NonComplianceDetail,@NonComplianceScore,@AuditScore,@CustCritical,@BusCritical,@ActionCaseWithinTime,@ActionCaseWithinTime1,@ActionCaseWithinTime2,@ActionCaseWithinTime_Cmnts,@ActionWithRightDocs,@ActionWithRightDocs_Cmnts,@RightTonerSupplies,@RightTonerSupplies_Cmnts,@Res_Info,@Res_Info_Cmnts,@Behavioural,@Behavioural1,@Behavioural2,@Behavioural3,@Behavioural4,@Behavioural5,@Behavioural6,@Behavioural_Cmnts,@EmailCommunication,@EmailCommunication1,@EmailCommunication2,@EmailCommunication3,@EmailCommunication_Cmnts,@Setting_Expectation,@Setting_Expectation_Cmnts,@CaseOwnership,@CaseOwnership1,@CaseOwnership2,@CaseOwnership3,@CaseOwnership4,@CaseOwnership_Cmnts,@Documentation,@Documentation_Cmnts,@WOW_DAB,@WOW_DAB_Cmnts,@AuditResult)";
            ...
            Con.Close();
            maildetails();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Audit Saved and Mail sent Successfully');window.location ='22_Email_PSCC_MPS_Legend.aspx';", true);
        }

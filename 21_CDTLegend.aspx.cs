...
{
    public partial class _21_CDTLegend : System.Web.UI.Page
    {
        ...
        protected void Submit_Button(object sender, EventArgs args)
        {
            ...
            string CommandText = "INSERT INTO [dbo].[FY21CDTLegend](QAName,QAMail,BusinessUnit,BusinessSegment,Month,EmployeeID,Employee_Name,Employee_Mail,TLName,TLMail,Reporting_Manager,Reporting_Manager_Mail,TeamName,CCMail,CallDate,EvaluationDate,CaseID,CallID_SR_ID,CallDuration,CaseType,ProblemDescription,NonCompliance,NonComplianceDetail,NonComplianceScore,AuditScore,CustCritical,BusCritical,CallOpening,CallOpening_Cmnts,Case_Serial_No,Case_Serial_No_Cmnts,Probing,Probing_Cmnts,Sol_Res,Sol_Res_Cmnts,Setting_Expectation,Setting_Expectation_Cmnts,Communication,Communication1,Communication2,Communication3,Communication4,Communication5,Communication6,Communication7,Communication8,Communication_Cmnts,Time_Management,Time_Management_Cmnts,CaseLogging,CaseLogging_Cmnts,CaseOwnership,CaseOwnership_Cmnts,Closing,Closing_Cmnts,AuditResult) values " +
            ...
            Con.Close();
            maildetails();
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Audit Saved and Mail sent Successfully');window.location ='21_CDTLegend.aspx';", true);
        }
        ...
        private bool SendEmail(string to, string from, string password, string subject, string body, string cc, string tl)
        {
            ...
            try
            {
                ...
                mail.Subject = "CDT Audit | " + ddMonth.SelectedItem.Text + " | " + tbId3.Text;
                mail.Body = body;
